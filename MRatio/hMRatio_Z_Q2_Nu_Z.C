...
//=========  (Mon Jan  9 19:35:19 2017) by ROOT version5.34/19
   ...
   c->Range(0.2375,0.9240744,0.8625,1.094901);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.9569668);
   hMRatioProj->SetBinContent(2,1.019088);
   hMRatioProj->SetBinContent(3,1.048386);
   hMRatioProj->SetBinContent(4,1.025622);
   hMRatioProj->SetBinContent(5,1.056883);
   hMRatioProj->SetBinError(1,0.00961185);
   hMRatioProj->SetBinError(2,0.01072515);
   hMRatioProj->SetBinError(3,0.01177701);
   hMRatioProj->SetBinError(4,0.01247167);
   hMRatioProj->SetBinError(5,0.01442816);
