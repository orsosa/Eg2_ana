...
//=========  (Tue Jan 10 11:09:11 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.2375,0.4157437,0.8625,1.629738);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.9530852);
   hMRatioProj->SetBinContent(2,0.9829054);
   hMRatioProj->SetBinContent(3,1.015687);
   hMRatioProj->SetBinContent(4,1.013315);
   hMRatioProj->SetBinContent(5,1.02164);
   hMRatioProj->SetBinError(1,0.2468069);
   hMRatioProj->SetBinError(2,0.2593343);
   hMRatioProj->SetBinError(3,0.2909617);
   hMRatioProj->SetBinError(4,0.335189);
   hMRatioProj->SetBinError(5,0.4404514);
