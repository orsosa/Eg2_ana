...
//=========  (Tue Jan 10 11:09:11 2017) by ROOT version5.34/19
   ...
   c->Range(0.2375,2.6695,0.8625,3.328822);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Z->SetBinContent(1,2.855626);
   hMR_Z->SetBinContent(2,3.056834);
   hMR_Z->SetBinContent(3,3.117723);
   hMR_Z->SetBinContent(4,3.080434);
   hMR_Z->SetBinContent(5,3.105509);
   hMR_Z->SetBinError(1,0.09627264);
   hMR_Z->SetBinError(2,0.09866836);
   hMR_Z->SetBinError(3,0.1047757);
   hMR_Z->SetBinError(4,0.1076498);
   hMR_Z->SetBinError(5,0.1322644);
   hMR_Z->SetEntries(14.9731);
   hMR_Z->SetStats(0);
