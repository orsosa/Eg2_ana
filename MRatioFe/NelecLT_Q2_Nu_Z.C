...
//=========  (Tue Jan 24 11:41:42 2017) by ROOT version5.34/19
   ...
   c->Range(0.6125,6356975,4.4875,6824985);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hNelecLT->SetBinContent(1,6541868);
   hNelecLT->SetBinContent(2,6760355);
   hNelecLT->SetBinContent(3,6420756);
   hNelecLT->SetBinContent(4,7);
   hNelecLT->SetEntries(1.972299e+07);
   ...
   text = ptstats->AddText("Entries =   1.972299e+07");
   text = ptstats->AddText("Mean  =  1.648");
   text = ptstats->AddText("RMS   =  0.516");
