...
//=========  (Tue Jan 24 11:41:43 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.2375,1.301037,0.8625,1.518135);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,1.487905);
   hMRatioProj->SetBinContent(2,1.474444);
   hMRatioProj->SetBinContent(3,1.400458);
   hMRatioProj->SetBinContent(4,1.348315);
   hMRatioProj->SetBinContent(5,1.330848);
