...
//=========  (Tue Jan 24 11:41:42 2017) by ROOT version5.34/19
   ...
   c->Range(0.2375,3.796096,0.8625,4.615124);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Z->SetBinContent(1,4.474474);
   hMR_Z->SetBinContent(2,4.427969);
   hMR_Z->SetBinContent(3,4.207632);
   hMR_Z->SetBinContent(4,4.029876);
   hMR_Z->SetBinContent(5,3.94081);
   hMR_Z->SetBinError(1,0.02754619);
   hMR_Z->SetBinError(2,0.02847633);
   hMR_Z->SetBinError(3,0.02879363);
   hMR_Z->SetBinError(4,0.02998643);
   hMR_Z->SetBinError(5,0.03309541);
   hMR_Z->SetEntries(14.93635);
   hMR_Z->SetStats(0);
