...
//=========  (Tue Jan 10 11:51:17 2017) by ROOT version5.34/19
   ...
   c->Range(0.6125,518182.9,4.4875,563362);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hNelecST->SetBinContent(1,524340);
   hNelecST->SetBinContent(2,551267);
   hNelecST->SetBinContent(3,557123);
   hNelecST->SetEntries(1632730);
   ...
   text = ptstats->AddText("Entries = 1632730");
   text = ptstats->AddText("Mean  =  1.668");
   text = ptstats->AddText("RMS   = 0.5294");
