...
//=========  (Tue Jan 10 11:51:18 2017) by ROOT version5.34/19
   ...
   c->Range(0.2375,0.7266029,0.8625,1.263401);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinError(1,0.1036049);
   hMRatioProj->SetBinError(2,0.100726);
   hMRatioProj->SetBinError(3,0.1049007);
   hMRatioProj->SetBinError(4,0.116798);
   hMRatioProj->SetBinError(5,0.148965);
