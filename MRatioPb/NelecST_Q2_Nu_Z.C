...
//=========  (Tue Jan 24 11:42:10 2017) by ROOT version5.34/19
   ...
   c->Range(0.6125,604397.7,4.4875,649454.1);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hNelecST->SetBinContent(1,622528);
   hNelecST->SetBinContent(2,643232);
   hNelecST->SetBinContent(3,610538);
   hNelecST->SetEntries(1876298);
   ...
   text = ptstats->AddText("Entries = 1876298");
   text = ptstats->AddText("Mean  =  1.649");
   text = ptstats->AddText("RMS   = 0.5181");
