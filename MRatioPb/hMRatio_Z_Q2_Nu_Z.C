...
//=========  (Tue Jan 24 11:42:11 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.2375,1.678285,0.8625,2.030069);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,1.981319);
   hMRatioProj->SetBinContent(2,1.887307);
   hMRatioProj->SetBinContent(3,1.785032);
   hMRatioProj->SetBinContent(4,1.726375);
   hMRatioProj->SetBinContent(5,1.728181);
