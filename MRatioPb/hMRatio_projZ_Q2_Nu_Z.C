...
//=========  (Tue Jan 24 11:42:11 2017) by ROOT version5.34/19
   ...
   c->Range(0.2375,4.881051,0.8625,6.131494);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Z->SetBinContent(1,5.919763);
   hMR_Z->SetBinContent(2,5.650364);
   hMR_Z->SetBinContent(3,5.398921);
   hMR_Z->SetBinContent(4,5.214321);
   hMR_Z->SetBinContent(5,5.098282);
   hMR_Z->SetBinError(1,0.03905023);
   hMR_Z->SetBinError(2,0.03928033);
   hMR_Z->SetBinError(3,0.04017769);
   hMR_Z->SetBinError(4,0.0424661);
   hMR_Z->SetBinError(5,0.04681901);
   hMR_Z->SetEntries(14.93508);
   hMR_Z->SetStats(0);
