...
//=========  (Tue Jan 10 11:12:04 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.2375,-1.249815,0.8625,3.334814);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.8991044);
   hMRatioProj->SetBinContent(2,0.9499268);
   hMRatioProj->SetBinContent(3,1.001638);
   hMRatioProj->SetBinContent(4,1.013434);
   hMRatioProj->SetBinContent(5,1.038341);
   hMRatioProj->SetBinError(1,0.8620062);
   hMRatioProj->SetBinError(2,0.924683);
   hMRatioProj->SetBinError(3,1.064896);
   hMRatioProj->SetBinError(4,1.255758);
   hMRatioProj->SetBinError(5,1.663357);
