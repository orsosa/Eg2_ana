...
//=========  (Tue Jan 10 12:54:31 2017) by ROOT version5.34/19
   ...
   c->Range(0.6125,368828.1,4.4875,429811.5);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hNelecST->SetBinContent(1,377139);
   hNelecST->SetBinContent(2,402896);
   hNelecST->SetBinContent(3,421390);
   hNelecST->SetEntries(1201425);
   ...
   text = ptstats->AddText("Mean  =   1.68");
   text = ptstats->AddText("RMS   = 0.5335");
