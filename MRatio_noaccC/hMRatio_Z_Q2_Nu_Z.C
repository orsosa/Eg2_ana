...
//=========  (Tue Jan 10 12:54:31 2017) by ROOT version5.34/19
   ...
   c->Range(0.2375,0.8513936,0.8625,1.140622);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,1.049224);
   hMRatioProj->SetBinContent(2,1.017392);
   hMRatioProj->SetBinContent(3,0.9845556);
   hMRatioProj->SetBinContent(4,0.9868599);
   hMRatioProj->SetBinContent(5,0.9788188);
   hMRatioProj->SetBinError(1,0.05145665);
   hMRatioProj->SetBinError(2,0.05263355);
   hMRatioProj->SetBinError(3,0.05784943);
   hMRatioProj->SetBinError(4,0.06884915);
   hMRatioProj->SetBinError(5,0.08800887);
