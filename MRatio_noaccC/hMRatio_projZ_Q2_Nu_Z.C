...
//=========  (Tue Jan 10 12:54:31 2017) by ROOT version5.34/19
   ...
   c->Range(0.2375,2.766809,0.8625,3.351558);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Z->SetBinContent(1,3.141974);
   hMR_Z->SetBinContent(2,3.165916);
   hMR_Z->SetBinContent(3,3.01819);
   hMR_Z->SetBinContent(4,3.002832);
   hMR_Z->SetBinContent(5,2.972245);
   hMR_Z->SetBinError(1,0.1057304);
   hMR_Z->SetBinError(2,0.1048905);
   hMR_Z->SetBinError(3,0.100889);
   hMR_Z->SetBinError(4,0.1056675);
   hMR_Z->SetBinError(5,0.1257452);
   hMR_Z->SetEntries(14.9821);
   hMR_Z->SetStats(0);
