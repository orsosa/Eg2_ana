...
//=========  (Tue Jan 10 12:54:40 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.6125,888263.3,4.4875,946875);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hNelecLT->SetBinContent(1,896251);
   hNelecLT->SetBinContent(2,934954);
   hNelecLT->SetBinContent(3,938781);
   hNelecLT->SetEntries(2769986);
   ...
   text = ptstats->AddText("Entries = 2769986");
