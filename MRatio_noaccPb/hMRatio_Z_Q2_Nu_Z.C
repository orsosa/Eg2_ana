...
//=========  (Tue Jan 10 12:54:41 2017) by ROOT version5.34/19
   ...
   c->Range(0.2375,0.8935789,0.8625,1.169572);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,1.112218);
   hMRatioProj->SetBinContent(2,1.052713);
   hMRatioProj->SetBinContent(3,0.9983648);
   hMRatioProj->SetBinContent(4,0.9867443);
   hMRatioProj->SetBinContent(5,0.9630746);
   hMRatioProj->SetBinError(1,0.01924056);
   hMRatioProj->SetBinError(2,0.01961245);
   hMRatioProj->SetBinError(3,0.02120322);
   hMRatioProj->SetBinError(4,0.02488388);
   hMRatioProj->SetBinError(5,0.03188309);
