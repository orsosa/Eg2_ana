...
//=========  (Tue Jan 10 12:54:41 2017) by ROOT version5.34/19
   ...
   c->Range(0.2375,2.637035,0.8625,3.607623);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Z->SetBinContent(1,3.332967);
   hMR_Z->SetBinContent(2,3.275084);
   hMR_Z->SetBinContent(3,3.062127);
   hMR_Z->SetBinContent(4,3.00064);
   hMR_Z->SetBinContent(5,2.925402);
   hMR_Z->SetBinError(1,0.140623);
   hMR_Z->SetBinError(2,0.1352656);
   hMR_Z->SetBinError(3,0.1263994);
   hMR_Z->SetBinError(4,0.1306512);
   hMR_Z->SetBinError(5,0.1560935);
   hMR_Z->SetEntries(14.95229);
   hMR_Z->SetStats(0);
