...
//=========  (Tue Jan 10 12:24:20 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.6125,937683.3,4.4875,1032815);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hNelecLT->SetBinContent(1,950648);
   hNelecLT->SetBinContent(2,1000698);
   hNelecLT->SetBinContent(3,1019678);
   hNelecLT->SetEntries(2971024);
   ...
   text = ptstats->AddText("Entries = 2971024");
   text = ptstats->AddText("Mean  =   1.67");
   text = ptstats->AddText("RMS   = 0.5288");
