...
//=========  (Tue Jan 10 12:24:21 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.2375,0.9442076,0.8625,1.109951);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,1.083003);
   hMRatioProj->SetBinContent(2,1.074655);
   hMRatioProj->SetBinContent(3,1.020856);
   hMRatioProj->SetBinContent(4,0.9836595);
   hMRatioProj->SetBinContent(5,0.9716955);
   hMRatioProj->SetBinError(1,0.004059918);
   hMRatioProj->SetBinError(2,0.004207704);
   hMRatioProj->SetBinError(3,0.004259766);
   hMRatioProj->SetBinError(4,0.004421616);
   hMRatioProj->SetBinError(5,0.004900233);
