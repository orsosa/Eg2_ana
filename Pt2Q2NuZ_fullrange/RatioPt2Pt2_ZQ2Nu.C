...
//=========  (Tue Apr 11 18:05:35 2017) by ROOT version5.34/19
   ...
   hC->SetBinContent(1,0.8252235);
   hC->SetBinContent(2,0.826807);
   hC->SetBinContent(3,0.8392321);
   hC->SetBinContent(4,0.8335391);
   hC->SetBinContent(5,0.8691378);
   hC->SetBinContent(6,0.8751627);
   hC->SetBinError(1,0.0002662569);
   hC->SetBinError(2,0.0002667679);
   hC->SetBinError(3,0.0002707768);
   hC->SetBinError(4,0.00026894);
   hC->SetBinError(5,0.0002804259);
   hC->SetBinError(6,0.000282371);
   hC->SetEntries(6);
   hC->SetStats(0);
   ...
   hFe->SetBinContent(1,0.6023613);
   hFe->SetBinContent(2,0.593021);
   hFe->SetBinContent(3,0.6176502);
   hFe->SetBinContent(4,0.6341375);
   hFe->SetBinContent(5,0.6537755);
   hFe->SetBinContent(6,0.6577157);
   hFe->SetBinError(1,0.0001519305);
   hFe->SetBinError(2,0.0001495746);
   hFe->SetBinError(3,0.0001557867);
   hFe->SetBinError(4,0.0001599452);
   hFe->SetBinError(5,0.0001648984);
   hFe->SetBinError(6,0.0001658923);
   hFe->SetEntries(6);
   hFe->SetStats(0);
   ...
   hPb->SetBinContent(1,0.4561772);
   hPb->SetBinContent(2,0.4622407);
   hPb->SetBinContent(3,0.4764387);
   hPb->SetBinContent(4,0.4981612);
   hPb->SetBinContent(5,0.5119613);
   hPb->SetBinContent(6,0.5236683);
   hPb->SetBinError(1,7.418516e-05);
   hPb->SetBinError(2,7.517123e-05);
   hPb->SetBinError(3,7.748016e-05);
   hPb->SetBinError(4,8.101274e-05);
   hPb->SetBinError(5,8.325712e-05);
   hPb->SetBinError(6,8.516244e-05);
   hPb->SetEntries(6);
   hPb->SetStats(0);
