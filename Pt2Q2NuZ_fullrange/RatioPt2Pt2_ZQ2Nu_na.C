...
//=========  (Tue Apr 11 17:25:33 2017) by ROOT version5.34/19
   ...
   hC->SetBinContent(1,0.7994599);
   hC->SetBinContent(2,0.8047373);
   hC->SetBinContent(3,0.8239605);
   hC->SetBinContent(4,0.8317754);
   hC->SetBinContent(5,0.8466252);
   hC->SetBinContent(6,0.891565);
   hC->SetBinError(1,0.0002579444);
   hC->SetBinError(2,0.0002596471);
   hC->SetBinError(3,0.0002658495);
   hC->SetBinError(4,0.0002683714);
   hC->SetBinError(5,0.0002731638);
   hC->SetBinError(6,0.0002887751);
   hC->SetEntries(6);
   hC->SetStats(0);
   ...
   hFe->SetBinContent(1,0.5763995);
   hFe->SetBinContent(2,0.5770409);
   hFe->SetBinContent(3,0.6041027);
   hFe->SetBinContent(4,0.6284788);
   hFe->SetBinContent(5,0.643151);
   hFe->SetBinContent(6,0.6574776);
   hFe->SetBinError(1,0.0001453823);
   hFe->SetBinError(2,0.0001455441);
   hFe->SetBinError(3,0.0001523697);
   hFe->SetBinError(4,0.0001585182);
   hFe->SetBinError(5,0.0001622193);
   hFe->SetBinError(6,0.0001658328);
   hFe->SetEntries(6);
   hFe->SetStats(0);
   ...
   hPb->SetBinContent(1,0.4417006);
   hPb->SetBinContent(2,0.4492541);
   hPb->SetBinContent(3,0.4663544);
   hPb->SetBinContent(4,0.4958311);
   hPb->SetBinContent(5,0.5046064);
   hPb->SetBinContent(6,0.5279607);
   hPb->SetBinError(1,7.183098e-05);
   hPb->SetBinError(2,7.305934e-05);
   hPb->SetBinError(3,7.584043e-05);
   hPb->SetBinError(4,8.06352e-05);
   hPb->SetBinError(5,8.21735e-05);
   hPb->SetBinError(6,8.727659e-05);
   hPb->SetEntries(6);
   hPb->SetStats(0);
