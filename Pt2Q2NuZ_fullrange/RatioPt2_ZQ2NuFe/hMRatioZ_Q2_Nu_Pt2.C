...
//=========  (Tue Apr 11 17:27:46 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.9858439,-1.117922,0.9858439,1.117922);
   TView *view = TView::CreateView(1);
   view->SetRange(0.3,0,0,1,1.5,12.69316);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatio->SetBinContent(19,11.51307);
   hMRatio->SetBinContent(22,22.47694);
   hMRatio->SetBinError(19,0.01444761);
   hMRatio->SetBinError(22,0.01492995);
   hMRatio->SetEntries(54);
   hMRatio->SetContour(20);
   hMRatio->SetContourLevel(0,0);
   hMRatio->SetContourLevel(1,0.5756535);
   hMRatio->SetContourLevel(2,1.151307);
   hMRatio->SetContourLevel(3,1.726961);
   hMRatio->SetContourLevel(4,2.302614);
   hMRatio->SetContourLevel(5,2.878268);
   hMRatio->SetContourLevel(6,3.453921);
   hMRatio->SetContourLevel(7,4.029575);
   hMRatio->SetContourLevel(8,4.605228);
   hMRatio->SetContourLevel(9,5.180882);
   hMRatio->SetContourLevel(10,5.756535);
   hMRatio->SetContourLevel(11,6.332189);
   hMRatio->SetContourLevel(12,6.907842);
   hMRatio->SetContourLevel(13,7.483496);
   hMRatio->SetContourLevel(14,8.059149);
   hMRatio->SetContourLevel(15,8.634803);
   hMRatio->SetContourLevel(16,9.210456);
   hMRatio->SetContourLevel(17,9.78611);
   hMRatio->SetContourLevel(18,10.36176);
   hMRatio->SetContourLevel(19,10.93742);
