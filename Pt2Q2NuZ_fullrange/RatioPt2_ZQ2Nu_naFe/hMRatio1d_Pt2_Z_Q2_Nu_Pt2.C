...
//=========  (Tue Apr 11 17:19:41 2017) by ROOT version5.34/19
   ...
   c->Range(-0.1875,0.5609682,1.6875,0.6731328);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.5763995);
   hMRatioProj->SetBinContent(2,0.5770409);
   hMRatioProj->SetBinContent(3,0.6041027);
   hMRatioProj->SetBinContent(4,0.6284788);
   hMRatioProj->SetBinContent(5,0.643151);
   hMRatioProj->SetBinContent(6,0.6574776);
   hMRatioProj->SetBinError(1,0.0001453823);
   hMRatioProj->SetBinError(2,0.0001455441);
   hMRatioProj->SetBinError(3,0.0001523697);
   hMRatioProj->SetBinError(4,0.0001585182);
   hMRatioProj->SetBinError(5,0.0001622193);
   hMRatioProj->SetBinError(6,0.0001658328);
