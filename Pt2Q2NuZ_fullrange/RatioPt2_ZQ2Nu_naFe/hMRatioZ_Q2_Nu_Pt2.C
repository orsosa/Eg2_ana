...
//=========  (Tue Apr 11 17:19:41 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.9858439,-1.117922,0.9858439,1.117922);
   TView *view = TView::CreateView(1);
   view->SetRange(0.3,0,0,1,1.5,12.2434);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatio->SetBinContent(19,11.10513);
   hMRatio->SetBinContent(22,21.84598);
   hMRatio->SetBinError(19,0.005844896);
   hMRatio->SetBinError(22,0.005916242);
   hMRatio->SetEntries(54);
   hMRatio->SetContour(20);
   hMRatio->SetContourLevel(0,0);
   hMRatio->SetContourLevel(1,0.5552564);
   hMRatio->SetContourLevel(2,1.110513);
   hMRatio->SetContourLevel(3,1.665769);
   hMRatio->SetContourLevel(4,2.221026);
   hMRatio->SetContourLevel(5,2.776282);
   hMRatio->SetContourLevel(6,3.331538);
   hMRatio->SetContourLevel(7,3.886795);
   hMRatio->SetContourLevel(8,4.442051);
   hMRatio->SetContourLevel(9,4.997308);
   hMRatio->SetContourLevel(10,5.552564);
   hMRatio->SetContourLevel(11,6.107821);
   hMRatio->SetContourLevel(12,6.663077);
   hMRatio->SetContourLevel(13,7.218333);
   hMRatio->SetContourLevel(14,7.77359);
   hMRatio->SetContourLevel(15,8.328846);
   hMRatio->SetContourLevel(16,8.884103);
   hMRatio->SetContourLevel(17,9.439359);
   hMRatio->SetContourLevel(18,9.994615);
   hMRatio->SetContourLevel(19,10.54987);
