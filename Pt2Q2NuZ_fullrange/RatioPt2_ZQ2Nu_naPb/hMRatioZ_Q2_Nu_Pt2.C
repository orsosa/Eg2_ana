...
//=========  (Tue Apr 11 17:19:53 2017) by ROOT version5.34/19
   ...
   view->SetRange(0.3,0,0,1,1.5,9.511464);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatio->SetBinContent(19,8.627178);
   hMRatio->SetBinContent(22,17.16877);
   hMRatio->SetBinError(19,0.006808384);
   hMRatio->SetBinError(22,0.00721931);
   hMRatio->SetEntries(54);
   hMRatio->SetContour(20);
   hMRatio->SetContourLevel(0,0);
   hMRatio->SetContourLevel(1,0.4313589);
   hMRatio->SetContourLevel(2,0.8627178);
   hMRatio->SetContourLevel(3,1.294077);
   hMRatio->SetContourLevel(4,1.725436);
   hMRatio->SetContourLevel(5,2.156795);
   hMRatio->SetContourLevel(6,2.588153);
   hMRatio->SetContourLevel(7,3.019512);
   hMRatio->SetContourLevel(8,3.450871);
   hMRatio->SetContourLevel(9,3.88223);
   hMRatio->SetContourLevel(10,4.313589);
   hMRatio->SetContourLevel(11,4.744948);
   hMRatio->SetContourLevel(12,5.176307);
   hMRatio->SetContourLevel(13,5.607666);
   hMRatio->SetContourLevel(14,6.039025);
   hMRatio->SetContourLevel(15,6.470384);
   hMRatio->SetContourLevel(16,6.901743);
   hMRatio->SetContourLevel(17,7.333101);
   hMRatio->SetContourLevel(18,7.76446);
   hMRatio->SetContourLevel(19,8.195819);
