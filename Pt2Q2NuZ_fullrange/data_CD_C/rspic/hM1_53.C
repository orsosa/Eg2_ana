...
//=========  (Fri Apr  7 15:58:26 2017) by ROOT version5.34/19
   ...
   hM_bin53->SetBinContent(45,22);
   hM_bin53->SetBinContent(46,28);
   hM_bin53->SetBinContent(47,29);
   hM_bin53->SetBinContent(48,31);
   hM_bin53->SetBinContent(49,46);
   hM_bin53->SetBinContent(50,47);
   hM_bin53->SetBinContent(51,48);
   hM_bin53->SetBinContent(52,65);
   hM_bin53->SetBinContent(53,55);
   hM_bin53->SetBinContent(54,101);
   hM_bin53->SetBinContent(55,62);
   hM_bin53->SetBinContent(56,65);
   hM_bin53->SetBinContent(57,62);
   hM_bin53->SetBinContent(58,61);
   hM_bin53->SetBinContent(59,55);
   hM_bin53->SetBinContent(60,43);
   hM_bin53->SetBinContent(61,36);
   hM_bin53->SetBinContent(62,30);
   hM_bin53->SetBinContent(63,34);
   hM_bin53->SetBinContent(64,22);
   hM_bin53->SetBinContent(65,28);
   hM_bin53->SetBinContent(66,20);
   hM_bin53->SetBinContent(67,24);
   hM_bin53->SetBinContent(68,14);
   hM_bin53->SetBinContent(69,19);
   hM_bin53->SetBinContent(70,11);
   hM_bin53->SetBinContent(71,9);
   hM_bin53->SetBinContent(72,15);
   hM_bin53->SetBinContent(73,14);
   ...
   hM_bin53->SetBinContent(97,21);
   hM_bin53->SetBinContent(98,13);
   hM_bin53->SetBinContent(99,22);
   hM_bin53->SetBinContent(100,29);
   hM_bin53->SetBinContent(101,14314);
   hM_bin53->SetEntries(20607);
   
   TF1 *fsig = new TF1("fsig","fmb+fpeak",0.09035743,0.209356);
   ...
   fsig->SetParameter(0,-16.28679);
   fsig->SetParError(0,26.30908);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,275.4068);
   fsig->SetParError(1,399.0597);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-689.7266);
   fsig->SetParError(2,1280.619);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,57.00694);
   fsig->SetParError(3,5.362128);
   fsig->SetParLimits(3,0,202);
   fsig->SetParameter(4,0.1499471);
   fsig->SetParError(4,0.001044747);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01932224);
   fsig->SetParError(5,0.001649256);
   ...
   text = ptstats->AddText("Entries = 20607  ");
   text = ptstats->AddText("Mean  = 0.1805");
   text = ptstats->AddText("RMS   = 0.0575");
   text = ptstats->AddText("#chi^{2} / ndf = 30.13 / 28");
   text = ptstats->AddText("p0       = -16.29 #pm 26.31 ");
   text = ptstats->AddText("p1       = 275.4 #pm 399.1 ");
   text = ptstats->AddText("p2       = -689.7 #pm 1280.6 ");
   text = ptstats->AddText("p3       = 57.01 #pm 5.36 ");
   text = ptstats->AddText("p4       = 0.1499 #pm 0.0010 ");
   text = ptstats->AddText("p5       = 0.01932 #pm 0.00165 ");
   ...
   fmb->SetParameter(0,-16.28679);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,275.4068);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-689.7266);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,57.00694);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1499471);
