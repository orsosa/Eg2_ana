...
//=========  (Fri Nov 17 12:48:50 2017) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(-0.1875,0.2103685,1.6875,3.745096);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.8789148);
   hMRatioProj->SetBinContent(2,0.945077);
   hMRatioProj->SetBinContent(3,0.8827854);
   hMRatioProj->SetBinContent(4,0.9311411);
   hMRatioProj->SetBinContent(5,1.19703);
   hMRatioProj->SetBinContent(6,1.569457);
   hMRatioProj->SetBinContent(7,2.930709);
   hMRatioProj->SetBinError(1,0.01104461);
   hMRatioProj->SetBinError(2,0.000585818);
   hMRatioProj->SetBinError(3,0.08948416);
   hMRatioProj->SetBinError(4,0.2390558);
   hMRatioProj->SetBinError(5,0.08607136);
   hMRatioProj->SetBinError(6,0.02852199);
   hMRatioProj->SetBinError(7,0.3262575);
