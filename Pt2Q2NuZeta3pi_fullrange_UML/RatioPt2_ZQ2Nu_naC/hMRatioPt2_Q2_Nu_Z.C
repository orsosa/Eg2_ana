...
//=========  (Thu Oct 26 13:25:57 2017) by ROOT version5.34/34
   ...
   hMRatio->SetBinContent(19,0.8784385);
   hMRatio->SetBinContent(20,0.9449795);
   hMRatio->SetBinContent(21,0.8897097);
   hMRatio->SetBinContent(22,0.9359841);
   hMRatio->SetBinContent(23,1.197961);
   hMRatio->SetBinContent(24,1.667582);
   hMRatio->SetBinContent(25,2.87839);
   hMRatio->SetBinError(19,0.02512468);
   hMRatio->SetBinError(20,0.0377028);
   hMRatio->SetBinError(21,0.05239019);
   hMRatio->SetBinError(22,0.08143696);
   hMRatio->SetBinError(23,0.1405146);
   hMRatio->SetBinError(24,0.2574777);
   hMRatio->SetBinError(25,0.6450238);
