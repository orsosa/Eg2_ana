...
//=========  (Thu Oct 26 13:25:55 2017) by ROOT version5.34/34
   ...
   hMRatio->SetBinContent(19,0.613663);
   hMRatio->SetBinContent(20,0.6574108);
   hMRatio->SetBinContent(21,0.8793552);
   hMRatio->SetBinContent(22,1.008321);
   hMRatio->SetBinContent(23,0.887199);
   hMRatio->SetBinContent(24,1.13223);
   hMRatio->SetBinContent(25,1.645264);
   hMRatio->SetBinError(19,0.01465415);
   hMRatio->SetBinError(20,0.02136941);
   hMRatio->SetBinError(21,0.04297925);
   hMRatio->SetBinError(22,0.06934459);
   hMRatio->SetBinError(23,0.0893682);
   hMRatio->SetBinError(24,0.1621358);
   hMRatio->SetBinError(25,0.2782247);
