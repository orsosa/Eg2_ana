...
//=========  (Tue May  9 15:47:33 2017) by ROOT version5.34/34
   ...
   hC->SetBinContent(1,0.8423764);
   hC->SetBinContent(2,0.8371312);
   hC->SetBinContent(3,0.8266584);
   hC->SetBinContent(4,0.8442205);
   hC->SetBinContent(5,0.9300141);
   hC->SetBinContent(6,0.8795604);
   hC->SetBinError(1,0.0002717913);
   hC->SetBinError(2,0.0002700989);
   hC->SetBinError(3,0.0002667199);
   hC->SetBinError(4,0.0002723869);
   hC->SetBinError(5,0.0003000675);
   hC->SetBinError(6,0.0002837887);
   hC->SetEntries(6);
   hC->SetStats(0);
   ...
   hFe->SetBinContent(1,0.6078287);
   hFe->SetBinContent(2,0.6010014);
   hFe->SetBinContent(3,0.6159896);
   hFe->SetBinContent(4,0.6260424);
   hFe->SetBinContent(5,0.7097371);
   hFe->SetBinContent(6,0.6867068);
   hFe->SetBinError(1,0.0001533095);
   hFe->SetBinError(2,0.0001515875);
   hFe->SetBinError(3,0.0001553679);
   hFe->SetBinError(4,0.0001579034);
   hFe->SetBinError(5,0.0001790133);
   hFe->SetBinError(6,0.0001732046);
   hFe->SetEntries(6);
   hFe->SetStats(0);
   ...
   hPb->SetBinContent(1,0.4563169);
   hPb->SetBinContent(2,0.4551851);
   hPb->SetBinContent(3,0.4707619);
   hPb->SetBinContent(4,0.4831481);
   hPb->SetBinContent(5,0.5588929);
   hPb->SetBinContent(6,0.5257589);
   hPb->SetBinError(1,7.420787e-05);
   hPb->SetBinError(2,7.402382e-05);
   hPb->SetBinError(3,7.655698e-05);
   hPb->SetBinError(4,7.857142e-05);
   hPb->SetBinError(5,9.090948e-05);
   hPb->SetBinError(6,8.550078e-05);
   hPb->SetEntries(6);
   hPb->SetStats(0);
