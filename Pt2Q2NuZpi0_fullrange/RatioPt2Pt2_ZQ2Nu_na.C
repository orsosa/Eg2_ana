...
//=========  (Tue May  9 15:44:30 2017) by ROOT version5.34/34
   ...
   hC->SetBinContent(1,0.7762508);
   hC->SetBinContent(2,0.8085014);
   hC->SetBinContent(3,0.8162801);
   hC->SetBinContent(4,0.8679835);
   hC->SetBinContent(5,0.8770615);
   hC->SetBinContent(6,0.9025546);
   hC->SetBinError(1,0.000250456);
   hC->SetBinError(2,0.0002608668);
   hC->SetBinError(3,0.0002633714);
   hC->SetBinError(4,0.0002806462);
   hC->SetBinError(5,0.0002829839);
   hC->SetBinError(6,0.0002912085);
   hC->SetEntries(6);
   hC->SetStats(0);
   ...
   hFe->SetBinContent(1,0.557745);
   hFe->SetBinContent(2,0.5797141);
   hFe->SetBinContent(3,0.6109524);
   hFe->SetBinContent(4,0.6420479);
   hFe->SetBinContent(5,0.6714255);
   hFe->SetBinContent(6,0.7039305);
   hFe->SetBinError(1,0.0001406771);
   hFe->SetBinError(2,0.0001462183);
   hFe->SetBinError(3,0.0001540974);
   hFe->SetBinError(4,0.0001619406);
   hFe->SetBinError(5,0.0001693508);
   hFe->SetBinError(6,0.0001775873);
   hFe->SetEntries(6);
   hFe->SetStats(0);
   ...
   hPb->SetBinContent(1,0.4214242);
   hPb->SetBinContent(2,0.4365513);
   hPb->SetBinContent(3,0.4702019);
   hPb->SetBinContent(4,0.4993977);
   hPb->SetBinContent(5,0.5321608);
   hPb->SetBinContent(6,0.5369915);
   hPb->SetBinError(1,6.853355e-05);
   hPb->SetBinError(2,7.099356e-05);
   hPb->SetBinError(3,7.646611e-05);
   hPb->SetBinError(4,8.139205e-05);
   hPb->SetBinError(5,0.0001045398);
   hPb->SetBinError(6,8.732983e-05);
   hPb->SetEntries(6);
   hPb->SetStats(0);
