...
//=========  (Tue May  9 15:46:47 2017) by ROOT version5.34/34
   ...
   c->Range(-0.1875,0.5803658,1.6875,0.7306728);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.6078287);
   hMRatioProj->SetBinContent(2,0.6010014);
   hMRatioProj->SetBinContent(3,0.6159896);
   hMRatioProj->SetBinContent(4,0.6260424);
   hMRatioProj->SetBinContent(5,0.7097371);
   hMRatioProj->SetBinContent(6,0.6867068);
   hMRatioProj->SetBinError(1,0.0001533095);
   hMRatioProj->SetBinError(2,0.0001515875);
   hMRatioProj->SetBinError(3,0.0001553679);
   hMRatioProj->SetBinError(4,0.0001579034);
   hMRatioProj->SetBinError(5,0.0001790133);
   hMRatioProj->SetBinError(6,0.0001732046);
