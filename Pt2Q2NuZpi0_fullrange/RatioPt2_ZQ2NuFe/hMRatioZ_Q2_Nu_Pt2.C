...
//=========  (Tue May  9 15:46:47 2017) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.9858439,-1.117922,0.9858439,1.117922);
   TView *view = TView::CreateView(1);
   view->SetRange(0.3,0,0,1,1.5,12.95142);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatio->SetBinContent(19,11.74732);
   hMRatio->SetBinContent(22,23.25505);
   hMRatio->SetBinError(19,0.01721962);
   hMRatio->SetBinError(22,0.01763421);
   hMRatio->SetEntries(54);
   hMRatio->SetContour(20);
   hMRatio->SetContourLevel(0,0);
   hMRatio->SetContourLevel(1,0.5873659);
   hMRatio->SetContourLevel(2,1.174732);
   hMRatio->SetContourLevel(3,1.762098);
   hMRatio->SetContourLevel(4,2.349463);
   hMRatio->SetContourLevel(5,2.936829);
   hMRatio->SetContourLevel(6,3.524195);
   hMRatio->SetContourLevel(7,4.111561);
   hMRatio->SetContourLevel(8,4.698927);
   hMRatio->SetContourLevel(9,5.286293);
   hMRatio->SetContourLevel(10,5.873659);
   hMRatio->SetContourLevel(11,6.461025);
   hMRatio->SetContourLevel(12,7.04839);
   hMRatio->SetContourLevel(13,7.635756);
   hMRatio->SetContourLevel(14,8.223122);
   hMRatio->SetContourLevel(15,8.810488);
   hMRatio->SetContourLevel(16,9.397854);
   hMRatio->SetContourLevel(17,9.98522);
   hMRatio->SetContourLevel(18,10.57259);
   hMRatio->SetContourLevel(19,11.15995);
