...
//=========  (Tue May  9 15:46:50 2017) by ROOT version5.34/34
   ...
   c->Range(-0.1875,0.4356025,1.6875,0.5787521);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.4563169);
   hMRatioProj->SetBinContent(2,0.4551851);
   hMRatioProj->SetBinContent(3,0.4707619);
   hMRatioProj->SetBinContent(4,0.4831481);
   hMRatioProj->SetBinContent(5,0.5588929);
   hMRatioProj->SetBinContent(6,0.5257589);
   hMRatioProj->SetBinError(1,7.420787e-05);
   hMRatioProj->SetBinError(2,7.402382e-05);
   hMRatioProj->SetBinError(3,7.655698e-05);
   hMRatioProj->SetBinError(4,7.857142e-05);
   hMRatioProj->SetBinError(5,9.090948e-05);
   hMRatioProj->SetBinError(6,8.550078e-05);
