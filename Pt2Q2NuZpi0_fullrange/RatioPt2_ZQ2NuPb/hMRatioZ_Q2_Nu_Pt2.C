...
//=========  (Tue May  9 15:46:50 2017) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.9858439,-1.117922,0.9858439,1.117922);
   TView *view = TView::CreateView(1);
   view->SetRange(0.3,0,0,1,1.5,9.983062);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatio->SetBinContent(19,9.054932);
   hMRatio->SetBinContent(22,17.75253);
   hMRatio->SetBinError(19,0.01240517);
   hMRatio->SetBinError(22,0.01545742);
   hMRatio->SetEntries(54);
   hMRatio->SetContour(20);
   hMRatio->SetContourLevel(0,0);
   hMRatio->SetContourLevel(1,0.4527466);
   hMRatio->SetContourLevel(2,0.9054932);
   hMRatio->SetContourLevel(3,1.35824);
   hMRatio->SetContourLevel(4,1.810986);
   hMRatio->SetContourLevel(5,2.263733);
   hMRatio->SetContourLevel(6,2.716479);
   hMRatio->SetContourLevel(7,3.169226);
   hMRatio->SetContourLevel(8,3.621973);
   hMRatio->SetContourLevel(9,4.074719);
   hMRatio->SetContourLevel(10,4.527466);
   hMRatio->SetContourLevel(11,4.980212);
   hMRatio->SetContourLevel(12,5.432959);
   hMRatio->SetContourLevel(13,5.885706);
   hMRatio->SetContourLevel(14,6.338452);
   hMRatio->SetContourLevel(15,6.791199);
   hMRatio->SetContourLevel(16,7.243945);
   hMRatio->SetContourLevel(17,7.696692);
   hMRatio->SetContourLevel(18,8.149438);
   hMRatio->SetContourLevel(19,8.602185);
