...
//=========  (Tue May  9 15:37:45 2017) by ROOT version5.34/34
   ...
   c->Range(-0.1875,0.5300891,1.6875,0.7319896);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.557745);
   hMRatioProj->SetBinContent(2,0.5797141);
   hMRatioProj->SetBinContent(3,0.6109524);
   hMRatioProj->SetBinContent(4,0.6420479);
   hMRatioProj->SetBinContent(5,0.6714255);
   hMRatioProj->SetBinContent(6,0.7039305);
   hMRatioProj->SetBinError(1,0.0001406771);
   hMRatioProj->SetBinError(2,0.0001462183);
   hMRatioProj->SetBinError(3,0.0001540974);
   hMRatioProj->SetBinError(4,0.0001619406);
   hMRatioProj->SetBinError(5,0.0001693508);
   hMRatioProj->SetBinError(6,0.0001775873);
