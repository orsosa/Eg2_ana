...
//=========  (Tue May  9 15:37:45 2017) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.9858439,-1.117922,0.9858439,1.117922);
   TView *view = TView::CreateView(1);
   view->SetRange(0.3,0,0,1,1.5,12.30811);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatio->SetBinContent(19,11.16382);
   hMRatio->SetBinContent(22,22.69816);
   hMRatio->SetBinError(19,0.007495792);
   hMRatio->SetBinError(22,0.007464533);
   hMRatio->SetEntries(54);
   hMRatio->SetContour(20);
   hMRatio->SetContourLevel(0,0);
   hMRatio->SetContourLevel(1,0.5581911);
   hMRatio->SetContourLevel(2,1.116382);
   hMRatio->SetContourLevel(3,1.674573);
   hMRatio->SetContourLevel(4,2.232764);
   hMRatio->SetContourLevel(5,2.790956);
   hMRatio->SetContourLevel(6,3.349147);
   hMRatio->SetContourLevel(7,3.907338);
   hMRatio->SetContourLevel(8,4.465529);
   hMRatio->SetContourLevel(9,5.02372);
   hMRatio->SetContourLevel(10,5.581911);
   hMRatio->SetContourLevel(11,6.140102);
   hMRatio->SetContourLevel(12,6.698293);
   hMRatio->SetContourLevel(13,7.256484);
   hMRatio->SetContourLevel(14,7.814676);
   hMRatio->SetContourLevel(15,8.372867);
   hMRatio->SetContourLevel(16,8.931058);
   hMRatio->SetContourLevel(17,9.489249);
   hMRatio->SetContourLevel(18,10.04744);
   hMRatio->SetContourLevel(19,10.60563);
