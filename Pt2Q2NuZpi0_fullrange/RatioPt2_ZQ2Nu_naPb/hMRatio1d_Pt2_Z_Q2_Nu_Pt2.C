...
//=========  (Tue May  9 15:37:49 2017) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(-0.1875,0.3996214,1.6875,0.5591024);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.4214242);
   hMRatioProj->SetBinContent(2,0.4365513);
   hMRatioProj->SetBinContent(3,0.4702019);
   hMRatioProj->SetBinContent(4,0.4993977);
   hMRatioProj->SetBinContent(5,0.5321608);
   hMRatioProj->SetBinContent(6,0.5369915);
   hMRatioProj->SetBinError(1,6.853355e-05);
   hMRatioProj->SetBinError(2,7.099356e-05);
   hMRatioProj->SetBinError(3,7.646611e-05);
   hMRatioProj->SetBinError(4,8.139205e-05);
   hMRatioProj->SetBinError(5,0.0001045398);
   hMRatioProj->SetBinError(6,8.732983e-05);
