...
//=========  (Tue May  9 15:44:30 2017) by ROOT version5.34/34
   ...
   cn->Range(-0.1875,-0.3900449,1.6875,0.08218812);
   cn->SetFillColor(0);
   cn->SetBorderMode(0);
   cn->SetBorderSize(2);
   cn->SetGridx();
   ...
   hC_Taya->SetBinContent(1,-0.03408325);
   hC_Taya->SetBinContent(2,-0.01222956);
   hC_Taya->SetBinContent(3,-0.01317888);
   hC_Taya->SetBinContent(4,0.004575491);
   hC_Taya->SetBinContent(5,-0.06984448);
   hC_Taya->SetBinContent(6,-0.2792655);
   ...
   hC_Taya->SetMinimum(-0.3428216);
   hC_Taya->SetMaximum(0.03496481);
   ...
   hFe_Taya->SetBinContent(1,-0.02419704);
   hFe_Taya->SetBinContent(2,-0.01340586);
   hFe_Taya->SetBinContent(3,-0.00161463);
   hFe_Taya->SetBinContent(4,-0.0301981);
   hFe_Taya->SetBinContent(5,-0.08134246);
   hFe_Taya->SetBinContent(6,-0.3256495);
   ...
   hPb_Taya->SetBinContent(1,-0.00945279);
   hPb_Taya->SetBinContent(2,-0.001684695);
   hPb_Taya->SetBinContent(3,0.00681591);
   hPb_Taya->SetBinContent(4,0.0177927);
   hPb_Taya->SetBinContent(5,-0.01275718);
   hPb_Taya->SetBinContent(6,-0.06772453);
