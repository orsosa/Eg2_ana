...
//=========  (Wed May 10 11:15:19 2017) by ROOT version5.34/34
   ...
   hC->SetBinContent(1,0.7901908);
   hC->SetBinContent(2,0.8036935);
   hC->SetBinContent(3,0.8177898);
   hC->SetBinContent(4,0.8380224);
   hC->SetBinContent(5,0.8671661);
   hC->SetBinContent(6,0.8819357);
   hC->SetBinError(1,0.0002549537);
   hC->SetBinError(2,0.0002593104);
   hC->SetBinError(3,0.0002638586);
   hC->SetBinError(4,0.000270387);
   hC->SetBinError(5,0.0002797917);
   hC->SetBinError(6,0.0002846548);
   hC->SetEntries(6);
   hC->SetStats(0);
   ...
   hFe->SetBinContent(1,0.5528629);
   hFe->SetBinContent(2,0.5688261);
   hFe->SetBinContent(3,0.5987352);
   hFe->SetBinContent(4,0.6282035);
   hFe->SetBinContent(5,0.6597585);
   hFe->SetBinContent(6,0.6815521);
   hFe->SetBinError(1,0.0001394458);
   hFe->SetBinError(2,0.0001434721);
   hFe->SetBinError(3,0.0001510159);
   hFe->SetBinError(4,0.0001584487);
   hFe->SetBinError(5,0.0001664086);
   hFe->SetBinError(6,0.0001719047);
   hFe->SetEntries(6);
   hFe->SetStats(0);
   ...
   hPb->SetBinContent(1,0.4088871);
   hPb->SetBinContent(2,0.4327119);
   hPb->SetBinContent(3,0.4631853);
   hPb->SetBinContent(4,0.4968998);
   hPb->SetBinContent(5,0.5150436);
   hPb->SetBinContent(6,0.5351147);
   hPb->SetBinError(1,6.651177e-05);
   hPb->SetBinError(2,7.036918e-05);
   hPb->SetBinError(3,7.532502e-05);
   hPb->SetBinError(4,8.108462e-05);
   hPb->SetBinError(5,8.376173e-05);
   hPb->SetBinError(6,8.702435e-05);
   hPb->SetEntries(6);
   hPb->SetStats(0);
