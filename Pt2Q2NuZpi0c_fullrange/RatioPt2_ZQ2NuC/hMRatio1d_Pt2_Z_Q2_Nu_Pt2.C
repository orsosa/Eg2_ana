...
//=========  (Wed May 10 11:16:48 2017) by ROOT version5.34/34
   ...
   c->Range(-0.1875,0.7984389,1.6875,0.9300106);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.8500791);
   hMRatioProj->SetBinContent(2,0.8316535);
   hMRatioProj->SetBinContent(3,0.8294383);
   hMRatioProj->SetBinContent(4,0.8166331);
   hMRatioProj->SetBinContent(5,0.9115471);
   hMRatioProj->SetBinContent(6,0.8521666);
   hMRatioProj->SetBinError(1,0.0002742766);
   hMRatioProj->SetBinError(2,0.0002683316);
   hMRatioProj->SetBinError(3,0.0002676169);
   hMRatioProj->SetBinError(4,0.0002634853);
   hMRatioProj->SetBinError(5,0.0002941091);
   hMRatioProj->SetBinError(6,0.0002749502);
