...
//=========  (Wed May 10 11:16:46 2017) by ROOT version5.34/34
   ...
   c->Range(-0.1875,0.5700632,1.6875,0.7152176);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.6024812);
   hMRatioProj->SetBinContent(2,0.5899938);
   hMRatioProj->SetBinContent(3,0.6045111);
   hMRatioProj->SetBinContent(4,0.6125951);
   hMRatioProj->SetBinContent(5,0.6949971);
   hMRatioProj->SetBinContent(6,0.6655696);
   hMRatioProj->SetBinError(1,0.0001519607);
   hMRatioProj->SetBinError(2,0.0001488111);
   hMRatioProj->SetBinError(3,0.0001524727);
   hMRatioProj->SetBinError(4,0.0001545117);
   hMRatioProj->SetBinError(5,0.0001752955);
   hMRatioProj->SetBinError(6,0.0001678732);
