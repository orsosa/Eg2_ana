...
//=========  (Wed May 10 11:16:46 2017) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.9858439,-1.117922,0.9858439,1.117922);
   TView *view = TView::CreateView(1);
   view->SetRange(0.3,0,0,1,1.5,12.72733);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatio->SetBinContent(19,11.54406);
   hMRatio->SetBinContent(22,22.6583);
   hMRatio->SetBinError(19,0.01664907);
   hMRatio->SetBinError(22,0.01742209);
   hMRatio->SetEntries(54);
   hMRatio->SetContour(20);
   hMRatio->SetContourLevel(0,0);
   hMRatio->SetContourLevel(1,0.577203);
   hMRatio->SetContourLevel(2,1.154406);
   hMRatio->SetContourLevel(3,1.731609);
   hMRatio->SetContourLevel(4,2.308812);
   hMRatio->SetContourLevel(5,2.886015);
   hMRatio->SetContourLevel(6,3.463218);
   hMRatio->SetContourLevel(7,4.040421);
   hMRatio->SetContourLevel(8,4.617624);
   hMRatio->SetContourLevel(9,5.194827);
   hMRatio->SetContourLevel(10,5.77203);
   hMRatio->SetContourLevel(11,6.349233);
   hMRatio->SetContourLevel(12,6.926436);
   hMRatio->SetContourLevel(13,7.503639);
   hMRatio->SetContourLevel(14,8.080842);
   hMRatio->SetContourLevel(15,8.658046);
   hMRatio->SetContourLevel(16,9.235249);
   hMRatio->SetContourLevel(17,9.812452);
   hMRatio->SetContourLevel(18,10.38965);
   hMRatio->SetContourLevel(19,10.96686);
