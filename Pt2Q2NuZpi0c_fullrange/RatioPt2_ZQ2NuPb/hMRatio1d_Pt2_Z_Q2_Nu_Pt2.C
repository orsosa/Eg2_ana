...
//=========  (Wed May 10 11:16:50 2017) by ROOT version5.34/34
   ...
   c->Range(-0.1875,0.4252718,1.6875,0.5616788);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.4439337);
   hMRatioProj->SetBinContent(2,0.455923);
   hMRatioProj->SetBinContent(3,0.4657027);
   hMRatioProj->SetBinContent(4,0.486932);
   hMRatioProj->SetBinContent(5,0.5427534);
   hMRatioProj->SetBinContent(6,0.519779);
   hMRatioProj->SetBinError(1,7.219408e-05);
   hMRatioProj->SetBinError(2,7.414381e-05);
   hMRatioProj->SetBinError(3,7.573423e-05);
   hMRatioProj->SetBinError(4,7.918687e-05);
   hMRatioProj->SetBinError(5,8.826449e-05);
   hMRatioProj->SetBinError(6,8.452831e-05);
