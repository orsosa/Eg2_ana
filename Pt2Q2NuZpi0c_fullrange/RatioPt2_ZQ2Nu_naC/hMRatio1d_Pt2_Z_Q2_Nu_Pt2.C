...
//=========  (Wed May 10 11:13:14 2017) by ROOT version5.34/34
   ...
   c->Range(-0.1875,0.7726036,1.6875,0.8997832);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.7901908);
   hMRatioProj->SetBinContent(2,0.8036935);
   hMRatioProj->SetBinContent(3,0.8177898);
   hMRatioProj->SetBinContent(4,0.8380224);
   hMRatioProj->SetBinContent(5,0.8671661);
   hMRatioProj->SetBinContent(6,0.8819357);
   hMRatioProj->SetBinError(1,0.0002549537);
   hMRatioProj->SetBinError(2,0.0002593104);
   hMRatioProj->SetBinError(3,0.0002638586);
   hMRatioProj->SetBinError(4,0.000270387);
   hMRatioProj->SetBinError(5,0.0002797917);
   hMRatioProj->SetBinError(6,0.0002846548);
