...
//=========  (Wed May 10 11:13:14 2017) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.9858439,-1.117922,0.9858439,1.117922);
   TView *view = TView::CreateView(1);
   view->SetRange(0.3,0,0,1,1.5,16.04252);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatio->SetBinContent(19,14.55104);
   hMRatio->SetBinContent(22,30.39343);
   hMRatio->SetBinError(19,0.01134599);
   hMRatio->SetBinError(22,0.01153802);
   hMRatio->SetEntries(54);
   hMRatio->SetContour(20);
   hMRatio->SetContourLevel(0,0);
   hMRatio->SetContourLevel(1,0.7275521);
   hMRatio->SetContourLevel(2,1.455104);
   hMRatio->SetContourLevel(3,2.182656);
   hMRatio->SetContourLevel(4,2.910208);
   hMRatio->SetContourLevel(5,3.63776);
   hMRatio->SetContourLevel(6,4.365312);
   hMRatio->SetContourLevel(7,5.092865);
   hMRatio->SetContourLevel(8,5.820417);
   hMRatio->SetContourLevel(9,6.547969);
   hMRatio->SetContourLevel(10,7.275521);
   hMRatio->SetContourLevel(11,8.003073);
   hMRatio->SetContourLevel(12,8.730625);
   hMRatio->SetContourLevel(13,9.458177);
   hMRatio->SetContourLevel(14,10.18573);
   hMRatio->SetContourLevel(15,10.91328);
   hMRatio->SetContourLevel(16,11.64083);
   hMRatio->SetContourLevel(17,12.36839);
   hMRatio->SetContourLevel(18,13.09594);
   hMRatio->SetContourLevel(19,13.82349);
