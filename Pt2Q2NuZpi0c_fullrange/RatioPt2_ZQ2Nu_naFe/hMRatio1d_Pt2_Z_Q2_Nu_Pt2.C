...
//=========  (Wed May 10 11:13:12 2017) by ROOT version5.34/34
   ...
   c->Range(-0.1875,0.5284956,1.6875,0.7062744);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.5528629);
   hMRatioProj->SetBinContent(2,0.5688261);
   hMRatioProj->SetBinContent(3,0.5987352);
   hMRatioProj->SetBinContent(4,0.6282035);
   hMRatioProj->SetBinContent(5,0.6597585);
   hMRatioProj->SetBinContent(6,0.6815521);
   hMRatioProj->SetBinError(1,0.0001394458);
   hMRatioProj->SetBinError(2,0.0001434721);
   hMRatioProj->SetBinError(3,0.0001510159);
   hMRatioProj->SetBinError(4,0.0001584487);
   hMRatioProj->SetBinError(5,0.0001664086);
   hMRatioProj->SetBinError(6,0.0001719047);
