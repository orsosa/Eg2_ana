...
//=========  (Wed May 10 11:13:16 2017) by ROOT version5.34/34
   ...
   c->Range(-0.1875,0.3850847,1.6875,0.5592536);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.4088871);
   hMRatioProj->SetBinContent(2,0.4327119);
   hMRatioProj->SetBinContent(3,0.4631853);
   hMRatioProj->SetBinContent(4,0.4968998);
   hMRatioProj->SetBinContent(5,0.5150436);
   hMRatioProj->SetBinContent(6,0.5351147);
   hMRatioProj->SetBinError(1,6.651177e-05);
   hMRatioProj->SetBinError(2,7.036918e-05);
   hMRatioProj->SetBinError(3,7.532502e-05);
   hMRatioProj->SetBinError(4,8.108462e-05);
   hMRatioProj->SetBinError(5,8.376173e-05);
   hMRatioProj->SetBinError(6,8.702435e-05);
