...
//=========  (Fri Apr  7 14:52:14 2017) by ROOT version5.34/19
   ...
   hM_bin28->SetBinContent(42,25);
   hM_bin28->SetBinContent(43,28);
   hM_bin28->SetBinContent(44,26);
   hM_bin28->SetBinContent(45,57);
   hM_bin28->SetBinContent(46,71);
   hM_bin28->SetBinContent(47,95);
   hM_bin28->SetBinContent(48,125);
   hM_bin28->SetBinContent(49,142);
   hM_bin28->SetBinContent(50,166);
   hM_bin28->SetBinContent(51,168);
   hM_bin28->SetBinContent(52,185);
   hM_bin28->SetBinContent(53,173);
   hM_bin28->SetBinContent(54,178);
   hM_bin28->SetBinContent(55,169);
   hM_bin28->SetBinContent(56,147);
   hM_bin28->SetBinContent(57,156);
   hM_bin28->SetBinContent(58,124);
   hM_bin28->SetBinContent(59,99);
   hM_bin28->SetBinContent(60,95);
   hM_bin28->SetBinContent(61,80);
   hM_bin28->SetBinContent(62,55);
   hM_bin28->SetBinContent(63,43);
   hM_bin28->SetBinContent(64,49);
   hM_bin28->SetBinContent(65,41);
   hM_bin28->SetBinContent(66,28);
   hM_bin28->SetBinContent(67,32);
   ...
   hM_bin28->SetBinContent(101,25828);
   hM_bin28->SetEntries(34228);
   
   TF1 *fsig = new TF1("fsig","fmb+fpeak",0.08773038,0.2036638);
   ...
   fsig->SetParameter(0,-17.99589);
   fsig->SetParError(0,3.944809);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,203.8171);
   fsig->SetParError(1,29.22534);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-2.295565e-08);
   fsig->SetParError(2,299.1871);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,161.2073);
   fsig->SetParError(3,4.38337);
   fsig->SetParLimits(3,0,370);
   fsig->SetParameter(4,0.144936);
   fsig->SetParError(4,0.0005177739);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01932224);
   fsig->SetParError(5,6.131722e-05);
   ...
   text = ptstats->AddText("#chi^{2} / ndf = 42.75 / 27");
   text = ptstats->AddText("p0       =   -18 #pm 3.9 ");
   text = ptstats->AddText("p1       = 203.8 #pm 29.2 ");
   text = ptstats->AddText("p2       = -2.296e-08 #pm 2.992e+02 ");
   text = ptstats->AddText("p3       = 161.2 #pm 4.4 ");
   ...
   fmb->SetParameter(0,-17.99589);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,203.8171);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-2.295565e-08);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,161.2073);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.144936);
