...
//=========  (Wed Jan 25 00:09:04 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.6125,3457928,4.4875,3656437);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hNelecLT->SetBinContent(1,3532067);
   hNelecLT->SetBinContent(2,3629024);
   hNelecLT->SetBinContent(3,3484981);
   hNelecLT->SetBinContent(4,5);
   hNelecLT->SetEntries(1.064608e+07);
   ...
   text = ptstats->AddText("Entries =   1.064608e+07");
   text = ptstats->AddText("Mean  =   1.65");
   text = ptstats->AddText("RMS   = 0.5174");
