...
//=========  (Wed Jan 25 00:09:04 2017) by ROOT version5.34/19
   ...
   c->Range(0.6125,1413638,4.4875,1527106);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hNelecST->SetBinContent(1,1429102);
   hNelecST->SetBinContent(2,1511437);
   hNelecST->SetBinContent(3,1502722);
   hNelecST->SetBinContent(4,1);
   hNelecST->SetEntries(4443262);
   ...
   text = ptstats->AddText("Entries = 4443262");
