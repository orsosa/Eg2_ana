...
//=========  (Tue Jan 31 02:18:52 2017) by ROOT version5.34/19
   ...
   c->Range(0.2375,0.8051383,0.8625,0.8723505);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.8593625);
   hMRatioProj->SetBinContent(2,0.8627904);
   hMRatioProj->SetBinContent(3,0.8148611);
   hMRatioProj->SetBinContent(4,0.8222544);
   hMRatioProj->SetBinContent(5,0.8145609);
   hMRatioProj->SetBinError(1,0.0002772718);
   hMRatioProj->SetBinError(2,0.0002783778);
   hMRatioProj->SetBinError(3,0.0002629135);
   hMRatioProj->SetBinError(4,0.000265299);
   hMRatioProj->SetBinError(5,0.0002628167);
