...
//=========  (Wed Jan 25 00:08:50 2017) by ROOT version5.34/19
   ...
   c->Range(0.6125,6354729,4.4875,6822313);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hNelecLT->SetBinContent(1,6538901);
   hNelecLT->SetBinContent(2,6757742);
   hNelecLT->SetBinContent(3,6418452);
   hNelecLT->SetBinContent(4,7);
   hNelecLT->SetEntries(1.97151e+07);
   ...
   text = ptstats->AddText("Entries =    1.97151e+07");
   text = ptstats->AddText("Mean  =  1.648");
   text = ptstats->AddText("RMS   = 0.5161");
