...
//=========  (Wed Jan 25 00:08:50 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.6125,2546989,4.4875,2714368);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hNelecST->SetBinContent(1,2569800);
   hNelecST->SetBinContent(2,2691254);
   hNelecST->SetBinContent(3,2610312);
   hNelecST->SetBinContent(4,1);
   hNelecST->SetEntries(7871367);
   ...
   text = ptstats->AddText("Entries = 7871367");
