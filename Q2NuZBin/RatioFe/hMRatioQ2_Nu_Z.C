...
//=========  (Tue Jan 31 02:18:47 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(31,3.108812);
   hMRatio->SetBinContent(32,3.046984);
   hMRatio->SetBinContent(33,3.050253);
   hMRatio->SetBinError(31,0.0090142);
   hMRatio->SetBinError(32,0.007478591);
   hMRatio->SetBinError(33,0.008425691);
