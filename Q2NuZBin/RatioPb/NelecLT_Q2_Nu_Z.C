...
//=========  (Wed Jan 25 00:09:20 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.6125,5349811,4.4875,5844349);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hNelecLT->SetBinContent(1,5639847);
   hNelecLT->SetBinContent(2,5776056);
   hNelecLT->SetBinContent(3,5417207);
   hNelecLT->SetBinContent(4,5);
   hNelecLT->SetEntries(1.683312e+07);
   ...
   text = ptstats->AddText("Entries =   1.683312e+07");
   text = ptstats->AddText("Mean  =  1.644");
   text = ptstats->AddText("RMS   = 0.5147");
