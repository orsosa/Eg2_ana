...
//=========  (Wed Jan 25 00:09:20 2017) by ROOT version5.34/19
   ...
   c->Range(0.6125,604122.3,4.4875,649210.5);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hNelecST->SetBinContent(1,622244);
   hNelecST->SetBinContent(2,642984);
   hNelecST->SetBinContent(3,610267);
   hNelecST->SetEntries(1875495);
   ...
   text = ptstats->AddText("Entries = 1875495");
