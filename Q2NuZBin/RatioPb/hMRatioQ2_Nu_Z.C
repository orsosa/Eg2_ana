...
//=========  (Tue Jan 31 02:18:58 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(31,2.40547);
   hMRatio->SetBinContent(32,2.398535);
   hMRatio->SetBinContent(33,2.360811);
   hMRatio->SetBinError(31,0.007622227);
   hMRatio->SetBinError(32,0.006678212);
   hMRatio->SetBinError(33,0.006878216);
