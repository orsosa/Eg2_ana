...
//=========  (Tue Jan 31 05:46:59 2017) by ROOT version5.34/19
   ...
   c->Range(0.2375,0.8218233,0.8625,0.8658262);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.8589056);
   hMRatioProj->SetBinContent(2,0.8594723);
   hMRatioProj->SetBinContent(3,0.8280873);
   hMRatioProj->SetBinContent(4,0.8301693);
   hMRatioProj->SetBinContent(5,0.8357449);
   hMRatioProj->SetBinError(1,0.0002771244);
   hMRatioProj->SetBinError(2,0.0002773073);
   hMRatioProj->SetBinError(3,0.0002671809);
   hMRatioProj->SetBinError(4,0.0002678527);
   hMRatioProj->SetBinError(5,0.0002696519);
