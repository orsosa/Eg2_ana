...
//=========  (Tue Jan 31 05:46:59 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(31,12.80917);
   hMRatio->SetBinContent(32,12.92472);
   hMRatio->SetBinContent(33,12.62656);
   hMRatio->SetBinError(31,0.0321411);
   hMRatio->SetBinError(32,0.02214549);
   hMRatio->SetBinError(33,0.01664724);
