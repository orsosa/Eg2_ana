...
//=========  (Tue Jan 31 05:46:54 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.2375,0.5804877,0.8625,0.6579033);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.6470494);
   hMRatioProj->SetBinContent(2,0.6387216);
   hMRatioProj->SetBinContent(3,0.612228);
   hMRatioProj->SetBinContent(4,0.5911871);
   hMRatioProj->SetBinContent(5,0.6072797);
   hMRatioProj->SetBinError(1,0.0001632019);
   hMRatioProj->SetBinError(2,0.0001611015);
   hMRatioProj->SetBinError(3,0.0001544191);
   hMRatioProj->SetBinError(4,0.0001491121);
   hMRatioProj->SetBinError(5,0.0001531716);
