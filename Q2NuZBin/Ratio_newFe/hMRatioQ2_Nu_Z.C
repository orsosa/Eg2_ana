...
//=========  (Tue Jan 31 05:46:54 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(31,9.56216);
   hMRatio->SetBinContent(32,9.45298);
   hMRatio->SetBinContent(33,9.157127);
   hMRatio->SetBinError(31,0.02008491);
   hMRatio->SetBinError(32,0.01741503);
   hMRatio->SetBinError(33,0.01376384);
