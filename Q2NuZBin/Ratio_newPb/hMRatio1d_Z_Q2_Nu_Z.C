...
//=========  (Tue Jan 31 05:47:04 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.2375,0.4426456,0.8625,0.5269986);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.5152661);
   hMRatioProj->SetBinContent(2,0.4924704);
   hMRatioProj->SetBinContent(3,0.4773707);
   hMRatioProj->SetBinContent(4,0.4657457);
   hMRatioProj->SetBinContent(5,0.4542152);
   hMRatioProj->SetBinError(1,8.37944e-05);
   hMRatioProj->SetBinError(2,8.008727e-05);
   hMRatioProj->SetBinError(3,7.763172e-05);
   hMRatioProj->SetBinError(4,7.574727e-05);
   hMRatioProj->SetBinError(5,7.38661e-05);
