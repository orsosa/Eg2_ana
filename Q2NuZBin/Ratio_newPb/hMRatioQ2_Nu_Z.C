...
//=========  (Tue Jan 31 05:47:04 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(31,7.381739);
   hMRatio->SetBinContent(32,7.490525);
   hMRatio->SetBinContent(33,7.123549);
   hMRatio->SetBinError(31,0.0149261);
   hMRatio->SetBinError(32,0.01460465);
   hMRatio->SetBinError(33,0.01106325);
