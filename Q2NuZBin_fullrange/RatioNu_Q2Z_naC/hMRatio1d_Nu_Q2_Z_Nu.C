...
//=========  (Fri Apr  7 14:39:08 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(1.94375,0.7755089,4.50625,0.8495751);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.7858563);
   hMRatioProj->SetBinContent(2,0.8290517);
   hMRatioProj->SetBinContent(3,0.8390762);
   hMRatioProj->SetBinError(1,0.0002535553);
   hMRatioProj->SetBinError(2,0.0002675142);
   hMRatioProj->SetBinError(3,0.0002707829);
