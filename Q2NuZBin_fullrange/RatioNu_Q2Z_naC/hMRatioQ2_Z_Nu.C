...
//=========  (Fri Apr  7 14:39:07 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(1,14.38573);
   hMRatio->SetBinContent(2,14.60781);
   hMRatio->SetBinContent(3,14.90862);
   hMRatio->SetBinError(1,0.00580731);
   hMRatio->SetBinError(2,0.007731409);
   hMRatio->SetBinError(3,0.007771717);
