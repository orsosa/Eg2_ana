...
//=========  (Fri Apr  7 14:39:02 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(1.94375,0.5476222,4.50625,0.6600499);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.563086);
   hMRatioProj->SetBinContent(2,0.6040365);
   hMRatioProj->SetBinContent(3,0.6443616);
   hMRatioProj->SetBinError(1,0.0001420243);
   hMRatioProj->SetBinError(2,0.0001524019);
   hMRatioProj->SetBinError(3,0.0001625241);
