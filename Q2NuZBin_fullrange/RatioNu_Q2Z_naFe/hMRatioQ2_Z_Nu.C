...
//=========  (Fri Apr  7 14:39:01 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(1,10.92342);
   hMRatio->SetBinContent(2,10.76854);
   hMRatio->SetBinContent(3,10.63177);
   hMRatio->SetBinError(1,0.004563653);
   hMRatio->SetBinError(2,0.005903109);
