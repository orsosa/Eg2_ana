...
//=========  (Tue Apr  4 14:46:38 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.6125,0.7853623,4.4875,0.8583245);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.7955624);
   hMRatioProj->SetBinContent(2,0.8449607);
   hMRatioProj->SetBinContent(3,0.8479752);
   hMRatioProj->SetBinError(1,0.0002566869);
   hMRatioProj->SetBinError(2,0.0002726251);
   hMRatioProj->SetBinError(3,0.0002735977);
