...
//=========  (Tue Apr  4 14:46:38 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(1,14.43832);
   hMRatio->SetBinContent(2,15.72989);
   hMRatio->SetBinContent(3,15.14263);
   hMRatio->SetBinError(1,0.02215284);
   hMRatio->SetBinError(2,0.01740695);
   hMRatio->SetBinError(3,0.01872542);
