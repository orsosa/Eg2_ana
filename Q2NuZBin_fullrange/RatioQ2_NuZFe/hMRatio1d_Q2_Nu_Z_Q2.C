...
//=========  (Tue Apr  4 14:46:32 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.6125,0.5995158,4.4875,0.6277912);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.6035215);
   hMRatioProj->SetBinContent(2,0.6237292);
   hMRatioProj->SetBinContent(3,0.604111);
   hMRatioProj->SetBinError(1,0.0001522231);
   hMRatioProj->SetBinError(2,0.00015732);
   hMRatioProj->SetBinError(3,0.000152372);
