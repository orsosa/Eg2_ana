...
//=========  (Tue Apr  4 14:46:32 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(1,10.27601);
   hMRatio->SetBinContent(2,11.50542);
   hMRatio->SetBinContent(3,11.5932);
   hMRatio->SetBinError(1,0.01463005);
   hMRatio->SetBinError(2,0.01017381);
   hMRatio->SetBinError(3,0.0125387);
