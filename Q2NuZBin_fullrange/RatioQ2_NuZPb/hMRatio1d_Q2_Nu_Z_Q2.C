...
//=========  (Tue Apr  4 14:46:44 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.6125,0.4632293,4.4875,0.4878053);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.4666544);
   hMRatioProj->SetBinContent(2,0.4843327);
   hMRatioProj->SetBinContent(3,0.4707417);
   hMRatioProj->SetBinError(1,7.5889e-05);
   hMRatioProj->SetBinError(2,7.876497e-05);
   hMRatioProj->SetBinError(3,7.655369e-05);
