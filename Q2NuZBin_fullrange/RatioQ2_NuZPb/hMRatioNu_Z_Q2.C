...
//=========  (Tue Apr  4 14:46:44 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(1,7.840384);
   hMRatio->SetBinContent(2,8.947886);
   hMRatio->SetBinContent(3,9.134984);
   hMRatio->SetBinError(1,0.01085319);
   hMRatio->SetBinError(2,0.008796413);
   hMRatio->SetBinError(3,0.01118722);
