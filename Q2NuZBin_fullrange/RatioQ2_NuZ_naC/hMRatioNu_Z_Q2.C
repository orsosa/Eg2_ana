...
//=========  (Tue Apr  4 14:50:47 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(1,14.09982);
   hMRatio->SetBinContent(2,14.76052);
   hMRatio->SetBinContent(3,15.04181);
   hMRatio->SetBinError(1,0.009179858);
   hMRatio->SetBinError(2,0.0072551);
