...
//=========  (Tue Apr  4 14:50:41 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.6125,0.6015565,4.4875,0.6134203);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.6116277);
   hMRatioProj->SetBinContent(2,0.6045664);
   hMRatioProj->SetBinContent(3,0.6033255);
   hMRatioProj->SetBinError(1,0.0001542677);
   hMRatioProj->SetBinError(2,0.0001524867);
   hMRatioProj->SetBinError(3,0.0001522298);
