...
//=========  (Tue Apr  4 14:50:53 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.6125,0.4697106,4.4875,0.4751222);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.4739111);
   hMRatioProj->SetBinContent(2,0.4742971);
   hMRatioProj->SetBinContent(3,0.4705246);
   hMRatioProj->SetBinError(1,7.706941e-05);
   hMRatioProj->SetBinError(2,7.773026e-05);
   hMRatioProj->SetBinError(3,7.651866e-05);
