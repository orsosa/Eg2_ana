...
//=========  (Tue Apr  4 14:50:53 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(1,7.647758);
   hMRatio->SetBinContent(2,8.385896);
   hMRatio->SetBinContent(3,9.107576);
   hMRatio->SetBinError(1,0.005717215);
   hMRatio->SetBinError(2,0.004575365);
