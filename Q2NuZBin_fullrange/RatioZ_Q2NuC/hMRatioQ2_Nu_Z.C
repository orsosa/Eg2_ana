...
//=========  (Tue Apr  4 14:18:36 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(36,14.8667);
   hMRatio->SetBinContent(37,15.36065);
   hMRatio->SetBinContent(38,15.08349);
   hMRatio->SetBinError(36,0.01200633);
   hMRatio->SetBinError(37,0.02030323);
   hMRatio->SetBinError(38,0.01872542);
