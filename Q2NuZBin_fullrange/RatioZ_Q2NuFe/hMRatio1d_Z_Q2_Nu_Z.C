...
//=========  (Tue Apr  4 14:18:30 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.2125,0.5377704,1.0875,0.6647527);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.6470538);
   hMRatioProj->SetBinContent(2,0.6387222);
   hMRatioProj->SetBinContent(3,0.6122279);
   hMRatioProj->SetBinContent(4,0.5911832);
   hMRatioProj->SetBinContent(5,0.6072828);
   hMRatioProj->SetBinContent(6,0.5552157);
   hMRatioProj->SetBinError(1,0.0001632031);
   hMRatioProj->SetBinError(2,0.0001611016);
   hMRatioProj->SetBinError(3,0.0001544191);
   hMRatioProj->SetBinError(4,0.0001491111);
   hMRatioProj->SetBinError(5,0.0001531725);
   hMRatioProj->SetBinError(6,0.0001400392);
