...
//=========  (Tue Apr  4 14:18:30 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(36,11.28064);
   hMRatio->SetBinContent(37,11.33375);
   hMRatio->SetBinContent(38,10.76024);
   hMRatio->SetBinError(36,0.01216913);
   hMRatio->SetBinError(37,0.01838852);
   hMRatio->SetBinError(38,0.0125387);
