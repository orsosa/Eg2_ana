...
//=========  (Tue Apr  4 14:18:42 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(36,8.651522);
   hMRatio->SetBinContent(37,8.904222);
   hMRatio->SetBinContent(38,8.367509);
   hMRatio->SetBinError(36,0.01148613);
   hMRatio->SetBinError(37,0.01386986);
   hMRatio->SetBinError(38,0.01118722);
