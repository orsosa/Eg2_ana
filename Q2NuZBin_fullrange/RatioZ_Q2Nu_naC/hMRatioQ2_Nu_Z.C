...
//=========  (Tue Apr  4 14:49:58 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(36,14.38573);
   hMRatio->SetBinContent(37,14.60781);
   hMRatio->SetBinContent(38,14.90862);
   hMRatio->SetBinError(36,0.00580731);
   hMRatio->SetBinError(37,0.007731409);
   hMRatio->SetBinError(38,0.007771717);
