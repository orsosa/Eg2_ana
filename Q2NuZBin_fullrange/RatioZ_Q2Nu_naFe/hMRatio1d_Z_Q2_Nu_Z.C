...
//=========  (Tue Apr  4 14:49:52 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.2125,0.5575407,1.0875,0.6601988);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.6458593);
   hMRatioProj->SetBinContent(2,0.6171958);
   hMRatioProj->SetBinContent(3,0.6004894);
   hMRatioProj->SetBinContent(4,0.5776566);
   hMRatioProj->SetBinContent(5,0.5806092);
   hMRatioProj->SetBinContent(6,0.5716752);
   hMRatioProj->SetBinError(1,0.0001629018);
   hMRatioProj->SetBinError(2,0.0001556721);
   hMRatioProj->SetBinError(3,0.0001514584);
   hMRatioProj->SetBinError(4,0.0001456995);
   hMRatioProj->SetBinError(5,0.0001471169);
   hMRatioProj->SetBinError(6,0.0001441909);
