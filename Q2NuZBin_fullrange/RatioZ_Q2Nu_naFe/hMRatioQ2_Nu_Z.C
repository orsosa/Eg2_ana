...
//=========  (Tue Apr  4 14:49:51 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.9858439,-1.117922,0.9858439,1.117922);
   TView *view = TView::CreateView(1);
   view->SetRange(1,0.3,-1,4.1,1,1.1);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   Double_t yAxis1[7] = {0.3, 0.4, 0.5, 0.6, 0.7, 0.8, 1}; 
   
   TH2F *hMRatio = new TH2F("hMRatio","Multiplicity ratio",3, xAxis1,6, yAxis1);
   hMRatio->SetBinContent(36,10.92342);
   hMRatio->SetBinContent(37,10.76854);
   hMRatio->SetBinContent(38,10.63177);
   hMRatio->SetBinError(36,0.004563653);
   hMRatio->SetBinError(37,0.005903109);
   hMRatio->SetBinError(38,0.004457655);
