...
//=========  (Tue Apr  4 14:50:05 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.2125,0.421124,1.0875,0.5285614);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.5136413);
   hMRatioProj->SetBinContent(2,0.4761633);
   hMRatioProj->SetBinContent(3,0.4724694);
   hMRatioProj->SetBinContent(4,0.4617526);
   hMRatioProj->SetBinContent(5,0.438107);
   hMRatioProj->SetBinContent(6,0.4358366);
   hMRatioProj->SetBinError(1,8.35302e-05);
   hMRatioProj->SetBinError(2,7.743546e-05);
   hMRatioProj->SetBinError(3,7.683493e-05);
   hMRatioProj->SetBinError(4,7.916442e-05);
   hMRatioProj->SetBinError(5,7.124947e-05);
   hMRatioProj->SetBinError(6,7.08792e-05);
