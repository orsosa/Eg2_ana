...
//=========  (Tue Apr  4 14:50:05 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(36,8.40303);
   hMRatio->SetBinContent(37,8.45649);
   hMRatio->SetBinContent(38,8.28171);
   hMRatio->SetBinError(36,0.006441225);
   hMRatio->SetBinError(37,0.006226612);
   hMRatio->SetBinError(38,0.005618942);
