...
//=========  (Tue Apr  4 12:31:35 2017) by ROOT version5.34/19
   ...
   hM_bin22->SetBinContent(50,106);
   hM_bin22->SetBinContent(51,98);
   hM_bin22->SetBinContent(52,120);
   hM_bin22->SetBinContent(53,121);
   hM_bin22->SetBinContent(54,115);
   hM_bin22->SetBinContent(55,99);
   hM_bin22->SetBinContent(56,107);
   ...
   hM_bin22->SetBinContent(101,11106);
   hM_bin22->SetEntries(15209);
   
   TF1 *fsig = new TF1("fsig","fmb+fpeak",0.08562896,0.2015624);
   ...
   fsig->SetParameter(0,-12.00521);
   fsig->SetParError(0,3.450078);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,144.1723);
   fsig->SetParError(1,26.21148);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-2.110592e-07);
   fsig->SetParError(2,535.098);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,99.90409);
   fsig->SetParError(3,3.613286);
   fsig->SetParLimits(3,0,242);
   fsig->SetParameter(4,0.1427897);
   fsig->SetParError(4,0.0007276652);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01932224);
   fsig->SetParError(5,0.0002261894);
   ...
   text = ptstats->AddText("p2       = -2.111e-07 #pm 5.351e+02 ");
   ...
   fmb->SetParameter(0,-12.00521);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,144.1723);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-2.110592e-07);
   fmb->SetParError(2,0);
