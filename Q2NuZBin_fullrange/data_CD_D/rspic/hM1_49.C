...
//=========  (Tue Apr  4 12:35:05 2017) by ROOT version5.34/19
   ...
   hM_bin49->SetBinContent(101,41194);
   hM_bin49->SetEntries(61180);
   ...
   fsig->SetParameter(2,-5.966704e-07);
   ...
   fmb->SetParameter(2,-5.966704e-07);
   fmb->SetParError(2,0);
