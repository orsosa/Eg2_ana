...
//=========  (Tue Apr  4 12:40:27 2017) by ROOT version5.34/19
   ...
   hM_bin33->SetBinContent(79,29);
   hM_bin33->SetBinContent(80,21);
   hM_bin33->SetBinContent(81,24);
   hM_bin33->SetBinContent(82,24);
   hM_bin33->SetBinContent(83,27);
   ...
   hM_bin33->SetBinContent(94,40);
   hM_bin33->SetBinContent(95,36);
   hM_bin33->SetBinContent(96,42);
   hM_bin33->SetBinContent(97,40);
   hM_bin33->SetBinContent(98,36);
   hM_bin33->SetBinContent(99,50);
   hM_bin33->SetBinContent(100,50);
   hM_bin33->SetBinContent(101,38765);
   hM_bin33->SetEntries(47960);
   ...
   fsig->SetParameter(0,4.665343);
   fsig->SetParError(0,3.80924);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,48.23181);
   fsig->SetParError(1,27.77498);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-6.476512e-07);
   fsig->SetParError(2,340.0929);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,111.7687);
   fsig->SetParError(3,3.911975);
   fsig->SetParLimits(3,0,266);
   fsig->SetParameter(4,0.1399448);
   fsig->SetParError(4,0.0006880401);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01932224);
   fsig->SetParError(5,0.0001342667);
   ...
   text = ptstats->AddText("p0       = 4.665 #pm 3.809 ");
   text = ptstats->AddText("p1       = 48.23 #pm 27.77 ");
   text = ptstats->AddText("p2       = -6.477e-07 #pm 3.401e+02 ");
   ...
   fmb->SetParameter(0,4.665343);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,48.23181);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-6.476512e-07);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,111.7687);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1399448);
