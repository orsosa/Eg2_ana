...
//=========  (Tue Apr  4 12:28:54 2017) by ROOT version5.34/19
   ...
   fsig->SetParError(1,99.87672);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-7.006347e-07);
   fsig->SetParError(2,380.2153);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,1120.103);
   fsig->SetParError(3,12.82106);
   fsig->SetParLimits(3,0,2764);
   fsig->SetParameter(4,0.1361178);
   fsig->SetParError(4,0.0002197742);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01932224);
   fsig->SetParError(5,1.225613e-05);
   ...
   fmb->SetParameter(2,-7.006347e-07);
   fmb->SetParError(2,0);
