...
//=========  (Tue Apr  4 13:16:31 2017) by ROOT version5.34/19
   ...
   hM_bin35->SetBinContent(119,6);
   hM_bin35->SetBinContent(120,3);
   hM_bin35->SetBinContent(122,3);
   hM_bin35->SetBinContent(123,3);
   ...
   hM_bin35->SetBinContent(201,4431);
   hM_bin35->SetEntries(5405);
   
   TF1 *fsig = new TF1("fsig","fmb+fpeak",0.08835617,0.1814925);
   ...
   fsig->SetParameter(0,0.5694505);
   fsig->SetParError(0,1.17818);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,3.700919);
   fsig->SetParError(1,8.643186);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-0.005347539);
   fsig->SetParError(2,823.961);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,8.676966);
   fsig->SetParError(3,0.8476731);
   fsig->SetParLimits(3,0,34);
   fsig->SetParameter(4,0.1346081);
   fsig->SetParError(4,0.001647771);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,0.005287913);
   ...
   text = ptstats->AddText("Entries = 5405   ");
   text = ptstats->AddText("Mean  = 0.1465");
   text = ptstats->AddText("RMS   = 0.04381");
   text = ptstats->AddText("#chi^{2} / ndf = 42.12 / 50");
   text = ptstats->AddText("p0       = 0.5695 #pm 1.1782 ");
   text = ptstats->AddText("p1       = 3.701 #pm 8.643 ");
   text = ptstats->AddText("p2       = -0.005348 #pm 823.961060 ");
   text = ptstats->AddText("p3       = 8.677 #pm 0.848 ");
   text = ptstats->AddText("p4       = 0.1346 #pm 0.0016 ");
   text = ptstats->AddText("p5       = 0.01552 #pm 0.00529 ");
   ...
   fmb->SetParameter(0,0.5694505);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,3.700919);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-0.005347539);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,8.676966);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1346081);
