...
//=========  (Tue Jan 31 23:57:57 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(-0.1125,0.7855137,1.0125,0.9111385);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.8178373);
   hMRatioProj->SetBinContent(2,0.8335409);
   hMRatioProj->SetBinContent(3,0.8270034);
   hMRatioProj->SetBinContent(4,0.802893);
   hMRatioProj->SetBinContent(5,0.8278796);
   hMRatioProj->SetBinContent(6,0.8935021);
   hMRatioProj->SetBinError(1,0.0002638738);
   hMRatioProj->SetBinError(2,0.0002689406);
   hMRatioProj->SetBinError(3,0.0002668312);
   hMRatioProj->SetBinError(4,0.0002590521);
   hMRatioProj->SetBinError(5,0.0002671139);
   hMRatioProj->SetBinError(6,0.0002882869);
