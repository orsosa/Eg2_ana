...
//=========  (Tue Jan 31 23:57:57 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(36,15.16888);
   hMRatio->SetBinContent(37,15.28995);
   hMRatio->SetBinContent(38,15.01845);
   hMRatio->SetBinError(36,0.0338032);
   hMRatio->SetBinError(37,0.02802018);
   hMRatio->SetBinError(38,0.02604814);
