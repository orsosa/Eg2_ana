...
//=========  (Tue Jan 31 23:57:52 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(-0.1125,0.5854161,1.0125,0.6487665);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.6398568);
   hMRatioProj->SetBinContent(2,0.6083409);
   hMRatioProj->SetBinContent(3,0.608085);
   hMRatioProj->SetBinContent(4,0.6003619);
   hMRatioProj->SetBinContent(5,0.5941995);
   hMRatioProj->SetBinContent(6,0.6267178);
   hMRatioProj->SetBinError(1,0.0001613878);
   hMRatioProj->SetBinError(2,0.0001534387);
   hMRatioProj->SetBinError(3,0.0001533741);
   hMRatioProj->SetBinError(4,0.0001514262);
   hMRatioProj->SetBinError(5,0.0001498719);
   hMRatioProj->SetBinError(6,0.0001580738);
