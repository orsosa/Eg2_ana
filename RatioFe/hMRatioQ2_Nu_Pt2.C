...
//=========  (Tue Jan 31 23:57:52 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(36,11.20999);
   hMRatio->SetBinContent(37,11.24983);
   hMRatio->SetBinContent(38,10.79749);
   hMRatio->SetBinError(36,0.02091528);
   hMRatio->SetBinError(37,0.02027983);
   hMRatio->SetBinError(38,0.02002352);
