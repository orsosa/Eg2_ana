...
//=========  (Tue Mar 14 11:46:35 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(1,15.16888);
   hMRatio->SetBinContent(2,15.28995);
   hMRatio->SetBinContent(3,15.01845);
   hMRatio->SetBinError(1,0.0338032);
   hMRatio->SetBinError(2,0.02802018);
