...
//=========  (Tue Mar 14 11:46:30 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(1.94375,0.5757736,4.50625,0.6614577);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.5875989);
   hMRatioProj->SetBinContent(2,0.6387964);
   hMRatioProj->SetBinContent(3,0.6494613);
   hMRatioProj->SetBinError(1,0.0001482071);
   hMRatioProj->SetBinError(2,0.0001611203);
   hMRatioProj->SetBinError(3,0.0001638103);
