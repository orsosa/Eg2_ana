...
//=========  (Tue Mar 14 11:46:30 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(1,11.20999);
   hMRatio->SetBinContent(2,11.24983);
   hMRatio->SetBinContent(3,10.79749);
   hMRatio->SetBinError(1,0.02091528);
   hMRatio->SetBinError(2,0.02027983);
