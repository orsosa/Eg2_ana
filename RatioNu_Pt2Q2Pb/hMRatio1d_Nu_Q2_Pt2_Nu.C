...
//=========  (Tue Mar 14 11:46:40 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(1.94375,0.4218684,4.50625,0.5241679);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.4358808);
   hMRatioProj->SetBinContent(2,0.4922257);
   hMRatioProj->SetBinContent(3,0.5099579);
   hMRatioProj->SetBinError(1,7.088448e-05);
   hMRatioProj->SetBinError(2,8.00475e-05);
   hMRatioProj->SetBinError(3,8.293116e-05);
