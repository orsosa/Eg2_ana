...
//=========  (Tue Mar 14 11:46:40 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(1,8.709133);
   hMRatio->SetBinContent(2,8.683434);
   hMRatio->SetBinContent(3,8.003734);
   hMRatio->SetBinError(1,0.01901392);
   hMRatio->SetBinError(2,0.01836576);
