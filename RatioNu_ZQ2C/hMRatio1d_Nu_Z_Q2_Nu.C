...
//=========  (Tue Mar 14 11:41:30 2017) by ROOT version5.34/19
   ...
   c->Range(1.94375,0.7955278,4.50625,0.8901609);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.8086854);
   hMRatioProj->SetBinContent(2,0.8768096);
   hMRatioProj->SetBinContent(3,0.8693654);
   hMRatioProj->SetBinError(1,0.000260921);
   hMRatioProj->SetBinError(2,0.0002829012);
   hMRatioProj->SetBinError(3,0.0002804993);
