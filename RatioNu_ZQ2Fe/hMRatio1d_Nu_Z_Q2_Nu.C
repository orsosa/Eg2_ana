...
//=========  (Tue Mar 14 11:41:25 2017) by ROOT version5.34/19
   ...
   c->Range(1.94375,0.5758121,4.50625,0.6658009);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.5882243);
   hMRatioProj->SetBinContent(2,0.6503515);
   hMRatioProj->SetBinContent(3,0.6532091);
   hMRatioProj->SetBinError(1,0.0001483648);
   hMRatioProj->SetBinError(2,0.000164035);
   hMRatioProj->SetBinError(3,0.0001647556);
