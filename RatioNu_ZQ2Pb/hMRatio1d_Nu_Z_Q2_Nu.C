...
//=========  (Tue Mar 14 11:41:35 2017) by ROOT version5.34/19
   ...
   c->Range(1.94375,0.438447,4.50625,0.5284124);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.4507809);
   hMRatioProj->SetBinContent(2,0.5107986);
   hMRatioProj->SetBinContent(3,0.5159047);
   hMRatioProj->SetBinError(1,7.330759e-05);
   hMRatioProj->SetBinError(2,8.306788e-05);
   hMRatioProj->SetBinError(3,8.389984e-05);
