...
//=========  (Tue Jan 31 23:58:03 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(36,8.709133);
   hMRatio->SetBinContent(37,8.683434);
   hMRatio->SetBinContent(38,8.003734);
   hMRatio->SetBinError(36,0.01901392);
   hMRatio->SetBinError(37,0.01836576);
   hMRatio->SetBinError(38,0.01678877);
