...
//=========  (Wed Feb  1 00:27:41 2017) by ROOT version5.34/34
   ...
   hC->SetBinContent(1,0.8178373);
   hC->SetBinContent(2,0.8335409);
   hC->SetBinContent(3,0.8270034);
   hC->SetBinContent(4,0.802893);
   hC->SetBinContent(5,0.8278796);
   hC->SetBinContent(6,0.8935021);
   hC->SetBinError(1,0.0002638738);
   hC->SetBinError(2,0.0002689406);
   hC->SetBinError(3,0.0002668312);
   hC->SetBinError(4,0.0002590521);
   hC->SetBinError(5,0.0002671139);
   hC->SetBinError(6,0.0002882869);
   hC->SetEntries(6);
   hC->SetStats(0);
   ...
   hFe->SetBinContent(1,0.6398568);
   hFe->SetBinContent(2,0.6083409);
   hFe->SetBinContent(3,0.608085);
   hFe->SetBinContent(4,0.6003619);
   hFe->SetBinContent(5,0.5941995);
   hFe->SetBinContent(6,0.6267178);
   hFe->SetBinError(1,0.0001613878);
   hFe->SetBinError(2,0.0001534387);
   hFe->SetBinError(3,0.0001533741);
   hFe->SetBinError(4,0.0001514262);
   hFe->SetBinError(5,0.0001498719);
   hFe->SetBinError(6,0.0001580738);
   hFe->SetEntries(6);
   hFe->SetStats(0);
   ...
   hPb->SetBinContent(1,0.480713);
   hPb->SetBinContent(2,0.475726);
   hPb->SetBinContent(3,0.4657758);
   hPb->SetBinContent(4,0.4660892);
   hPb->SetBinContent(5,0.45517);
   hPb->SetBinContent(6,0.4690224);
   hPb->SetBinError(1,7.817525e-05);
   hPb->SetBinError(2,7.736425e-05);
   hPb->SetBinError(3,7.574611e-05);
   hPb->SetBinError(4,7.579708e-05);
   hPb->SetBinError(5,7.402136e-05);
   hPb->SetBinError(6,7.627413e-05);
   hPb->SetEntries(6);
   hPb->SetStats(0);
