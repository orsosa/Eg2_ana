...
//=========  (Wed Feb  1 00:25:30 2017) by ROOT version5.34/34
   TCanvas *cn = new TCanvas("cn", "cn",0,0,1200,900);
   cn->Range(-0.1125,0.3125,1.0125,1.1875);
   cn->SetFillColor(0);
   cn->SetBorderMode(0);
   cn->SetBorderSize(2);
   cn->SetGridx();
   ...
   TH1F *hframe__1 = new TH1F("hframe__1","Multiplicity Ratio",1000,0,0.9);
   ...
   pt->Draw();
   Double_t xAxis1[7] = {0, 0.1, 0.25, 0.4, 0.55, 0.75, 0.9}; 
   
   TH1F *hC = new TH1F("hC","Multiplicity Ratio (Pt2)",6, xAxis1);
   hC->SetBinContent(1,0.8324656);
   hC->SetBinContent(2,0.8148545);
   hC->SetBinContent(3,0.8068817);
   hC->SetBinContent(4,0.7984932);
   hC->SetBinContent(5,0.8118121);
   hC->SetBinContent(6,0.8552046);
   hC->SetBinError(1,0.0002685936);
   hC->SetBinError(2,0.0002629114);
   hC->SetBinError(3,0.0002603391);
   hC->SetBinError(4,0.0002576328);
   hC->SetBinError(5,0.0002619304);
   hC->SetBinError(6,0.0002759398);
   hC->SetEntries(6);
   hC->SetStats(0);
   ...
   hFe->SetBinContent(1,0.6479692);
   hFe->SetBinContent(2,0.59661);
   hFe->SetBinContent(3,0.5905743);
   hFe->SetBinContent(4,0.5923725);
   hFe->SetBinContent(5,0.5884071);
   hFe->SetBinContent(6,0.5984778);
   hFe->SetBinError(1,0.0001634339);
   hFe->SetBinError(2,0.0001504799);
   hFe->SetBinError(3,0.0001489575);
   hFe->SetBinError(4,0.0001494112);
   hFe->SetBinError(5,0.0001484112);
   hFe->SetBinError(6,0.0001509547);
   hFe->SetEntries(6);
   hFe->SetStats(0);
   ...
   hFe->Draw("samepe");
   Double_t xAxis3[7] = {0, 0.1, 0.25, 0.4, 0.55, 0.75, 0.9}; 
   
   TH1F *hPb = new TH1F("hPb","Multiplicity Ratio (Pt2)",6, xAxis3);
   hPb->SetBinContent(1,0.4911183);
   hPb->SetBinContent(2,0.4668056);
   hPb->SetBinContent(3,0.4521741);
   hPb->SetBinContent(4,0.4623765);
   hPb->SetBinContent(5,0.4502625);
   hPb->SetBinContent(6,0.4401872);
   hPb->SetBinError(1,7.986748e-05);
   hPb->SetBinError(2,7.591805e-05);
   hPb->SetBinError(3,7.353426e-05);
   hPb->SetBinError(4,7.519404e-05);
   hPb->SetBinError(5,7.322527e-05);
   hPb->SetBinError(6,7.162997e-05);
   hPb->SetEntries(6);
   hPb->SetStats(0);
   ...
   hPb->Draw("samepe");
   Double_t xAxis4[7] = {0, 0.1, 0.25, 0.4, 0.55, 0.75, 0.9}; 
   ...
   hC_Taya->Draw("samepe");
   Double_t xAxis5[7] = {0, 0.1, 0.25, 0.4, 0.55, 0.75, 0.9}; 
   ...
   Double_t xAxis6[7] = {0, 0.1, 0.25, 0.4, 0.55, 0.75, 0.9}; 
