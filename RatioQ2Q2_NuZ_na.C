...
//=========  (Tue Apr  4 14:54:19 2017) by ROOT version5.34/36
   ...
   hC->SetBinContent(1,0.8010003);
   hC->SetBinContent(2,0.8153973);
   hC->SetBinContent(3,0.8434708);
   hC->SetBinError(1,0.0002585426);
   hC->SetBinError(2,0.0002630868);
   hC->SetBinError(3,0.0002721445);
   hC->SetEntries(3);
   hC->SetStats(0);
   ...
   hFe->SetBinContent(1,0.6116277);
   hFe->SetBinContent(2,0.6045664);
   hFe->SetBinContent(3,0.6033255);
   hFe->SetBinError(1,0.0001542677);
   hFe->SetBinError(2,0.0001524867);
   hFe->SetBinError(3,0.0001522298);
   hFe->SetEntries(3);
   hFe->SetStats(0);
   ...
   hPb->SetBinContent(1,0.4739111);
   hPb->SetBinContent(2,0.4742971);
   hPb->SetBinContent(3,0.4705246);
   hPb->SetBinError(1,7.706941e-05);
   hPb->SetBinError(2,7.773026e-05);
   hPb->SetBinError(3,7.651866e-05);
   hPb->SetEntries(3);
   hPb->SetStats(0);
