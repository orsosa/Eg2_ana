...
//=========  (Mon Mar  6 12:00:38 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.6125,0.7953886,4.4875,0.8643956);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.8050527);
   hMRatioProj->SetBinContent(2,0.8387696);
   hMRatioProj->SetBinContent(3,0.8545903);
   hMRatioProj->SetBinError(1,0.0002597489);
   hMRatioProj->SetBinError(2,0.0002706276);
   hMRatioProj->SetBinError(3,0.0002757321);
