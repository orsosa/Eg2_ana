...
//=========  (Mon Mar  6 12:00:38 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(1,14.21179);
   hMRatio->SetBinContent(2,15.94044);
   hMRatio->SetBinContent(3,15.32504);
   hMRatio->SetBinError(1,0.03741279);
   hMRatio->SetBinError(2,0.02573504);
   hMRatio->SetBinError(3,0.02604814);
