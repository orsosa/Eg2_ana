...
//=========  (Mon Mar  6 12:00:32 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.6125,0.6104699,4.4875,0.6327023);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.6136546);
   hMRatioProj->SetBinContent(2,0.6294733);
   hMRatioProj->SetBinContent(3,0.6261306);
   hMRatioProj->SetBinError(1,0.0001547789);
   hMRatioProj->SetBinError(2,0.0001587688);
   hMRatioProj->SetBinError(3,0.0001579257);
