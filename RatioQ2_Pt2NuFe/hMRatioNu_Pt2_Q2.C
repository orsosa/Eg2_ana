...
//=========  (Mon Mar  6 12:00:32 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(1,10.086);
   hMRatio->SetBinContent(2,11.57596);
   hMRatio->SetBinContent(3,11.59534);
   hMRatio->SetBinError(1,0.02204158);
   hMRatio->SetBinError(2,0.01765231);
   hMRatio->SetBinError(3,0.02002352);
