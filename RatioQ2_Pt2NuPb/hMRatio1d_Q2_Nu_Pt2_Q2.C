...
//=========  (Mon Mar  6 12:00:44 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.6125,0.4656407,4.4875,0.4872811);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.4686661);
   hMRatioProj->SetBinContent(2,0.4842139);
   hMRatioProj->SetBinContent(3,0.4727584);
   hMRatioProj->SetBinError(1,7.621615e-05);
   hMRatioProj->SetBinError(2,7.874458e-05);
   hMRatioProj->SetBinError(3,7.688164e-05);
