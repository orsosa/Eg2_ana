...
//=========  (Mon Mar  6 12:00:44 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(1,7.462468);
   hMRatio->SetBinContent(2,8.79233);
   hMRatio->SetBinContent(3,9.141502);
   hMRatio->SetBinError(1,0.008683162);
   hMRatio->SetBinError(2,0.01313097);
   hMRatio->SetBinError(3,0.01678877);
