...
//=========  (Mon Mar  6 15:08:49 2017) by ROOT version5.34/19
   ...
   c->Range(0.6125,0.830034,4.4875,0.8617557);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.8346264);
   hMRatioProj->SetBinContent(2,0.8570986);
   hMRatioProj->SetBinContent(3,0.8528737);
   hMRatioProj->SetBinError(1,0.0002692908);
   hMRatioProj->SetBinError(2,0.0002765414);
   hMRatioProj->SetBinError(3,0.0002751783);
