...
//=========  (Mon Mar  6 15:08:44 2017) by ROOT version5.34/19
   ...
   c->Range(0.6125,0.6195935,4.4875,0.6312649);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.6224399);
   hMRatioProj->SetBinContent(2,0.6294944);
   hMRatioProj->SetBinContent(3,0.6213408);
   hMRatioProj->SetBinError(1,0.0001569948);
   hMRatioProj->SetBinError(2,0.0001587741);
   hMRatioProj->SetBinError(3,0.0001567178);
