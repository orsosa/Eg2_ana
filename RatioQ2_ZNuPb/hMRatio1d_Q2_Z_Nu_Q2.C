...
//=========  (Mon Mar  6 15:08:55 2017) by ROOT version5.34/19
   ...
   c->Range(0.6125,0.4806284,4.4875,0.4952763);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.4827031);
   hMRatioProj->SetBinContent(2,0.4931733);
   hMRatioProj->SetBinContent(3,0.483754);
   hMRatioProj->SetBinError(1,7.84989e-05);
   hMRatioProj->SetBinError(2,8.020331e-05);
   hMRatioProj->SetBinError(3,7.866979e-05);
