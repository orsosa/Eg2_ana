...
//=========  (Tue Apr  4 14:38:15 2017) by ROOT version5.34/36
   ...
   hC->SetBinContent(1,0.8589122);
   hC->SetBinContent(2,0.859473);
   hC->SetBinContent(3,0.8280903);
   hC->SetBinContent(4,0.8301646);
   hC->SetBinContent(5,0.8357567);
   hC->SetBinContent(6,0.7386066);
   hC->SetBinError(1,0.0002771265);
   hC->SetBinError(2,0.0002773075);
   hC->SetBinError(3,0.0002671819);
   hC->SetBinError(4,0.0002678512);
   hC->SetBinError(5,0.0002696558);
   hC->SetBinError(6,0.0002383104);
   hC->SetEntries(6);
   hC->SetStats(0);
   ...
   hFe->SetBinContent(1,0.6470538);
   hFe->SetBinContent(2,0.6387222);
   hFe->SetBinContent(3,0.6122279);
   hFe->SetBinContent(4,0.5911832);
   hFe->SetBinContent(5,0.6072828);
   hFe->SetBinContent(6,0.5552157);
   hFe->SetBinError(1,0.0001632031);
   hFe->SetBinError(2,0.0001611016);
   hFe->SetBinError(3,0.0001544191);
   hFe->SetBinError(4,0.0001491111);
   hFe->SetBinError(5,0.0001531725);
   hFe->SetBinError(6,0.0001400392);
   hFe->SetEntries(6);
   hFe->SetStats(0);
   ...
   hPb->SetBinContent(1,0.5152693);
   hPb->SetBinContent(2,0.4924709);
   hPb->SetBinContent(3,0.4773707);
   hPb->SetBinContent(4,0.4657377);
   hPb->SetBinContent(5,0.454554);
   hPb->SetBinContent(6,0.4251379);
   hPb->SetBinError(1,8.379493e-05);
   hPb->SetBinError(2,8.008736e-05);
   hPb->SetBinError(3,7.763172e-05);
   hPb->SetBinError(4,7.574588e-05);
   hPb->SetBinError(5,7.392119e-05);
   hPb->SetBinError(6,6.913744e-05);
   hPb->SetEntries(6);
   hPb->SetStats(0);
