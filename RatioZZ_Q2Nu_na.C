...
//=========  (Tue Apr  4 14:51:07 2017) by ROOT version5.34/36
   ...
   hC->SetBinContent(1,0.8563728);
   hC->SetBinContent(2,0.8297378);
   hC->SetBinContent(3,0.8181569);
   hC->SetBinContent(4,0.8160998);
   hC->SetBinContent(5,0.7938626);
   hC->SetBinContent(6,0.7748326);
   hC->SetBinError(1,0.0002763073);
   hC->SetBinError(2,0.0002677135);
   hC->SetBinError(3,0.000263977);
   hC->SetBinError(4,0.0002633135);
   hC->SetBinError(5,0.0002564085);
   hC->SetBinError(6,0.0002503384);
   hC->SetEntries(6);
   hC->SetStats(0);
   ...
   hFe->SetBinContent(1,0.6458593);
   hFe->SetBinContent(2,0.6171958);
   hFe->SetBinContent(3,0.6004894);
   hFe->SetBinContent(4,0.5776566);
   hFe->SetBinContent(5,0.5806092);
   hFe->SetBinContent(6,0.5716752);
   hFe->SetBinError(1,0.0001629018);
   hFe->SetBinError(2,0.0001556721);
   hFe->SetBinError(3,0.0001514584);
   hFe->SetBinError(4,0.0001456995);
   hFe->SetBinError(5,0.0001471169);
   hFe->SetBinError(6,0.0001441909);
   hFe->SetEntries(6);
   hFe->SetStats(0);
   ...
   hPb->SetBinContent(1,0.5136413);
   hPb->SetBinContent(2,0.4761633);
   hPb->SetBinContent(3,0.4724694);
   hPb->SetBinContent(4,0.4617526);
   hPb->SetBinContent(5,0.438107);
   hPb->SetBinContent(6,0.4358366);
   hPb->SetBinError(1,8.35302e-05);
   hPb->SetBinError(2,7.743546e-05);
   hPb->SetBinError(3,7.683493e-05);
   hPb->SetBinError(4,7.916442e-05);
   hPb->SetBinError(5,7.124947e-05);
   hPb->SetBinError(6,7.08792e-05);
   hPb->SetEntries(6);
   hPb->SetStats(0);
