...
//=========  (Tue Jan 24 13:32:13 2017) by ROOT version5.34/19
   ...
   c->Range(0.6125,1414244,4.4875,1527690);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hNelecST->SetBinContent(1,1429705);
   hNelecST->SetBinContent(2,1512024);
   hNelecST->SetBinContent(3,1503281);
   hNelecST->SetBinContent(4,1);
   hNelecST->SetEntries(4445011);
   ...
   text = ptstats->AddText("Entries = 4445011");
   text = ptstats->AddText("Mean  =  1.665");
   text = ptstats->AddText("RMS   = 0.5255");
