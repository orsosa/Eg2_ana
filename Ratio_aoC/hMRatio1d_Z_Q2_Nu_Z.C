...
//=========  (Tue Jan 24 13:32:14 2017) by ROOT version5.34/19
   ...
   c->Range(0.2375,0.6739652,0.8625,0.7307147);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.7195995);
   hMRatioProj->SetBinContent(2,0.7224699);
   hMRatioProj->SetBinContent(3,0.6823356);
   hMRatioProj->SetBinContent(4,0.6885266);
   hMRatioProj->SetBinContent(5,0.6820843);
