...
//=========  (Tue Jan 24 13:31:59 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.2375,0.5192629,0.8625,0.6063342);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.5940596);
   hMRatioProj->SetBinContent(2,0.5886851);
   hMRatioProj->SetBinContent(3,0.5591457);
   hMRatioProj->SetBinContent(4,0.538327);
   hMRatioProj->SetBinContent(5,0.5313531);
   hMRatioProj->SetBinError(1,0.0002504179);
   hMRatioProj->SetBinError(2,0.0002481523);
   hMRatioProj->SetBinError(3,0.0002357004);
   hMRatioProj->SetBinError(4,0.0002269245);
   hMRatioProj->SetBinError(5,0.0002239848);
