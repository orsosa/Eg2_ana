...
//=========  (Tue Jan 24 13:32:29 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(0.6125,5351733,4.4875,5846739);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hNelecLT->SetBinContent(1,5642540);
   hNelecLT->SetBinContent(2,5778381);
   hNelecLT->SetBinContent(3,5419193);
   hNelecLT->SetBinContent(4,5);
   hNelecLT->SetEntries(1.684012e+07);
   ...
   text = ptstats->AddText("Entries =   1.684012e+07");
