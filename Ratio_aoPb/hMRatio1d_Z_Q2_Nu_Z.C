...
//=========  (Tue Jan 24 13:32:30 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.2375,0.1868071,0.8625,0.2263916);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.2207553);
   hMRatioProj->SetBinContent(2,0.2102806);
   hMRatioProj->SetBinContent(3,0.1988852);
   hMRatioProj->SetBinContent(4,0.1923498);
   hMRatioProj->SetBinContent(5,0.192551);
   hMRatioProj->SetBinError(1,0.0001699022);
   hMRatioProj->SetBinError(2,0.0001618404);
   hMRatioProj->SetBinError(3,0.0001530701);
   hMRatioProj->SetBinError(4,0.0001480402);
   hMRatioProj->SetBinError(5,0.000148195);
