...
//=========  (Tue Apr  4 14:54:19 2017) by ROOT version5.34/36
   ...
   cn->Range(0.6125,-0.0418016,4.4875,0.02411818);
   cn->SetFillColor(0);
   cn->SetBorderMode(0);
   cn->SetBorderSize(2);
   cn->SetGridx();
   ...
   hC_Taya->SetBinContent(1,-0.02919972);
   hC_Taya->SetBinContent(2,-0.02275467);
   hC_Taya->SetBinContent(3,-0.004951179);
   hC_Taya->SetBinError(1,0.0002585426);
   hC_Taya->SetBinError(2,0.0002630868);
   hC_Taya->SetBinError(3,0.0002721445);
   hC_Taya->SetMinimum(-0.03520962);
   hC_Taya->SetMaximum(0.0175262);
   ...
   hFe_Taya->SetBinContent(1,-0.003365278);
   hFe_Taya->SetBinContent(2,-0.02052963);
   hFe_Taya->SetBinContent(3,-0.03281254);
   ...
   hPb_Taya->SetBinContent(1,0.0138081);
   hPb_Taya->SetBinContent(2,0.01512912);
   hPb_Taya->SetBinContent(3,-0.009501398);
