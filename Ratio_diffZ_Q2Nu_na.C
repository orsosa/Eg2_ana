...
//=========  (Tue Apr  4 14:51:07 2017) by ROOT version5.34/36
   ...
   cn->Range(0.2125,-0.07655632,1.0875,0.1655165);
   cn->SetFillColor(0);
   cn->SetBorderMode(0);
   cn->SetBorderSize(2);
   cn->SetGridx();
   ...
   hC_Taya->SetBinContent(1,0.007437766);
   hC_Taya->SetBinContent(2,-0.00974822);
   hC_Taya->SetBinContent(3,-0.03443313);
   hC_Taya->SetBinContent(4,-0.03795218);
   hC_Taya->SetBinContent(5,-0.02212739);
   hC_Taya->SetBinContent(6,0.02476662);
   ...
   hC_Taya->SetMinimum(-0.05234903);
   hC_Taya->SetMaximum(0.1413093);
   ...
   hFe_Taya->SetBinContent(1,0.002259314);
   hFe_Taya->SetBinContent(2,-0.01839322);
   hFe_Taya->SetBinContent(3,-0.0230996);
   hFe_Taya->SetBinContent(4,-0.04354638);
   hFe_Taya->SetBinContent(5,-0.01108378);
   hFe_Taya->SetBinContent(6,0.06070918);
   ...
   hPb_Taya->SetBinContent(1,0.02029231);
   hPb_Taya->SetBinContent(2,-0.007795691);
   hPb_Taya->SetBinContent(3,0.006868392);
   hPb_Taya->SetBinContent(4,0.0121446);
   hPb_Taya->SetBinContent(5,0.05338103);
   hPb_Taya->SetBinContent(6,0.1325066);
