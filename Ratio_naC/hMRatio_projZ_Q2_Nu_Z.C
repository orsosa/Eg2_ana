...
//=========  (Tue Jan 24 12:18:25 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.2375,4.77644,0.8625,5.225616);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Z->SetBinContent(1,5.150438);
   hMR_Z->SetBinContent(2,4.9765);
   hMR_Z->SetBinContent(3,4.852677);
   hMR_Z->SetBinContent(4,4.893463);
   hMR_Z->SetBinContent(5,4.85896);
   hMR_Z->SetBinError(1,0.01314831);
   hMR_Z->SetBinError(2,0.01375801);
   hMR_Z->SetBinError(3,0.01502308);
   hMR_Z->SetBinError(4,0.01699286);
   hMR_Z->SetBinError(5,0.01880729);
   hMR_Z->SetEntries(14.98747);
   hMR_Z->SetStats(0);
