...
//=========  (Tue Jan 24 12:18:11 2017) by ROOT version5.34/19
   ...
   c->Range(0.6125,2548236,4.4875,2715346);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hNelecST->SetBinContent(1,2571010);
   hNelecST->SetBinContent(2,2692269);
   hNelecST->SetBinContent(3,2611303);
   hNelecST->SetBinContent(4,1);
   hNelecST->SetEntries(7874583);
   ...
   text = ptstats->AddText("Entries = 7874583");
   text = ptstats->AddText("Mean  =  1.657");
   text = ptstats->AddText("RMS   = 0.5211");
