...
//=========  (Tue Jan 24 12:18:11 2017) by ROOT version5.34/19
   ...
   c->Range(0.2375,1.262332,0.8625,1.508552);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,1.474302);
   hMRatioProj->SetBinContent(2,1.412877);
   hMRatioProj->SetBinContent(3,1.369766);
   hMRatioProj->SetBinContent(4,1.32133);
   hMRatioProj->SetBinContent(5,1.296105);
