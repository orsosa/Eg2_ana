...
//=========  (Tue Jan 24 12:18:11 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.2375,3.77542,0.8625,4.536749);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMR_Z->SetBinContent(1,4.422902);
   hMR_Z->SetBinContent(2,4.238002);
   hMR_Z->SetBinContent(3,4.109908);
   hMR_Z->SetBinContent(4,3.968355);
   hMR_Z->SetBinContent(5,3.891527);
   hMR_Z->SetBinError(1,0.008710852);
   hMR_Z->SetBinError(2,0.009195587);
   hMR_Z->SetBinError(3,0.01013562);
   hMR_Z->SetBinError(4,0.0111607);
   hMR_Z->SetBinError(5,0.01235259);
   hMR_Z->SetEntries(14.95958);
   hMR_Z->SetStats(0);
