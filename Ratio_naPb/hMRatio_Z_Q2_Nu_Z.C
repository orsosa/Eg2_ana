...
//=========  (Tue Jan 24 12:18:41 2017) by ROOT version5.34/19
   ...
   c->Range(0.2375,1.627831,0.8625,2.001181);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,1.949455);
   hMRatioProj->SetBinContent(2,1.802532);
   hMRatioProj->SetBinContent(3,1.757838);
   hMRatioProj->SetBinContent(4,1.711348);
   hMRatioProj->SetBinContent(5,1.678855);
