...
//=========  (Tue Jan 10 13:23:47 2017) by ROOT version5.34/03
   TCanvas *cn = new TCanvas("cn", "cn",2,77,1025,898);
   cn->Range(0.2375,0.75625,0.8625,1.19375);
   cn->SetFillColor(0);
   cn->SetBorderMode(0);
   cn->SetBorderSize(2);
   cn->SetGridx();
   ...
   TPaveText *pt = new TPaveText(0.3399164,0.9359611,0.6600836,0.995,"blNDC");
   pt->SetName("title");
   pt->SetBorderSize(0);
   pt->SetFillColor(0);
   pt->SetFillStyle(0);
   ...
   hC->SetBinContent(1,1.049224);
   hC->SetBinContent(2,1.017392);
   hC->SetBinContent(3,0.9845556);
   hC->SetBinContent(4,0.9868599);
   hC->SetBinContent(5,0.9788188);
   hC->SetBinError(1,0.05145665);
   hC->SetBinError(2,0.05263355);
   hC->SetBinError(3,0.05784943);
   hC->SetBinError(4,0.06884915);
   hC->SetBinError(5,0.08800887);
   hC->SetEntries(5);
   hC->SetStats(0);
   ...
   hFe->SetBinContent(1,1.085667);
   hFe->SetBinContent(2,1.039629);
   hFe->SetBinContent(3,0.9975796);
   hFe->SetBinContent(4,0.9699824);
   hFe->SetBinContent(5,0.9487234);
   hFe->SetBinError(1,0.03366656);
   hFe->SetBinError(2,0.03459086);
   hFe->SetBinError(3,0.03822099);
   hFe->SetBinError(4,0.04437404);
   hFe->SetBinError(5,0.05682068);
   hFe->SetEntries(5);
   hFe->SetStats(0);
   ...
   hPb->SetBinContent(1,1.112218);
   hPb->SetBinContent(2,1.052713);
   hPb->SetBinContent(3,0.9983648);
   hPb->SetBinContent(4,0.9867443);
   hPb->SetBinContent(5,0.9630746);
   hPb->SetBinError(1,0.01924056);
   hPb->SetBinError(2,0.01961245);
   hPb->SetBinError(3,0.02120322);
   hPb->SetBinError(4,0.02488388);
   hPb->SetBinError(5,0.03188309);
   hPb->SetEntries(5);
   hPb->SetStats(0);
