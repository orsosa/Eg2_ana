...
//=========  (Wed Feb  1 00:13:32 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(-0.1125,0.7874842,1.0125,0.866375);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.8324656);
   hMRatioProj->SetBinContent(2,0.8148545);
   hMRatioProj->SetBinContent(3,0.8068817);
   hMRatioProj->SetBinContent(4,0.7984932);
   hMRatioProj->SetBinContent(5,0.8118121);
   hMRatioProj->SetBinContent(6,0.8552046);
   hMRatioProj->SetBinError(1,0.0002685936);
   hMRatioProj->SetBinError(2,0.0002629114);
   hMRatioProj->SetBinError(3,0.0002603391);
   hMRatioProj->SetBinError(4,0.0002576328);
   hMRatioProj->SetBinError(5,0.0002619304);
   hMRatioProj->SetBinError(6,0.0002759398);
