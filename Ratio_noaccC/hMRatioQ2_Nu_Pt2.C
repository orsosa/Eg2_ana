...
//=========  (Wed Feb  1 00:13:32 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(36,14.54084);
   hMRatio->SetBinContent(37,14.63293);
   hMRatio->SetBinContent(38,14.86522);
   hMRatio->SetBinError(36,0.01396066);
   hMRatio->SetBinError(37,0.0125398);
   hMRatio->SetBinError(38,0.0118534);
