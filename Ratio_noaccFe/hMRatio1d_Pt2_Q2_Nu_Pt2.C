...
//=========  (Wed Feb  1 00:13:26 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(-0.1125,0.5770136,1.0125,0.6595274);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.6479692);
   hMRatioProj->SetBinContent(2,0.59661);
   hMRatioProj->SetBinContent(3,0.5905743);
   hMRatioProj->SetBinContent(4,0.5923725);
   hMRatioProj->SetBinContent(5,0.5884071);
   hMRatioProj->SetBinContent(6,0.5984778);
   hMRatioProj->SetBinError(1,0.0001634339);
   hMRatioProj->SetBinError(2,0.0001504799);
   hMRatioProj->SetBinError(3,0.0001489575);
   hMRatioProj->SetBinError(4,0.0001494112);
   hMRatioProj->SetBinError(5,0.0001484112);
   hMRatioProj->SetBinError(6,0.0001509547);
