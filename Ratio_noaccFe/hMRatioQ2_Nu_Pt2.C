...
//=========  (Wed Feb  1 00:13:26 2017) by ROOT version5.34/19
   ...
   view->SetRange(1,0,-1,4.1,0.9,1.1);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   Double_t yAxis1[7] = {0, 0.1, 0.25, 0.4, 0.55, 0.75, 0.9}; 
   
   TH2F *hMRatio = new TH2F("hMRatio","Multiplicity ratio",3, xAxis1,6, yAxis1);
   hMRatio->SetBinContent(36,10.77513);
   hMRatio->SetBinContent(37,10.78447);
   hMRatio->SetBinContent(38,10.6615);
   hMRatio->SetBinError(36,0.00729578);
   hMRatio->SetBinError(37,0.007862886);
   hMRatio->SetBinError(38,0.007595089);
