...
//=========  (Wed Feb  1 00:13:37 2017) by ROOT version5.34/19
   ...
   hMRatio->SetBinContent(36,8.367871);
   hMRatio->SetBinContent(37,8.334002);
   hMRatio->SetBinContent(38,7.848118);
   hMRatio->SetBinError(36,0.009021032);
   hMRatio->SetBinError(37,0.009808398);
   hMRatio->SetBinError(38,0.008823105);
