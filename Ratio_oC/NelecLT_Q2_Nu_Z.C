...
//=========  (Tue Jan 24 12:34:02 2017) by ROOT version5.34/19
   ...
   c->Range(0.6125,3459146,4.4875,3657949);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hNelecLT->SetBinContent(1,3533660);
   hNelecLT->SetBinContent(2,3630495);
   hNelecLT->SetBinContent(3,3486239);
   hNelecLT->SetBinContent(4,5);
   hNelecLT->SetEntries(1.06504e+07);
   ...
   text = ptstats->AddText("Entries =    1.06504e+07");
