...
//=========  (Tue Jan 24 12:34:18 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.2375,0.1811903,0.8625,0.2231694);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.2172051);
   hMRatioProj->SetBinContent(2,0.2008351);
   hMRatioProj->SetBinContent(3,0.1958554);
   hMRatioProj->SetBinContent(4,0.1906755);
   hMRatioProj->SetBinContent(5,0.1870552);
   hMRatioProj->SetBinError(1,0.0001671698);
   hMRatioProj->SetBinError(2,0.0001545708);
   hMRatioProj->SetBinError(3,0.0001507383);
   hMRatioProj->SetBinError(4,0.0001467516);
   hMRatioProj->SetBinError(5,0.0001439653);
