...
//=========  (Tue Apr 11 18:12:48 2017) by ROOT version5.34/19
   ...
   hC->SetBinContent(1,0.8540976);
   hC->SetBinContent(2,0.8261374);
   hC->SetBinContent(3,0.813677);
   hC->SetBinContent(4,0.8071432);
   hC->SetBinContent(5,0.7915786);
   hC->SetBinContent(6,0.7703214);
   hC->SetBinError(1,0.0002755731);
   hC->SetBinError(2,0.0002665519);
   hC->SetBinError(3,0.0002625316);
   hC->SetBinError(4,0.0002604237);
   hC->SetBinError(5,0.0002583154);
   hC->SetBinError(6,0.0002485437);
   hC->SetEntries(6);
   hC->SetStats(0);
   ...
   hFe->SetBinContent(1,0.6413378);
   hFe->SetBinContent(2,0.6126826);
   hFe->SetBinContent(3,0.5944229);
   hFe->SetBinContent(4,0.5689529);
   hFe->SetBinContent(5,0.5657347);
   hFe->SetBinContent(6,0.5460372);
   hFe->SetBinError(1,0.0001617613);
   hFe->SetBinError(2,0.0001545338);
   hFe->SetBinError(3,0.0001499283);
   hFe->SetBinError(4,0.0001435042);
   hFe->SetBinError(5,0.0001428462);
   hFe->SetBinError(6,0.0001377251);
   hFe->SetEntries(6);
   hFe->SetStats(0);
   ...
   hPb->SetBinContent(1,0.5096079);
   hPb->SetBinContent(2,0.4718591);
   hPb->SetBinContent(3,0.4664643);
   hPb->SetBinContent(4,0.4552964);
   hPb->SetBinContent(5,0.4285571);
   hPb->SetBinContent(6,0.4170801);
   hPb->SetBinError(1,8.287428e-05);
   hPb->SetBinError(2,7.673552e-05);
   hPb->SetBinError(3,7.585841e-05);
   hPb->SetBinError(4,7.404307e-05);
   hPb->SetBinError(5,6.969741e-05);
   hPb->SetBinError(6,6.784913e-05);
   hPb->SetEntries(6);
   hPb->SetStats(0);
