...
//=========  (Wed Apr 12 11:48:45 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.2125,0.7125004,1.0875,0.8818563);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.8581921);
   hMRatioProj->SetBinContent(2,0.8569863);
   hMRatioProj->SetBinContent(3,0.8192525);
   hMRatioProj->SetBinContent(4,0.8316305);
   hMRatioProj->SetBinContent(5,0.8315657);
   hMRatioProj->SetBinContent(6,0.7358178);
   hMRatioProj->SetBinError(1,0.0002768942);
   hMRatioProj->SetBinError(2,0.0002765052);
   hMRatioProj->SetBinError(3,0.0002643304);
   hMRatioProj->SetBinError(4,0.0002683242);
   hMRatioProj->SetBinError(5,0.0002683066);
   hMRatioProj->SetBinError(6,0.0002374103);
