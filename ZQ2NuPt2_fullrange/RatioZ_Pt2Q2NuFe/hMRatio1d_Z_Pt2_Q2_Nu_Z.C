...
//=========  (Wed Apr 12 11:48:38 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.2125,0.5156526,1.0875,0.6645411);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.643818);
   hMRatioProj->SetBinContent(2,0.6349006);
   hMRatioProj->SetBinContent(3,0.603193);
   hMRatioProj->SetBinContent(4,0.5897305);
   hMRatioProj->SetBinContent(5,0.5899001);
   hMRatioProj->SetBinContent(6,0.5360785);
   hMRatioProj->SetBinError(1,0.0001623869);
   hMRatioProj->SetBinError(2,0.0001601377);
   hMRatioProj->SetBinError(3,0.0001521403);
   hMRatioProj->SetBinError(4,0.0001487447);
   hMRatioProj->SetBinError(5,0.0001487877);
   hMRatioProj->SetBinError(6,0.0001352123);
