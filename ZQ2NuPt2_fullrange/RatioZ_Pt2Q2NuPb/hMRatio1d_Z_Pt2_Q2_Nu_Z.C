...
//=========  (Wed Apr 12 11:48:51 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.2125,0.3902253,1.0875,0.5318963);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.5122489);
   hMRatioProj->SetBinContent(2,0.4885123);
   hMRatioProj->SetBinContent(3,0.4683696);
   hMRatioProj->SetBinContent(4,0.4645178);
   hMRatioProj->SetBinContent(5,0.4422718);
   hMRatioProj->SetBinContent(6,0.409599);
   hMRatioProj->SetBinError(1,8.330373e-05);
   hMRatioProj->SetBinError(2,7.944361e-05);
   hMRatioProj->SetBinError(3,7.616793e-05);
   hMRatioProj->SetBinError(4,7.554153e-05);
   hMRatioProj->SetBinError(5,7.192382e-05);
   hMRatioProj->SetBinError(6,6.661046e-05);
