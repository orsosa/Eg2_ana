...
//=========  (Wed Apr 12 11:49:28 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.2125,0.7542402,1.0875,0.8704166);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.8540976);
   hMRatioProj->SetBinContent(2,0.8261374);
   hMRatioProj->SetBinContent(3,0.813677);
   hMRatioProj->SetBinContent(4,0.8071432);
   hMRatioProj->SetBinContent(5,0.7915786);
   hMRatioProj->SetBinContent(6,0.7703214);
   hMRatioProj->SetBinError(1,0.0002755731);
   hMRatioProj->SetBinError(2,0.0002665519);
   hMRatioProj->SetBinError(3,0.0002625316);
   hMRatioProj->SetBinError(4,0.0002604237);
   hMRatioProj->SetBinError(5,0.0002583154);
   hMRatioProj->SetBinError(6,0.0002485437);
