...
//=========  (Wed Apr 12 11:49:22 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.2125,0.5279446,1.0875,0.6596935);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.6413378);
   hMRatioProj->SetBinContent(2,0.6126826);
   hMRatioProj->SetBinContent(3,0.5944229);
   hMRatioProj->SetBinContent(4,0.5689529);
   hMRatioProj->SetBinContent(5,0.5657347);
   hMRatioProj->SetBinContent(6,0.5460372);
   hMRatioProj->SetBinError(1,0.0001617613);
   hMRatioProj->SetBinError(2,0.0001545338);
   hMRatioProj->SetBinError(3,0.0001499283);
   hMRatioProj->SetBinError(4,0.0001435042);
   hMRatioProj->SetBinError(5,0.0001428462);
   hMRatioProj->SetBinError(6,0.0001377251);
