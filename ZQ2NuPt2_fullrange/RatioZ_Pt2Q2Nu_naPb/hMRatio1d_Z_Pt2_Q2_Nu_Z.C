...
//=========  (Wed Apr 12 11:49:33 2017) by ROOT version5.34/19
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.2125,0.3996061,1.0875,0.5273287);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,0.5096079);
   hMRatioProj->SetBinContent(2,0.4718591);
   hMRatioProj->SetBinContent(3,0.4664643);
   hMRatioProj->SetBinContent(4,0.4552964);
   hMRatioProj->SetBinContent(5,0.4285571);
   hMRatioProj->SetBinContent(6,0.4170801);
   hMRatioProj->SetBinError(1,8.287428e-05);
   hMRatioProj->SetBinError(2,7.673552e-05);
   hMRatioProj->SetBinError(3,7.585841e-05);
   hMRatioProj->SetBinError(4,7.404307e-05);
   hMRatioProj->SetBinError(5,6.969741e-05);
   hMRatioProj->SetBinError(6,6.784913e-05);
