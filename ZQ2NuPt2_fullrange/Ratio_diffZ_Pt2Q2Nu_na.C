...
//=========  (Tue Apr 11 18:12:49 2017) by ROOT version5.34/19
   ...
   cn->Range(0.2125,-0.08337512,1.0875,0.1448751);
   cn->SetFillColor(0);
   cn->SetBorderMode(0);
   cn->SetBorderSize(2);
   cn->SetGridx();
   ...
   hC_Taya->SetBinContent(1,0.005162597);
   hC_Taya->SetBinContent(2,-0.01334858);
   hC_Taya->SetBinContent(3,-0.03891301);
   hC_Taya->SetBinContent(4,-0.0469088);
   hC_Taya->SetBinContent(5,-0.02441138);
   hC_Taya->SetBinContent(6,0.02025545);
   ...
   hC_Taya->SetMinimum(-0.0605501);
   hC_Taya->SetMaximum(0.1220501);
   ...
   hFe_Taya->SetBinContent(1,-0.002262175);
   hFe_Taya->SetBinContent(2,-0.02290642);
   hFe_Taya->SetBinContent(3,-0.0291661);
   hFe_Taya->SetBinContent(4,-0.05225009);
   hFe_Taya->SetBinContent(5,-0.0259583);
   hFe_Taya->SetBinContent(6,0.03507119);
   ...
   hPb_Taya->SetBinContent(1,0.01625893);
   hPb_Taya->SetBinContent(2,-0.01209989);
   hPb_Taya->SetBinContent(3,0.0008633137);
   hPb_Taya->SetBinContent(4,0.005688399);
   hPb_Taya->SetBinContent(5,0.04383111);
   hPb_Taya->SetBinContent(6,0.1137501);
