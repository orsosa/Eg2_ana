...
//=========  (Tue Apr 11 12:11:17 2017) by ROOT version5.34/19
   ...
   hM_bin46->SetBinContent(90,26);
   hM_bin46->SetBinContent(91,41);
   hM_bin46->SetBinContent(92,43);
   hM_bin46->SetBinContent(93,31);
   hM_bin46->SetBinContent(94,49);
   hM_bin46->SetBinContent(95,44);
   hM_bin46->SetBinContent(96,50);
   hM_bin46->SetBinContent(97,29);
   hM_bin46->SetBinContent(98,41);
   hM_bin46->SetBinContent(99,52);
   hM_bin46->SetBinContent(100,57);
   hM_bin46->SetBinContent(101,38998);
   hM_bin46->SetEntries(46263);
   
   TF1 *fsig = new TF1("fsig","fmb+fpeak",0.08053935,0.1964728);
   ...
   fsig->SetParameter(0,-0.6331493);
   fsig->SetParError(0,4.240952);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,111.7072);
   fsig->SetParError(1,31.505);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-6.749869e-07);
   fsig->SetParError(2,1096.685);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,189.1635);
   fsig->SetParError(3,4.81688);
   fsig->SetParLimits(3,0,458);
   fsig->SetParameter(4,0.1385952);
   fsig->SetParError(4,0.0005143359);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01932224);
   fsig->SetParError(5,0.0001736284);
   ...
   text = ptstats->AddText("RMS   = 0.05981");
   text = ptstats->AddText("#chi^{2} / ndf = 36.47 / 28");
   text = ptstats->AddText("p0       = -0.6331 #pm 4.2410 ");
   text = ptstats->AddText("p1       = 111.7 #pm 31.5 ");
   text = ptstats->AddText("p2       = -6.75e-07 #pm 1.10e+03 ");
   ...
   fmb->SetParameter(0,-0.6331493);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,111.7072);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-6.749869e-07);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,189.1635);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1385952);
