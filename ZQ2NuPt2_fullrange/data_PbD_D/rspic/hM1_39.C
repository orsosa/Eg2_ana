...
//=========  (Tue Apr 11 11:56:22 2017) by ROOT version5.34/19
   ...
   hM_bin39->SetBinContent(101,20161);
   hM_bin39->SetEntries(27143);
   
   TF1 *fsig = new TF1("fsig","fmb+fpeak",0.08318237,0.1991158);
   ...
   fsig->SetParameter(0,-14.37268);
   fsig->SetParError(0,5.240384);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,252.1322);
   fsig->SetParError(1,40.57058);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-1.120081e-06);
   fsig->SetParError(2,388.2015);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,199.2104);
   fsig->SetParError(3,5.315711);
   fsig->SetParLimits(3,0,478);
   fsig->SetParameter(4,0.1412317);
   fsig->SetParError(4,0.000519672);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01932224);
   fsig->SetParError(5,8.031635e-05);
   ...
   text = ptstats->AddText("#chi^{2} / ndf = 32.86 / 27");
   text = ptstats->AddText("p0       = -14.37 #pm 5.24 ");
   text = ptstats->AddText("p1       = 252.1 #pm 40.6 ");
   text = ptstats->AddText("p2       = -1.12e-06 #pm 3.88e+02 ");
   ...
   fmb->SetParameter(0,-14.37268);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,252.1322);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-1.120081e-06);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,199.2104);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1412317);
