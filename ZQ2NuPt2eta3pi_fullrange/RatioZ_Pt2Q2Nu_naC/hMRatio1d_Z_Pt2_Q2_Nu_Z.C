...
//=========  (Fri Oct 13 01:30:47 2017) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "c",1,1,1200,876);
   c->SetHighLightColor(2);
   c->Range(0.4375,0.5562295,1.0625,1.63113);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   hMRatioProj->SetBinContent(1,1.295026);
   hMRatioProj->SetBinContent(2,0.9829433);
   hMRatioProj->SetBinContent(3,0.8694235);
   hMRatioProj->SetBinContent(4,0.8146514);
   hMRatioProj->SetBinContent(5,0.7692718);
   hMRatioProj->SetBinError(1,0.1876654);
   hMRatioProj->SetBinError(2,0.09588687);
   hMRatioProj->SetBinError(3,0.04282816);
   hMRatioProj->SetBinError(4,0.04011957);
   hMRatioProj->SetBinError(5,0.06655349);
