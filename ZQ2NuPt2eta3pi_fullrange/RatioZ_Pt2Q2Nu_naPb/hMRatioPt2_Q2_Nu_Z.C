...
//=========  (Fri Oct 13 01:30:49 2017) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "c",0,0,1200,900);
   c->SetHighLightColor(2);
   c->Range(-0.9858439,-1.117922,0.9858439,1.117922);
   TView *view = TView::CreateView(1);
   view->SetRange(0,0.5,-1,1.5,1,1.1);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   Double_t xAxis1[2] = {0, 1.5}; 
   Double_t yAxis1[6] = {0.5, 0.6, 0.7, 0.8, 0.9, 1}; 
   
   TH2F *hMRatio = new TH2F("hMRatio","Multiplicity ratio",1, xAxis1,5, yAxis1);
   hMRatio->SetBinContent(19,1.820855);
   hMRatio->SetBinError(19,0.02386964);
   hMRatio->SetEntries(5);
