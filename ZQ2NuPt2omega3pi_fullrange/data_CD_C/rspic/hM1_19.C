...
//=========  (Wed Oct  4 11:57:55 2017) by ROOT version5.34/34
   ...
   TH1F *hM_bin19 = new TH1F("hM_bin19","M_{#gamma #gamma}",100,0.64,0.92);
   hM_bin19->SetBinContent(101,3);
   hM_bin19->SetEntries(3);
   ...
   text = ptstats->AddText("Entries = 3      ");
