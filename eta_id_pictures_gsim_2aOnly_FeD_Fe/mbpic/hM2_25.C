...
//=========  (Tue Dec 20 13:53:41 2016) by ROOT version5.34/19
   ...
   c->Range(0.425,-8.891659,0.675,80.02492);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   text = ptstats->AddText("Entries = 4147   ");
   text = ptstats->AddText("Mean  =  0.457");
   text = ptstats->AddText("RMS   = 0.004609");
   ...
   fmb->SetParameter(0,-36339.54);
   fmb->SetParError(0,18389.88);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,161474.3);
   fmb->SetParError(1,79869.01);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-179093.9);
   fmb->SetParError(2,86707.94);
