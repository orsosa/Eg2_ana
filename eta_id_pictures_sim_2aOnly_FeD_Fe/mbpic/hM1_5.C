...
//=========  (Tue Dec 20 13:35:37 2016) by ROOT version5.34/19
   ...
   c->Range(0.425,-8.051987,0.675,72.46788);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   hM->SetBinContent(0,3286);
   hM->SetBinContent(1,50);
   hM->SetBinContent(2,54);
   hM->SetBinContent(3,50);
   hM->SetBinContent(4,48);
   hM->SetBinContent(5,42);
   hM->SetBinContent(6,46);
   hM->SetBinContent(7,28);
   ...
   text = ptstats->AddText("Entries = 3630   ");
   text = ptstats->AddText("Mean  = 0.4595");
   text = ptstats->AddText("RMS   = 0.005879");
   ...
   fmb->SetParameter(0,-19157.86);
   fmb->SetParError(0,9910.024);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,85181.67);
   fmb->SetParError(1,42815.97);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-94424.52);
   fmb->SetParError(2,46236.55);
