...
//=========  (Tue Dec 20 13:35:37 2016) by ROOT version5.34/19
   ...
   c->Range(0.425,-3.670785,0.675,49.31742);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   text = ptstats->AddText("Entries = 2578   ");
   ...
   fmb->SetParameter(0,-108.1396);
   fmb->SetParError(0,47.59978);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,484.5352);
   fmb->SetParError(1,174.2123);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-461.7056);
   fmb->SetParError(2,157.8826);
