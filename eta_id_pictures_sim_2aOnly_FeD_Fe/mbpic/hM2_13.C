...
//=========  (Tue Dec 20 13:35:54 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Mean  = 0.5502");
   ...
   fmb->SetParameter(0,-39.63342);
   fmb->SetParError(0,33.61035);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,191.0431);
   fmb->SetParError(1,123.6253);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-184.0588);
   fmb->SetParError(2,112.6269);
