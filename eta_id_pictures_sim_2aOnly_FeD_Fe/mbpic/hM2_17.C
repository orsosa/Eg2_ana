...
//=========  (Tue Dec 20 13:35:55 2016) by ROOT version5.34/19
   ...
   c->Range(0.425,-3.876936,0.675,39.24667);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   text = ptstats->AddText("Entries = 1816   ");
   ...
   fmb->SetParameter(0,41.48598);
   fmb->SetParError(0,42.79107);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-71.79034);
   fmb->SetParError(1,155.8869);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,34.05723);
   fmb->SetParError(2,140.747);
