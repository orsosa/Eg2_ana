...
//=========  (Tue Dec 20 13:35:55 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 1150   ");
   text = ptstats->AddText("Mean  = 0.5518");
   ...
   fmb->SetParameter(0,-31.6558);
   fmb->SetParError(0,29.49912);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,128.4555);
   fmb->SetParError(1,108.9261);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-104.9822);
   fmb->SetParError(2,99.58864);
