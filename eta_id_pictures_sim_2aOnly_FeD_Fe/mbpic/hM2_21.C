...
//=========  (Tue Dec 20 13:35:55 2016) by ROOT version5.34/19
   ...
   c->Range(0.425,-4.36951,0.675,39.32559);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   text = ptstats->AddText("Entries = 1362   ");
   text = ptstats->AddText("Mean  = 0.5315");
   text = ptstats->AddText("RMS   = 0.0512");
   ...
   fmb->SetParameter(0,-34.61404);
   fmb->SetParError(0,41.12614);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,203.7625);
   fmb->SetParError(1,150.7708);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-224.2701);
   fmb->SetParError(2,137.0323);
