...
//=========  (Tue Dec 20 13:35:55 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 1864   ");
   text = ptstats->AddText("Mean  = 0.5444");
   text = ptstats->AddText("RMS   = 0.0561");
   ...
   fmb->SetParameter(0,-67.88297);
   fmb->SetParError(0,36.95851);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,322.5399);
   fmb->SetParError(1,134.2933);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-320.208);
   fmb->SetParError(2,120.8517);
