...
//=========  (Tue Dec 20 13:35:55 2016) by ROOT version5.34/19
   ...
   c->Range(0.425,-2.919347,0.675,26.27412);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   text = ptstats->AddText("Entries = 1158   ");
   text = ptstats->AddText("Mean  = 0.5497");
   text = ptstats->AddText("RMS   = 0.05588");
   ...
   fmb->SetParameter(0,-71.92896);
   fmb->SetParError(0,29.96157);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,286.2295);
   fmb->SetParError(1,110.5842);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-256.903);
   fmb->SetParError(2,100.9895);
