...
//=========  (Tue Dec 20 13:35:56 2016) by ROOT version5.34/19
   ...
   c->Range(0.425,-1.004755,0.675,9.042796);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   text = ptstats->AddText("Entries = 128    ");
   text = ptstats->AddText("Mean  = 0.4948");
   text = ptstats->AddText("RMS   = 0.03127");
   ...
   fmb->SetParameter(0,81.14144);
   fmb->SetParError(0,103.0875);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-307.8682);
   fmb->SetParError(1,413.1354);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,299.9694);
   fmb->SetParError(2,412.873);
