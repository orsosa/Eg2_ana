...
//=========  (Tue Dec 20 13:35:56 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 1022   ");
   ...
   fmb->SetParameter(0,73.80887);
   fmb->SetParError(0,30.93239);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-226.0425);
   fmb->SetParError(1,112.4583);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,185.9759);
   fmb->SetParError(2,101.3806);
