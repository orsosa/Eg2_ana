...
//=========  (Tue Dec 20 13:35:56 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 792    ");
   text = ptstats->AddText("Mean  = 0.5488");
   ...
   fmb->SetParameter(0,34.54478);
   fmb->SetParError(0,27.79151);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-109.7867);
   fmb->SetParError(1,101.8271);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,101.1413);
   fmb->SetParError(2,92.4837);
