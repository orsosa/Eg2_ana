...
//=========  (Tue Dec 20 13:35:53 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 1304   ");
   text = ptstats->AddText("Mean  = 0.5453");
   text = ptstats->AddText("RMS   = 0.05822");
   ...
   fmb->SetParameter(0,141.4387);
   fmb->SetParError(0,32.23);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-476.5293);
   fmb->SetParError(1,116.9151);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,416.5982);
   fmb->SetParError(2,105.2918);
