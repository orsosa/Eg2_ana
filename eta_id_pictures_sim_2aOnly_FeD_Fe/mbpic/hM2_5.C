...
//=========  (Tue Dec 20 13:35:53 2016) by ROOT version5.34/19
   ...
   c->Range(0.425,-8.612071,0.675,77.50863);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   hM->SetBinContent(0,3056);
   hM->SetBinContent(1,58);
   hM->SetBinContent(2,58);
   hM->SetBinContent(3,46);
   hM->SetBinContent(4,32);
   hM->SetBinContent(5,36);
   hM->SetBinContent(6,38);
   hM->SetBinContent(7,44);
   ...
   text = ptstats->AddText("Entries = 3444   ");
   text = ptstats->AddText("Mean  = 0.4613");
   text = ptstats->AddText("RMS   = 0.00761");
   ...
   fmb->SetParameter(0,-7310.449);
   fmb->SetParError(0,5478.434);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,33307.22);
   fmb->SetParError(1,23473.84);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-37651.91);
   fmb->SetParError(2,25137.04);
