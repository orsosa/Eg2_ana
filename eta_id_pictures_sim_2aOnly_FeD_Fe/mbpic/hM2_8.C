...
//=========  (Tue Dec 20 13:35:54 2016) by ROOT version5.34/19
   ...
   c->Range(0.425,-5.227813,0.675,47.05031);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   text = ptstats->AddText("Entries = 2168   ");
   text = ptstats->AddText("Mean  = 0.5424");
   text = ptstats->AddText("RMS   = 0.05657");
   ...
   fmb->SetParameter(0,76.80774);
   fmb->SetParError(0,42.59748);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-200.9642);
   fmb->SetParError(1,154.5919);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,151.1275);
   fmb->SetParError(2,139.0938);
