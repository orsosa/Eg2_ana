...
//=========  (Tue Dec 20 13:35:54 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 1396   ");
   ...
   fmb->SetParameter(0,47.69392);
   fmb->SetParError(0,34.75905);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-142.6005);
   fmb->SetParError(1,127.0743);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,127.1607);
   fmb->SetParError(2,115.1704);
