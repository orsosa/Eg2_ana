...
//=========  (Tue Dec 20 13:45:38 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 1440   ");
   text = ptstats->AddText("Mean  =  0.536");
   text = ptstats->AddText("RMS   = 0.05024");
   text = ptstats->AddText("#chi^{2} / ndf = 76.18 / 67");
   text = ptstats->AddText("p0       = -17.08 #pm 0.55 ");
   text = ptstats->AddText("p1       = 69.21 #pm 0.92 ");
   text = ptstats->AddText("p2       = -53.73 #pm 1.45 ");
   text = ptstats->AddText("p3       = -3.729 #pm 0.280 ");
   text = ptstats->AddText("p4       = 0.6377 #pm 0.0495 ");
   text = ptstats->AddText("p5       = 0.04788 #pm 0.01386 ");
   ...
   fsig->SetParameter(0,-17.08178);
   fsig->SetParError(0,0.5536882);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,69.21088);
   fsig->SetParError(1,0.9230024);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-53.73231);
   fsig->SetParError(2,1.450399);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,-3.729305);
   fsig->SetParError(3,0.2801719);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.6376974);
   fsig->SetParError(4,0.04946036);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.04788352);
   fsig->SetParError(5,0.01386152);
   ...
   fmb->SetParameter(0,-17.08178);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,69.21088);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-53.73231);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,-3.729305);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.6376974);
   fpeak->SetParError(1,0);
   fpeak->SetParLimits(1,0,0);
   fpeak->SetParameter(2,0.04788352);
