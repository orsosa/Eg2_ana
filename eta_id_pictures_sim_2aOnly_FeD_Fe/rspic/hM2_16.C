...
//=========  (Tue Dec 20 13:45:38 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 2760   ");
   text = ptstats->AddText("Mean  =  0.531");
   text = ptstats->AddText("RMS   = 0.05211");
   text = ptstats->AddText("#chi^{2} / ndf =  62.6 / 66");
   text = ptstats->AddText("p0       =  -111 #pm 20.5 ");
   text = ptstats->AddText("p1       = 476.4 #pm 80.6 ");
   text = ptstats->AddText("p2       = -489.1 #pm 80.9 ");
   text = ptstats->AddText("p3       = 10.14 #pm 2.21 ");
   text = ptstats->AddText("p4       = 0.6733 #pm 0.0097 ");
   text = ptstats->AddText("p5       = 0.04843 #pm 0.01789 ");
   ...
   fsig->SetParameter(0,-111.0361);
   fsig->SetParError(0,20.53528);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,476.4353);
   fsig->SetParError(1,80.55935);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-489.0929);
   fsig->SetParError(2,80.93639);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,10.14467);
   fsig->SetParError(3,2.214775);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.6733166);
   fsig->SetParError(4,0.009653629);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.04842946);
   fsig->SetParError(5,0.01788644);
   ...
   fmb->SetParameter(0,-111.0361);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,476.4353);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-489.0929);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,10.14467);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.6733166);
   fpeak->SetParError(1,0);
   fpeak->SetParLimits(1,0,0);
   fpeak->SetParameter(2,0.04842946);
