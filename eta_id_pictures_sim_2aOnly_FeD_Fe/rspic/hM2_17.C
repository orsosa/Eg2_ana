...
//=========  (Tue Dec 20 13:45:38 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 2251   ");
   text = ptstats->AddText("Mean  = 0.5333");
   text = ptstats->AddText("RMS   = 0.05422");
   text = ptstats->AddText("#chi^{2} / ndf = 42.73 / 67");
   text = ptstats->AddText("p0       = -100.4 #pm 13.1 ");
   text = ptstats->AddText("p1       = 445.4 #pm 47.3 ");
   text = ptstats->AddText("p2       =  -466 #pm 44.9 ");
   text = ptstats->AddText("p3       =  12.2 #pm 2.1 ");
   text = ptstats->AddText("p4       = 0.6781 #pm 0.0094 ");
   text = ptstats->AddText("p5       = 0.04821 #pm 0.00324 ");
   ...
   fsig->SetParameter(0,-100.3564);
   fsig->SetParError(0,13.0613);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,445.3723);
   fsig->SetParError(1,47.30197);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-465.991);
   fsig->SetParError(2,44.85231);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,12.20131);
   fsig->SetParError(3,2.111811);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.6781446);
   fsig->SetParError(4,0.00939551);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.04821411);
   fsig->SetParError(5,0.003237409);
   ...
   fmb->SetParameter(0,-100.3564);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,445.3723);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-465.991);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,12.20131);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.6781446);
   fpeak->SetParError(1,0);
   fpeak->SetParLimits(1,0,0);
   fpeak->SetParameter(2,0.04821411);
