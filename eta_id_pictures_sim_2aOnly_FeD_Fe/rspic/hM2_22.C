...
//=========  (Tue Dec 20 13:45:39 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 2412   ");
   text = ptstats->AddText("Mean  = 0.5371");
   text = ptstats->AddText("RMS   = 0.04903");
   text = ptstats->AddText("#chi^{2} / ndf = 107.8 / 66");
   text = ptstats->AddText("p0       = -182.4 #pm 28.1 ");
   text = ptstats->AddText("p1       = 731.1 #pm 111.5 ");
   text = ptstats->AddText("p2       = -712.7 #pm 111.5 ");
   text = ptstats->AddText("p3       = 12.11 #pm 3.50 ");
   text = ptstats->AddText("p4       = 0.6802 #pm 0.0123 ");
   text = ptstats->AddText("p5       = 0.04826 #pm 0.01509 ");
   ...
   fsig->SetParameter(0,-182.39);
   fsig->SetParError(0,28.0604);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,731.051);
   fsig->SetParError(1,111.5236);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-712.739);
   fsig->SetParError(2,111.5292);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,12.11174);
   fsig->SetParError(3,3.498093);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.6802175);
   fsig->SetParError(4,0.01225248);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.04825964);
   fsig->SetParError(5,0.01508763);
   ...
   fmb->SetParameter(0,-182.39);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,731.051);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-712.739);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,12.11174);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.6802175);
   fpeak->SetParError(1,0);
   fpeak->SetParLimits(1,0,0);
   fpeak->SetParameter(2,0.04825964);
