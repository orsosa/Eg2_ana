...
//=========  (Tue Dec 20 13:45:37 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 1521   ");
   text = ptstats->AddText("Mean  = 0.5432");
   text = ptstats->AddText("RMS   = 0.05354");
   text = ptstats->AddText("#chi^{2} / ndf =  64.2 / 68");
   text = ptstats->AddText("p0       = 5.755 #pm 3.228 ");
   text = ptstats->AddText("p1       = -6.875 #pm 5.641 ");
   text = ptstats->AddText("p2       = -1.983e-05 #pm 6.267e+01 ");
   text = ptstats->AddText("p3       = 1.921 #pm 0.723 ");
   text = ptstats->AddText("p4       = 0.5476 #pm 0.0181 ");
   text = ptstats->AddText("p5       = 0.04788 #pm 0.01616 ");
   ...
   fsig->SetParameter(0,5.755109);
   fsig->SetParError(0,3.228017);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,-6.874552);
   fsig->SetParError(1,5.641395);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-1.982733e-05);
   fsig->SetParError(2,62.67039);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,1.92149);
   fsig->SetParError(3,0.7230071);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.547591);
   fsig->SetParError(4,0.01811937);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.04788336);
   fsig->SetParError(5,0.01616424);
   ...
   fmb->SetParameter(0,5.755109);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-6.874552);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-1.982733e-05);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,1.92149);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.547591);
