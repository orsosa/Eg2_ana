...
//=========  (Fri Sep 29 00:27:41 2017) by ROOT version5.34/34
   ...
   TH1F *hM_bin14 = new TH1F("hM_bin14","M_{#gamma #gamma}",100,0.42,0.7);
   hM_bin14->SetBinContent(42,1);
   hM_bin14->SetBinContent(67,1);
   hM_bin14->SetBinContent(83,1);
   hM_bin14->SetBinContent(89,1);
   hM_bin14->SetBinContent(90,1);
   hM_bin14->SetBinContent(92,1);
   hM_bin14->SetBinContent(101,501);
   hM_bin14->SetEntries(507);
   ...
   fsig->SetLineWidth(3);
   fsig->SetChisquare(7.720631e-11);
   fsig->SetNDF(0);
   ...
   fsig->SetParameter(0,9.115347);
   fsig->SetParError(0,1);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,-1.649856);
   fsig->SetParError(1,1.864976);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-25.14936);
   fsig->SetParError(2,3.478106);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,0.3547443);
   fsig->SetParError(3,1.817387);
   ...
   text = ptstats->AddText("Entries = 507    ");
   text = ptstats->AddText("Mean  = 0.6352");
   text = ptstats->AddText("RMS   = 0.05017");
   text = ptstats->AddText("#chi^{2} / ndf = 7.721e-11 / 0");
   text = ptstats->AddText("p0       = 9.115 #pm 1.000 ");
   text = ptstats->AddText("p1       = -1.65 #pm 1.86 ");
   text = ptstats->AddText("p2       = -25.15 #pm 3.48 ");
   text = ptstats->AddText("p3       = 0.3547 #pm 1.8174 ");
   ...
   fmb->SetParameter(0,9.115347);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-1.649856);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-25.14936);
   fmb->SetParError(2,0);
