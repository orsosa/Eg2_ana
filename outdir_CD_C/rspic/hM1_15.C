...
//=========  (Fri Sep 29 00:27:42 2017) by ROOT version5.34/34
   ...
   TH1F *hM_bin15 = new TH1F("hM_bin15","M_{#gamma #gamma}",100,0.42,0.7);
   hM_bin15->SetBinContent(68,1);
   hM_bin15->SetBinContent(81,1);
   hM_bin15->SetBinContent(83,1);
   hM_bin15->SetBinContent(90,1);
   hM_bin15->SetBinContent(93,1);
   hM_bin15->SetBinContent(101,379);
   hM_bin15->SetEntries(384);
   ...
   text = ptstats->AddText("Mean  = 0.6515");
   text = ptstats->AddText("RMS   = 0.02462");
