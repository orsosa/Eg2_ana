...
//=========  (Fri Sep 29 00:27:51 2017) by ROOT version5.34/34
   ...
   TH1F *hM_bin22 = new TH1F("hM_bin22","M_{#gamma #gamma}",100,0.42,0.7);
   hM_bin22->SetBinContent(47,1);
   hM_bin22->SetBinContent(49,1);
   hM_bin22->SetBinContent(60,1);
   hM_bin22->SetBinContent(66,2);
   hM_bin22->SetBinContent(81,1);
   hM_bin22->SetBinContent(84,1);
   hM_bin22->SetBinContent(85,1);
   hM_bin22->SetBinContent(96,1);
   hM_bin22->SetBinContent(97,1);
   hM_bin22->SetBinContent(100,1);
   hM_bin22->SetBinContent(101,383);
   hM_bin22->SetEntries(394);
   ...
   fsig->SetLineWidth(3);
   fsig->SetChisquare(1.281145e-06);
   fsig->SetNDF(0);
   ...
   fsig->SetParameter(0,-1.034086);
   fsig->SetParError(0,0.5773503);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,7.168684);
   fsig->SetParError(1,1.022896);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-6.311865);
   fsig->SetParError(2,1.809222);
   ...
   text = ptstats->AddText("Entries = 394    ");
   text = ptstats->AddText("Mean  = 0.6302");
   text = ptstats->AddText("RMS   = 0.05089");
   text = ptstats->AddText("#chi^{2} / ndf = 1.281e-06 / 0");
   text = ptstats->AddText("p0       = -1.034 #pm 0.577 ");
   text = ptstats->AddText("p1       = 7.169 #pm 1.023 ");
   text = ptstats->AddText("p2       = -6.312 #pm 1.809 ");
   ...
   fmb->SetParameter(0,-1.034086);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,7.168684);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-6.311865);
   fmb->SetParError(2,0);
