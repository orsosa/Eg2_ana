...
//=========  (Fri Sep 29 00:27:58 2017) by ROOT version5.34/34
   ...
   TH1F *hM_bin27 = new TH1F("hM_bin27","M_{#gamma #gamma}",100,0.42,0.7);
   ...
   hM_bin27->SetBinContent(53,1);
   hM_bin27->SetBinContent(56,1);
   hM_bin27->SetBinContent(72,1);
   hM_bin27->SetBinContent(74,2);
   hM_bin27->SetBinContent(94,1);
   hM_bin27->SetBinContent(97,1);
   hM_bin27->SetBinContent(98,1);
   hM_bin27->SetBinContent(99,1);
   hM_bin27->SetBinContent(100,1);
   hM_bin27->SetBinContent(101,461);
   hM_bin27->SetEntries(476);
   ...
   fsig->SetLineWidth(3);
   fsig->SetChisquare(5.477428e-06);
   fsig->SetNDF(0);
   ...
   fsig->SetParameter(0,-1.068273);
   fsig->SetParError(0,0.4082483);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,7.474752);
   fsig->SetParError(1,0.7423235);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-6.747423);
   fsig->SetParError(2,1.34752);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,0.7094886);
   fsig->SetParError(3,2.210846);
   ...
   text = ptstats->AddText("Entries = 476    ");
   text = ptstats->AddText("Mean  = 0.6094");
   text = ptstats->AddText("RMS   = 0.0668");
   text = ptstats->AddText("#chi^{2} / ndf = 5.477e-06 / 0");
   text = ptstats->AddText("p0       = -1.068 #pm 0.408 ");
   text = ptstats->AddText("p1       = 7.475 #pm 0.742 ");
   text = ptstats->AddText("p2       = -6.747 #pm 1.348 ");
   text = ptstats->AddText("p3       = 0.7095 #pm 2.2108 ");
   ...
   fmb->SetParameter(0,-1.068273);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,7.474752);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-6.747423);
   fmb->SetParError(2,0);
