...
//=========  (Fri Sep 29 00:27:59 2017) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "The canvas",1,1,800,576);
   gStyle->SetOptFit(1);
   c->SetHighLightColor(2);
   c->Range(0.385,-0.3624071,0.735,3.261664);
   c->SetBorderSize(2);
   c->SetFrameFillColor(0);
   
   TH1F *hM_bin28 = new TH1F("hM_bin28","M_{#gamma #gamma}",100,0.42,0.7);
   hM_bin28->SetBinContent(63,1);
   hM_bin28->SetBinContent(88,1);
   hM_bin28->SetBinContent(89,1);
   hM_bin28->SetBinContent(91,1);
   hM_bin28->SetBinContent(101,362);
   hM_bin28->SetEntries(366);
   ...
   fsig->SetLineWidth(3);
   fsig->SetChisquare(5.188649e-11);
   fsig->SetNDF(0);
   ...
   fsig->SetParameter(0,9.091065);
   fsig->SetParError(0,1);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,-1.527622);
   fsig->SetParError(1,1.680672);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-20.28709);
   fsig->SetParError(2,2.82464);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,0.3547443);
   fsig->SetParError(3,1.44674);
   ...
   text = ptstats->AddText("Entries = 366    ");
   text = ptstats->AddText("Mean  = 0.6502");
   text = ptstats->AddText("RMS   = 0.03177");
   text = ptstats->AddText("#chi^{2} / ndf = 5.189e-11 / 0");
   text = ptstats->AddText("p0       = 9.091 #pm 1.000 ");
   text = ptstats->AddText("p1       = -1.528 #pm 1.681 ");
   text = ptstats->AddText("p2       = -20.29 #pm 2.82 ");
   text = ptstats->AddText("p3       = 0.3547 #pm 1.4467 ");
   ...
   fmb->SetParameter(0,9.091065);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-1.527622);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-20.28709);
   fmb->SetParError(2,0);
