...
//=========  (Fri Sep 29 00:28:00 2017) by ROOT version5.34/34
   ...
   TH1F *hM_bin29 = new TH1F("hM_bin29","M_{#gamma #gamma}",100,0.42,0.7);
   hM_bin29->SetBinContent(50,1);
   hM_bin29->SetBinContent(95,1);
   hM_bin29->SetBinContent(96,1);
   hM_bin29->SetBinContent(100,1);
   hM_bin29->SetBinContent(101,348);
   hM_bin29->SetEntries(352);
   ...
   fsig->SetLineWidth(3);
   fsig->SetChisquare(6.733917e-11);
   fsig->SetNDF(0);
   ...
   fsig->SetParameter(0,9.105668);
   fsig->SetParError(0,1);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,-1.601023);
   fsig->SetParError(1,1.79019);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-23.11077);
   fsig->SetParError(2,3.204755);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,0.3547443);
   fsig->SetParError(3,1.053687);
   ...
   text = ptstats->AddText("Entries = 352    ");
   text = ptstats->AddText("Mean  = 0.6575");
   text = ptstats->AddText("RMS   = 0.05785");
   text = ptstats->AddText("#chi^{2} / ndf = 6.734e-11 / 0");
   text = ptstats->AddText("p0       = 9.106 #pm 1.000 ");
   text = ptstats->AddText("p1       = -1.601 #pm 1.790 ");
   text = ptstats->AddText("p2       = -23.11 #pm 3.20 ");
   text = ptstats->AddText("p3       = 0.3547 #pm 1.0537 ");
   ...
   fmb->SetParameter(0,9.105668);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-1.601023);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-23.11077);
   fmb->SetParError(2,0);
