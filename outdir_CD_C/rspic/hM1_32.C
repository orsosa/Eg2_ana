...
//=========  (Fri Sep 29 00:28:04 2017) by ROOT version5.34/34
   ...
   TH1F *hM_bin32 = new TH1F("hM_bin32","M_{#gamma #gamma}",100,0.42,0.7);
   hM_bin32->SetBinContent(35,1);
   hM_bin32->SetBinContent(37,1);
   hM_bin32->SetBinContent(47,1);
   hM_bin32->SetBinContent(53,1);
   hM_bin32->SetBinContent(55,1);
   hM_bin32->SetBinContent(56,2);
   hM_bin32->SetBinContent(63,1);
   hM_bin32->SetBinContent(64,1);
   hM_bin32->SetBinContent(65,1);
   hM_bin32->SetBinContent(73,1);
   hM_bin32->SetBinContent(82,1);
   hM_bin32->SetBinContent(89,1);
   hM_bin32->SetBinContent(90,1);
   hM_bin32->SetBinContent(91,1);
   hM_bin32->SetBinContent(99,1);
   hM_bin32->SetBinContent(100,1);
   hM_bin32->SetBinContent(101,497);
   hM_bin32->SetEntries(514);
   ...
   fsig->SetParameter(0,0.3999588);
   fsig->SetParError(0,0.3922323);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,1.451002);
   fsig->SetParError(1,0.6897856);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-0.4558863);
   fsig->SetParError(2,1.208671);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,0.7094886);
   fsig->SetParError(3,2.35444);
   ...
   text = ptstats->AddText("Entries = 514    ");
   text = ptstats->AddText("Mean  = 0.6088");
   text = ptstats->AddText("RMS   = 0.05649");
   text = ptstats->AddText("#chi^{2} / ndf = 0.458 / 1");
   text = ptstats->AddText("p0       =   0.4 #pm 0.4 ");
   text = ptstats->AddText("p1       = 1.451 #pm 0.690 ");
   text = ptstats->AddText("p2       = -0.4559 #pm 1.2087 ");
   text = ptstats->AddText("p3       = 0.7095 #pm 2.3544 ");
   ...
   fmb->SetParameter(0,0.3999588);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,1.451002);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-0.4558863);
   fmb->SetParError(2,0);
