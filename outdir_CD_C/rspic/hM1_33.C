...
//=========  (Fri Sep 29 00:28:06 2017) by ROOT version5.34/34
   ...
   TH1F *hM_bin33 = new TH1F("hM_bin33","M_{#gamma #gamma}",100,0.42,0.7);
   hM_bin33->SetBinContent(36,1);
   hM_bin33->SetBinContent(101,427);
   hM_bin33->SetEntries(428);
   ...
   text = ptstats->AddText("Mean  = 0.5185");
