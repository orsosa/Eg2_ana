...
//=========  (Fri Sep 29 00:28:07 2017) by ROOT version5.34/34
   TCanvas *c = new TCanvas("c", "The canvas",1,1,800,576);
   gStyle->SetOptFit(1);
   c->SetHighLightColor(2);
   c->Range(0.385,-0.13125,0.735,1.18125);
   c->SetBorderSize(2);
   c->SetFrameFillColor(0);
   
   TH1F *hM_bin34 = new TH1F("hM_bin34","M_{#gamma #gamma}",100,0.42,0.7);
   hM_bin34->SetBinContent(101,273);
   hM_bin34->SetEntries(273);
   ...
   text = ptstats->AddText("Entries = 273    ");
