...
//=========  (Fri Sep 29 00:28:23 2017) by ROOT version5.34/34
   ...
   TH1F *hM_bin46 = new TH1F("hM_bin46","M_{#gamma #gamma}",100,0.42,0.7);
   hM_bin46->SetBinContent(34,1);
   hM_bin46->SetBinContent(47,1);
   hM_bin46->SetBinContent(48,1);
   hM_bin46->SetBinContent(88,2);
   hM_bin46->SetBinContent(94,1);
   hM_bin46->SetBinContent(97,1);
   hM_bin46->SetBinContent(101,400);
   hM_bin46->SetEntries(407);
   ...
   fsig->SetParameter(0,9.119363);
   fsig->SetParError(0,0.7071068);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,-1.596188);
   fsig->SetParError(1,1.281915);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-23.79091);
   fsig->SetParError(2,2.323946);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,0.7094886);
   fsig->SetParError(3,2.329278);
   ...
   text = ptstats->AddText("Mean  = 0.6171");
   text = ptstats->AddText("RMS   = 0.06899");
   text = ptstats->AddText("#chi^{2} / ndf = 0.003039 / 0");
   text = ptstats->AddText("p0       = 9.119 #pm 0.707 ");
   text = ptstats->AddText("p1       = -1.596 #pm 1.282 ");
   text = ptstats->AddText("p2       = -23.79 #pm 2.32 ");
   text = ptstats->AddText("p3       = 0.7095 #pm 2.3293 ");
   ...
   fmb->SetParameter(0,9.119363);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-1.596188);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-23.79091);
   fmb->SetParError(2,0);
