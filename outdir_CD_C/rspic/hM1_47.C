...
//=========  (Fri Sep 29 00:28:25 2017) by ROOT version5.34/34
   ...
   TH1F *hM_bin47 = new TH1F("hM_bin47","M_{#gamma #gamma}",100,0.42,0.7);
   hM_bin47->SetBinContent(23,1);
   hM_bin47->SetBinContent(24,1);
   hM_bin47->SetBinContent(93,1);
   hM_bin47->SetBinContent(101,338);
   hM_bin47->SetEntries(341);
   ...
   text = ptstats->AddText("Entries = 341    ");
   text = ptstats->AddText("Mean  = 0.5487");
   text = ptstats->AddText("RMS   = 0.09135");
