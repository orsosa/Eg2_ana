...
//=========  (Fri Sep 29 00:28:31 2017) by ROOT version5.34/34
   ...
   TH1F *hM_bin51 = new TH1F("hM_bin51","M_{#gamma #gamma}",100,0.42,0.7);
   hM_bin51->SetBinContent(69,1);
   hM_bin51->SetBinContent(73,1);
   hM_bin51->SetBinContent(81,1);
   hM_bin51->SetBinContent(82,1);
   hM_bin51->SetBinContent(84,1);
   hM_bin51->SetBinContent(99,1);
   hM_bin51->SetBinContent(101,506);
   hM_bin51->SetEntries(512);
   ...
   text = ptstats->AddText("Mean  = 0.6459");
   text = ptstats->AddText("RMS   = 0.02629");
