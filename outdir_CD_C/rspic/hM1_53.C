...
//=========  (Fri Sep 29 00:28:33 2017) by ROOT version5.34/34
   ...
   TH1F *hM_bin53 = new TH1F("hM_bin53","M_{#gamma #gamma}",100,0.42,0.7);
   hM_bin53->SetBinContent(101,246);
   hM_bin53->SetEntries(246);
   ...
   text = ptstats->AddText("Entries = 246    ");
