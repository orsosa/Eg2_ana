...
//=========  (Fri Sep 29 00:27:35 2017) by ROOT version5.34/34
   ...
   TH1F *hM_bin9 = new TH1F("hM_bin9","M_{#gamma #gamma}",100,0.42,0.7);
   hM_bin9->SetBinContent(47,1);
   hM_bin9->SetBinContent(54,1);
   hM_bin9->SetBinContent(62,1);
   hM_bin9->SetBinContent(64,1);
   hM_bin9->SetBinContent(71,1);
   hM_bin9->SetBinContent(74,1);
   hM_bin9->SetBinContent(82,1);
   hM_bin9->SetBinContent(90,1);
   hM_bin9->SetBinContent(92,1);
   hM_bin9->SetBinContent(97,1);
   hM_bin9->SetBinContent(98,1);
   hM_bin9->SetBinContent(100,1);
   hM_bin9->SetBinContent(101,437);
   hM_bin9->SetEntries(449);
   ...
   fsig->SetLineWidth(3);
   fsig->SetChisquare(6.645475e-06);
   fsig->SetNDF(0);
   ...
   fsig->SetParameter(0,-0.8617909);
   fsig->SetParError(0,0.5);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,6.501281);
   fsig->SetParError(1,0.8653363);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-5.669088);
   fsig->SetParError(2,1.494435);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,0.3547443);
   fsig->SetParError(3,1.817265);
   ...
   text = ptstats->AddText("Mean  = 0.6363");
   text = ptstats->AddText("RMS   = 0.04891");
   text = ptstats->AddText("#chi^{2} / ndf = 6.645e-06 / 0");
   text = ptstats->AddText("p0       = -0.8618 #pm 0.5000 ");
   text = ptstats->AddText("p1       = 6.501 #pm 0.865 ");
   text = ptstats->AddText("p2       = -5.669 #pm 1.494 ");
   text = ptstats->AddText("p3       = 0.3547 #pm 1.8173 ");
   ...
   fmb->SetParameter(0,-0.8617909);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,6.501281);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-5.669088);
   fmb->SetParError(2,0);
