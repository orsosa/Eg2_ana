...
//=========  (Wed Sep 14 17:45:36 2016) by ROOT version5.34/19
   ...
   c->Range(0.06625,-1.15075,0.20375,5.023843);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hM->SetBinContent(36,166);
   hM->SetBinContent(37,2122);
   hM->SetBinContent(38,13338);
   hM->SetBinContent(39,2191);
   ...
   text = ptstats->AddText("Entries = 18370  ");
   text = ptstats->AddText("Mean  = 0.1351");
   text = ptstats->AddText("RMS   = 0.003697");
   text = ptstats->AddText("#chi^{2} / ndf = 487.3 / 66");
   text = ptstats->AddText("p0       = -3.201 #pm 3.867 ");
   text = ptstats->AddText("p1       = 76.05 #pm 61.66 ");
   text = ptstats->AddText("p2       = -226.3 #pm 232.7 ");
   text = ptstats->AddText("p3       = 1.328e+04 #pm 1.163e+02 ");
   text = ptstats->AddText("p4       = 0.135 #pm 0.000 ");
   text = ptstats->AddText("p5       = 0.0007724 #pm 0.0000038 ");
   ...
   fsig->SetParameter(0,-3.20134);
   fsig->SetParError(0,3.866969);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,76.05175);
   fsig->SetParError(1,61.66337);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-226.2533);
   fsig->SetParError(2,232.6879);
   fsig->SetParLimits(2,0,0);
   fsig->SetParameter(3,13280.75);
   fsig->SetParError(3,116.3206);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1350065);
   fsig->SetParError(4,6.094284e-06);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.0007724018);
   fsig->SetParError(5,3.83471e-06);
   ...
   fmb->SetParameter(0,-3.20134);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,76.05175);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-226.2533);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,13280.75);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1350065);
   fpeak->SetParError(1,0);
   fpeak->SetParLimits(1,0,0);
   fpeak->SetParameter(2,0.0007724018);
