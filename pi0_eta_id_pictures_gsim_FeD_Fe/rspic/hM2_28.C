...
//=========  (Wed Sep 14 17:45:38 2016) by ROOT version5.34/19
   ...
   c->Range(0.06625,-1.138496,0.20375,4.913561);
   c->SetBorderSize(2);
   c->SetLogy();
   ...
   hM->SetBinContent(37,1747);
   hM->SetBinContent(38,10632);
   hM->SetBinContent(39,1740);
   ...
   text = ptstats->AddText("RMS   = 0.002489");
   text = ptstats->AddText("#chi^{2} / ndf = 367.3 / 45");
   text = ptstats->AddText("p0       = -3.301 #pm 3.272 ");
   text = ptstats->AddText("p1       = 75.63 #pm 50.99 ");
   text = ptstats->AddText("p2       = -276.3 #pm 188.7 ");
   text = ptstats->AddText("p3       = 1.058e+04 #pm 1.041e+02 ");
   text = ptstats->AddText("p4       = 0.135 #pm 0.000 ");
   text = ptstats->AddText("p5       = 0.0007758 #pm 0.0000043 ");
   ...
   fsig->SetParameter(0,-3.30088);
   fsig->SetParError(0,3.272005);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,75.63485);
   fsig->SetParError(1,50.98824);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-276.3343);
   fsig->SetParError(2,188.6734);
   fsig->SetParLimits(2,0,0);
   fsig->SetParameter(3,10583.29);
   fsig->SetParError(3,104.0515);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1349992);
   fsig->SetParError(4,6.833258e-06);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.0007757974);
   fsig->SetParError(5,4.332569e-06);
   ...
   fmb->SetParameter(0,-3.30088);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,75.63485);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-276.3343);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,10583.29);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1349992);
   fpeak->SetParError(1,0);
   fpeak->SetParLimits(1,0,0);
   fpeak->SetParameter(2,0.0007757974);
