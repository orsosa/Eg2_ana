...
//=========  (Tue Oct 11 11:03:50 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 622    ");
   ...
   fmb->SetParameter(0,-6.600985);
   fmb->SetParError(0,5.692838);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,173.6986);
   fmb->SetParError(1,88.7584);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-553.1858);
   fmb->SetParError(2,329.9371);
