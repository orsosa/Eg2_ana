...
//=========  (Tue Oct 11 11:03:50 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 430    ");
   ...
   fmb->SetParameter(0,1.89989);
   fmb->SetParError(0,4.781221);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,12.60415);
   fmb->SetParError(1,74.08931);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,44.15172);
   fmb->SetParError(2,274.837);
