...
//=========  (Tue Oct 11 11:03:50 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 240    ");
   text = ptstats->AddText("Mean  = 0.1444");
   text = ptstats->AddText("RMS   = 0.02966");
   ...
   fmb->SetParameter(0,7.257139);
   fmb->SetParError(0,5.018871);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-78.89693);
   fmb->SetParError(1,74.7387);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,333.5927);
   fmb->SetParError(2,270.5359);
