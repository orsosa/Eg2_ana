...
//=========  (Tue Oct 11 11:03:49 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.03062");
   ...
   fmb->SetParameter(0,3.776404);
   fmb->SetParError(0,4.199314);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-32.66282);
   fmb->SetParError(1,65.77486);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,195.0621);
   fmb->SetParError(2,247.2719);
