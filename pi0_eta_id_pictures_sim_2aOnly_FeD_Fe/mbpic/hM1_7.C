...
//=========  (Tue Oct 11 11:03:50 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 630    ");
   text = ptstats->AddText("Mean  = 0.1424");
   text = ptstats->AddText("RMS   = 0.02986");
   ...
   fmb->SetParameter(0,-13.06434);
   fmb->SetParError(0,5.252037);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,256.268);
   fmb->SetParError(1,83.56932);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-770.3106);
   fmb->SetParError(2,315.0249);
