...
//=========  (Tue Oct 11 11:03:50 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.03152");
   ...
   fmb->SetParameter(0,7.47674);
   fmb->SetParError(0,5.35728);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-77.33685);
   fmb->SetParError(1,80.60225);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,316.2185);
   fmb->SetParError(2,292.8144);
