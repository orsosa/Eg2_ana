...
//=========  (Tue Oct 11 11:03:54 2016) by ROOT version5.34/19
   ...
   fmb->SetParameter(0,5.296128);
   fmb->SetParError(0,6.953944);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-44.51482);
   fmb->SetParError(1,110.5827);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,618.5946);
   fmb->SetParError(2,419.8702);
