...
//=========  (Tue Oct 11 11:03:54 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 750    ");
   ...
   fmb->SetParameter(0,-2.898773);
   fmb->SetParError(0,5.596001);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,145.9128);
   fmb->SetParError(1,86.66466);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-517.7323);
   fmb->SetParError(2,320.3571);
