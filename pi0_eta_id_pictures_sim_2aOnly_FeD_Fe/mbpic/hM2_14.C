...
//=========  (Tue Oct 11 11:03:54 2016) by ROOT version5.34/19
   ...
   fmb->SetParameter(0,3.483445);
   fmb->SetParError(0,5.179137);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-15.23449);
   fmb->SetParError(1,77.71917);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,46.77274);
   fmb->SetParError(2,280.775);
