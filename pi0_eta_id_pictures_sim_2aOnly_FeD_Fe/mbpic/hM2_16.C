...
//=========  (Tue Oct 11 11:03:54 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.03101");
   ...
   fmb->SetParameter(0,10.37793);
   fmb->SetParError(0,4.739377);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-135.041);
   fmb->SetParError(1,75.98035);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,604.4501);
   fmb->SetParError(2,293.78);
