...
//=========  (Tue Oct 11 11:03:55 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 236    ");
   text = ptstats->AddText("Mean  = 0.1447");
   text = ptstats->AddText("RMS   = 0.03215");
   ...
   fmb->SetParameter(0,6.826181);
   fmb->SetParError(0,4.913834);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-76.33244);
   fmb->SetParError(1,76.03852);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,346.5994);
   fmb->SetParError(2,282.6665);
