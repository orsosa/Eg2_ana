...
//=========  (Tue Oct 11 11:03:55 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 134    ");
   text = ptstats->AddText("Mean  = 0.1433");
   text = ptstats->AddText("RMS   = 0.03368");
   ...
   fmb->SetParameter(0,4.820191);
   fmb->SetParError(0,5.811357);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-42.78184);
   fmb->SetParError(1,88.33548);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,186.5641);
   fmb->SetParError(2,320.2685);
