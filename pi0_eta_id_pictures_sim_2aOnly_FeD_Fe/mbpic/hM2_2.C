...
//=========  (Tue Oct 11 11:03:54 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 490    ");
   text = ptstats->AddText("Mean  = 0.1401");
   text = ptstats->AddText("RMS   = 0.03188");
   ...
   fmb->SetParameter(0,2.488119);
   fmb->SetParError(0,4.854733);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,22.87795);
   fmb->SetParError(1,75.25583);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-46.51931);
   fmb->SetParError(2,278.8106);
