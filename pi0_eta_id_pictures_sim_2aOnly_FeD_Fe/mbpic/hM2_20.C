...
//=========  (Tue Oct 11 11:03:55 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Mean  = 0.1333");
   text = ptstats->AddText("RMS   = 0.03157");
   ...
   fmb->SetParameter(0,7.629468);
   fmb->SetParError(0,4.903189);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-55.14798);
   fmb->SetParError(1,72.28402);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,145.2947);
   fmb->SetParError(2,257.5054);
