...
//=========  (Tue Oct 11 11:03:55 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 252    ");
   text = ptstats->AddText("Mean  = 0.1382");
   text = ptstats->AddText("RMS   = 0.0318");
   ...
   fmb->SetParameter(0,1.447811);
   fmb->SetParError(0,4.532035);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,13.76886);
   fmb->SetParError(1,70.10281);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-9.514363);
   fmb->SetParError(2,259.2222);
