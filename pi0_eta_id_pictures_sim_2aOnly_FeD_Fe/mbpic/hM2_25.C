...
//=========  (Tue Oct 11 11:03:55 2016) by ROOT version5.34/19
   ...
   fmb->SetParError(0,11.01448);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-6.621796e-12);
   fmb->SetParError(1,164.1737);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,2.351008e-11);
   fmb->SetParError(2,589.2113);
