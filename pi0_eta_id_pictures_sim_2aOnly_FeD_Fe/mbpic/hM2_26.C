...
//=========  (Tue Oct 11 11:03:55 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 114    ");
   text = ptstats->AddText("Mean  = 0.1365");
   text = ptstats->AddText("RMS   = 0.03237");
   ...
   fmb->SetParameter(0,0.4629438);
   fmb->SetParError(0,4.619453);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,28.53872);
   fmb->SetParError(1,72.18505);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-95.45479);
   fmb->SetParError(2,268.2354);
