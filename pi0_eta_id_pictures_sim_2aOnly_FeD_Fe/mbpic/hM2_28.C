...
//=========  (Tue Oct 11 11:03:55 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 66     ");
   text = ptstats->AddText("Mean  = 0.1525");
   text = ptstats->AddText("RMS   = 0.02998");
   ...
   fmb->SetParameter(0,1.037763);
   fmb->SetParError(0,5.608734);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,15.13562);
   fmb->SetParError(1,86.3225);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-49.09345);
   fmb->SetParError(2,316.1093);
