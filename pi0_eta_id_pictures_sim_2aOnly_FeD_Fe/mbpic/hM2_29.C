...
//=========  (Tue Oct 11 11:03:55 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.03135");
   ...
   fmb->SetParameter(0,3.507131);
   fmb->SetParError(0,8.859214);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-24.36304);
   fmb->SetParError(1,132.0368);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,94.07533);
   fmb->SetParError(2,470.4387);
