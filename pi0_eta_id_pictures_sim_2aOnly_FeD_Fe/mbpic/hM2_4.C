...
//=========  (Tue Oct 11 11:03:54 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.02951");
   ...
   fmb->SetParameter(0,-0.3259245);
   fmb->SetParError(0,4.545951);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,38.49691);
   fmb->SetParError(1,69.83267);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-130.2394);
   fmb->SetParError(2,257.0341);
