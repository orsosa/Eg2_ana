...
//=========  (Tue Oct 11 11:03:54 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.03093");
   ...
   fmb->SetParameter(0,-10.79994);
   fmb->SetParError(0,6.566407);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,265.3173);
   fmb->SetParError(1,104.9795);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-796.5497);
   fmb->SetParError(2,398.2768);
