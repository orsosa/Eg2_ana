...
//=========  (Tue Oct 11 11:03:54 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 450    ");
   text = ptstats->AddText("Mean  = 0.1401");
   text = ptstats->AddText("RMS   = 0.03141");
   ...
   fmb->SetParameter(0,3.611455);
   fmb->SetParError(0,4.432411);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-12.94543);
   fmb->SetParError(1,69.17937);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,124.2745);
   fmb->SetParError(2,258.819);
