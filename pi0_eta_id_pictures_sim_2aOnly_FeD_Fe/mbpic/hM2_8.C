...
//=========  (Tue Oct 11 11:03:54 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.02938");
   ...
   fmb->SetParameter(0,-3.252136);
   fmb->SetParError(0,4.802207);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,90.57433);
   fmb->SetParError(1,72.73612);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-299.0418);
   fmb->SetParError(2,263.4781);
