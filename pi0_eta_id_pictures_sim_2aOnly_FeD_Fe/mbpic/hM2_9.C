...
//=========  (Tue Oct 11 11:03:54 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.02957");
   ...
   fmb->SetParameter(0,-0.07133581);
   fmb->SetParError(0,4.568504);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,34.7753);
   fmb->SetParError(1,69.44589);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-119.8357);
   fmb->SetParError(2,252.6731);
