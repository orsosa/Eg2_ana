...
//=========  (Tue Oct 11 11:09:11 2016) by ROOT version5.34/19
   ...
   c->Range(0.06625,-6.645615,0.20375,59.81053);
   c->SetBorderSize(2);
   c->SetFrameFillColor(0);
   
   TH1F *hM = new TH1F("hM","Mass, bin (q2,nu,z) = (1,0,3), tot: 1.357669,partial: 1.274510",75,0.08,0.19);
   hM->SetBinContent(0,27);
   ...
   text = ptstats->AddText("Entries = 2262   ");
   text = ptstats->AddText("Mean  =  0.136");
   text = ptstats->AddText("RMS   = 0.01726");
   text = ptstats->AddText("#chi^{2} / ndf = 68.29 / 64");
   text = ptstats->AddText("p0       = 0.3962 #pm 1.0401 ");
   text = ptstats->AddText("p1       = 2.666 #pm 6.883 ");
   text = ptstats->AddText("p2       = -0.008554 #pm 0.155850 ");
   text = ptstats->AddText("p3       = 32.77 #pm 1.32 ");
   ...
   fsig->SetParameter(0,0.396232);
   fsig->SetParError(0,1.040052);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,2.666103);
   fsig->SetParError(1,6.883167);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-0.008554297);
   fsig->SetParError(2,0.15585);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,32.7686);
   fsig->SetParError(3,1.320044);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1346395);
   fsig->SetParError(4,0.0005727838);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,8.259703e-05);
   ...
   fmb->SetParameter(0,0.396232);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,2.666103);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-0.008554297);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,32.7686);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1346395);
   ...
   pt->SetName("title");
   pt->SetBorderSize(2);
   text = pt->AddText("Mass, bin (q2,nu,z) = (1,0,3), tot: 1.357669,partial: 1.274510");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
