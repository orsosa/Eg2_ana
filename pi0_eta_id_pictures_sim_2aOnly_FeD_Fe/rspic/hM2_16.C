...
//=========  (Tue Oct 11 11:09:13 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 1347   ");
   text = ptstats->AddText("Mean  = 0.1355");
   text = ptstats->AddText("RMS   = 0.01877");
   text = ptstats->AddText("#chi^{2} / ndf = 98.65 / 65");
   text = ptstats->AddText("p0       = -0.7218 #pm 0.8768 ");
   text = ptstats->AddText("p1       = 13.45 #pm 6.52 ");
   text = ptstats->AddText("p2       = -1.011e-05 #pm 1.756e-01 ");
   text = ptstats->AddText("p3       = 24.91 #pm 1.19 ");
   ...
   fsig->SetParameter(0,-0.7217731);
   fsig->SetParError(0,0.8767886);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,13.44645);
   fsig->SetParError(1,6.524745);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-1.01106e-05);
   fsig->SetParError(2,0.1755599);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,24.90902);
   fsig->SetParError(3,1.188055);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1333979);
   fsig->SetParError(4,0.0006804399);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,9.243779e-05);
   ...
   fmb->SetParameter(0,-0.7217731);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,13.44645);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-1.01106e-05);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,24.90902);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1333979);
