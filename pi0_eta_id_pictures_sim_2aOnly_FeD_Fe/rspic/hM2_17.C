...
//=========  (Tue Oct 11 11:09:13 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 1106   ");
   text = ptstats->AddText("Mean  = 0.1369");
   text = ptstats->AddText("RMS   = 0.01824");
   text = ptstats->AddText("#chi^{2} / ndf = 52.22 / 59");
   text = ptstats->AddText("p0       = -2.879 #pm 1.101 ");
   text = ptstats->AddText("p1       = 27.65 #pm 7.81 ");
   text = ptstats->AddText("p2       = -1.772e-05 #pm 4.695e-01 ");
   text = ptstats->AddText("p3       = 18.31 #pm 1.07 ");
   ...
   fsig->SetParameter(0,-2.87902);
   fsig->SetParError(0,1.100866);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,27.64725);
   fsig->SetParError(1,7.810969);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-1.771718e-05);
   fsig->SetParError(2,0.4695137);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,18.30915);
   fsig->SetParError(3,1.07207);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1336567);
   fsig->SetParError(4,0.0008379557);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,0.0001674969);
   ...
   fmb->SetParameter(0,-2.87902);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,27.64725);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-1.771718e-05);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,18.30915);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1336567);
