...
//=========  (Tue Oct 11 11:09:12 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 1710   ");
   text = ptstats->AddText("Mean  = 0.1359");
   text = ptstats->AddText("RMS   = 0.02081");
   text = ptstats->AddText("#chi^{2} / ndf = 41.43 / 64");
   text = ptstats->AddText("p0       = 0.5804 #pm 0.8357 ");
   text = ptstats->AddText("p1       = 4.814 #pm 6.108 ");
   text = ptstats->AddText("p2       = -1.245e-05 #pm 1.708e+02 ");
   text = ptstats->AddText("p3       = 10.71 #pm 0.84 ");
   text = ptstats->AddText("p4       = 0.135 #pm 0.001 ");
   text = ptstats->AddText("p5       = 0.01552 #pm 0.00055 ");
   ...
   fsig->SetParameter(0,0.5803548);
   fsig->SetParError(0,0.8356991);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,4.81384);
   fsig->SetParError(1,6.107608);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-1.245123e-05);
   fsig->SetParError(2,170.799);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,10.70678);
   fsig->SetParError(3,0.8415798);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1349584);
   fsig->SetParError(4,0.001223597);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,0.0005511883);
   ...
   fmb->SetParameter(0,0.5803548);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,4.81384);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-1.245123e-05);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,10.70678);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1349584);
