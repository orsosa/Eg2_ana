...
//=========  (Tue Oct 11 11:09:14 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.01739");
   text = ptstats->AddText("#chi^{2} / ndf = 43.03 / 55");
   text = ptstats->AddText("p0       = -0.7315 #pm 0.9841 ");
   text = ptstats->AddText("p1       = 10.68 #pm 7.06 ");
   text = ptstats->AddText("p2       = -5.398e-07 #pm 1.293e+02 ");
   text = ptstats->AddText("p3       =  11.4 #pm 0.9 ");
   ...
   fsig->SetParameter(0,-0.7315256);
   fsig->SetParError(0,0.9841093);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,10.67742);
   fsig->SetParError(1,7.059797);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-5.397724e-07);
   fsig->SetParError(2,129.2562);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,11.40336);
   fsig->SetParError(3,0.8851734);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1329664);
   fsig->SetParError(4,0.001108078);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,0.0002685126);
   ...
   fmb->SetParameter(0,-0.7315256);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,10.67742);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-5.397724e-07);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,11.40336);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1329664);
