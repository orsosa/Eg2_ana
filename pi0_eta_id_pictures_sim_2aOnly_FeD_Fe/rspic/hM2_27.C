...
//=========  (Tue Oct 11 11:09:14 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("#chi^{2} / ndf =  60.5 / 52");
   text = ptstats->AddText("p0       = -1.621 #pm 1.063 ");
   text = ptstats->AddText("p1       = 12.55 #pm 7.36 ");
   text = ptstats->AddText("p2       = -2.903e-09 #pm 7.537e+01 ");
   text = ptstats->AddText("p3       = 14.03 #pm 0.93 ");
   ...
   fsig->SetParameter(0,-1.621236);
   fsig->SetParError(0,1.062617);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,12.54769);
   fsig->SetParError(1,7.361728);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-2.903107e-09);
   fsig->SetParError(2,75.36831);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,14.02922);
   fsig->SetParError(3,0.9265532);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1331664);
   fsig->SetParError(4,0.0009004402);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,0.0001382281);
   ...
   fmb->SetParameter(0,-1.621236);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,12.54769);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-2.903107e-09);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,14.02922);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1331664);
