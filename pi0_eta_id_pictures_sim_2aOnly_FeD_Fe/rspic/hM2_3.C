...
//=========  (Tue Oct 11 11:09:12 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 990    ");
   text = ptstats->AddText("Mean  = 0.1339");
   text = ptstats->AddText("RMS   = 0.02115");
   text = ptstats->AddText("#chi^{2} / ndf = 33.55 / 52");
   text = ptstats->AddText("p0       = 1.228 #pm 0.802 ");
   text = ptstats->AddText("p1       = -2.148 #pm 6.362 ");
   text = ptstats->AddText("p2       = -0.03278 #pm 8.09938 ");
   text = ptstats->AddText("p3       = 3.979 #pm 0.633 ");
   text = ptstats->AddText("p4       = 0.1359 #pm 0.0023 ");
   text = ptstats->AddText("p5       = 0.01552 #pm 0.00100 ");
   ...
   fsig->SetParameter(0,1.227809);
   fsig->SetParError(0,0.8024908);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,-2.148488);
   fsig->SetParError(1,6.362385);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-0.03278002);
   fsig->SetParError(2,8.099376);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,3.978739);
   fsig->SetParError(3,0.6331652);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1359105);
   fsig->SetParError(4,0.002303302);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552273);
   fsig->SetParError(5,0.001001803);
   ...
   fmb->SetParameter(0,1.227809);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-2.148488);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-0.03278002);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,3.978739);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1359105);
   fpeak->SetParError(1,0);
   fpeak->SetParLimits(1,0,0);
   fpeak->SetParameter(2,0.01552273);
