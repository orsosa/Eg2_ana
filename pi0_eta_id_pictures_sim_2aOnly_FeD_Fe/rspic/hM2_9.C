...
//=========  (Tue Oct 11 11:09:13 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 753    ");
   text = ptstats->AddText("Mean  = 0.1338");
   text = ptstats->AddText("RMS   = 0.01791");
   text = ptstats->AddText("#chi^{2} / ndf = 32.01 / 48");
   text = ptstats->AddText("p0       = 0.4436 #pm 0.9813 ");
   text = ptstats->AddText("p1       = 1.499 #pm 6.917 ");
   text = ptstats->AddText("p2       = -1.978e-07 #pm 1.100e+02 ");
   text = ptstats->AddText("p3       = 7.027 #pm 0.750 ");
   text = ptstats->AddText("p4       = 0.133 #pm 0.002 ");
   ...
   fsig->SetParameter(0,0.4436498);
   fsig->SetParError(0,0.9812966);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,1.499211);
   fsig->SetParError(1,6.917449);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-1.977987e-07);
   fsig->SetParError(2,109.9911);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,7.026676);
   fsig->SetParError(3,0.7501394);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1329672);
   fsig->SetParError(4,0.001536192);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,0.0004196632);
   ...
   fmb->SetParameter(0,0.4436498);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,1.499211);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-1.977987e-07);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,7.026676);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1329672);
