...
//=========  (Tue Sep 13 13:34:35 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.03048");
   ...
   fmb->SetParameter(0,3.452848);
   fmb->SetParError(0,4.844654);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-18.10723);
   fmb->SetParError(1,72.49406);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,68.71071);
   fmb->SetParError(2,263.2301);
