...
//=========  (Tue Sep 13 13:34:35 2016) by ROOT version5.34/19
   ...
   fmb->SetParameter(0,0.4053455);
   fmb->SetParError(0,4.050218);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,44.44976);
   fmb->SetParError(1,62.85627);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-170.4274);
   fmb->SetParError(2,233.1451);
