...
//=========  (Tue Sep 13 13:34:35 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.02845");
   ...
   fmb->SetParameter(0,1.891881);
   fmb->SetParError(0,5.788377);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,0.8120607);
   fmb->SetParError(1,85.66116);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,14.84201);
   fmb->SetParError(2,307.3063);
