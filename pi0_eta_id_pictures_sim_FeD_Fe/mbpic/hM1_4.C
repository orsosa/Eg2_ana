...
//=========  (Tue Sep 13 13:34:35 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 50     ");
   ...
   fmb->SetParameter(0,4.19491);
   fmb->SetParError(0,6.737719);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-29.92799);
   fmb->SetParError(1,102.3935);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,102.6545);
   fmb->SetParError(2,379.2001);
