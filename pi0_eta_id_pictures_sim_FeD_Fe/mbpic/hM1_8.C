...
//=========  (Tue Sep 13 13:34:35 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.02991");
   ...
   fmb->SetParameter(0,-0.9786187);
   fmb->SetParError(0,4.784524);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,56.77443);
   fmb->SetParError(1,72.78622);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-196.9041);
   fmb->SetParError(2,265.1184);
