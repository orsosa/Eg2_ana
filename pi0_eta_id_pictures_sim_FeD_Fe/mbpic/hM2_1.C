...
//=========  (Tue Sep 13 13:34:39 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 458    ");
   text = ptstats->AddText("Mean  = 0.1382");
   text = ptstats->AddText("RMS   = 0.03001");
   ...
   fmb->SetParameter(0,-8.086137);
   fmb->SetParError(0,4.567719);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,184.7677);
   fmb->SetParError(1,71.37805);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-647.2019);
   fmb->SetParError(2,264.6008);
