...
//=========  (Tue Sep 13 13:34:39 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 182    ");
   text = ptstats->AddText("Mean  = 0.1431");
   text = ptstats->AddText("RMS   = 0.02767");
   ...
   fmb->SetParameter(0,-2.393169);
   fmb->SetParError(0,4.936265);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,67.22023);
   fmb->SetParError(1,75.62898);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-213.3019);
   fmb->SetParError(2,278.6422);
