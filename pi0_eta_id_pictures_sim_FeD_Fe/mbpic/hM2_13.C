...
//=========  (Tue Sep 13 13:34:39 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 92     ");
   text = ptstats->AddText("Mean  = 0.1434");
   text = ptstats->AddText("RMS   = 0.02756");
   ...
   fmb->SetParameter(0,5.364625);
   fmb->SetParError(0,8.903501);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-38.43824);
   fmb->SetParError(1,127.0426);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,122.9252);
   fmb->SetParError(2,441.2719);
