...
//=========  (Tue Sep 13 13:34:40 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 432    ");
   text = ptstats->AddText("Mean  = 0.1367");
   text = ptstats->AddText("RMS   = 0.03238");
   ...
   fmb->SetParameter(0,9.721844);
   fmb->SetParError(0,4.994153);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-85.76845);
   fmb->SetParError(1,76.97412);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,337.2801);
   fmb->SetParError(2,284.9878);
