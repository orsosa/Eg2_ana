...
//=========  (Tue Sep 13 13:34:40 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.03036");
   ...
   fmb->SetParameter(0,0.3927001);
   fmb->SetParError(0,4.156873);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,41.60903);
   fmb->SetParError(1,64.42677);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-149.204);
   fmb->SetParError(2,239.5214);
