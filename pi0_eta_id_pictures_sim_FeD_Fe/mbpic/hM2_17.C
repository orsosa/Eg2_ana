...
//=========  (Tue Sep 13 13:34:40 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 116    ");
   text = ptstats->AddText("Mean  = 0.1388");
   text = ptstats->AddText("RMS   = 0.0304");
   ...
   fmb->SetParameter(0,0.7488834);
   fmb->SetParError(0,5.174013);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,19.56279);
   fmb->SetParError(1,81.89179);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-46.31258);
   fmb->SetParError(2,309.1286);
