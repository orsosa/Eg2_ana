...
//=========  (Tue Sep 13 13:34:40 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.02792");
   ...
   fmb->SetParameter(0,0.5966893);
   fmb->SetParError(0,13.48828);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,17.03597);
   fmb->SetParError(1,192.7418);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-42.2211);
   fmb->SetParError(2,665.5292);
