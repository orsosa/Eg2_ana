...
//=========  (Tue Sep 13 13:34:39 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 172    ");
   text = ptstats->AddText("Mean  = 0.1437");
   text = ptstats->AddText("RMS   = 0.03231");
   ...
   fmb->SetParameter(0,5.914061);
   fmb->SetParError(0,4.530989);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-55.64226);
   fmb->SetParError(1,67.98942);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,216.4429);
   fmb->SetParError(2,246.388);
