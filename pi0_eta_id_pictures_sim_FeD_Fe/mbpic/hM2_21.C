...
//=========  (Tue Sep 13 13:34:40 2016) by ROOT version5.34/19
   ...
   fmb->SetParameter(0,1.667638);
   fmb->SetParError(0,4.70577);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,5.721137);
   fmb->SetParError(1,73.00338);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,38.40044);
   fmb->SetParError(2,270.5688);
