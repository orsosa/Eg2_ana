...
//=========  (Tue Sep 13 13:34:40 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.03388");
   ...
   fmb->SetParameter(0,3.624037);
   fmb->SetParError(0,4.4149);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-10.43637);
   fmb->SetParError(1,67.67006);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,20.21627);
   fmb->SetParError(2,248.462);
