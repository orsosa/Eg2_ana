...
//=========  (Tue Sep 13 13:34:40 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 98     ");
   text = ptstats->AddText("Mean  = 0.1339");
   text = ptstats->AddText("RMS   = 0.03168");
   ...
   fmb->SetParameter(0,3.596936);
   fmb->SetParError(0,5.791728);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-5.650347);
   fmb->SetParError(1,88.21463);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-14.35141);
   fmb->SetParError(2,322.2747);
