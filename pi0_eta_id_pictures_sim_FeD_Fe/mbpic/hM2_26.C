...
//=========  (Tue Sep 13 13:34:40 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 142    ");
   text = ptstats->AddText("Mean  = 0.1372");
   text = ptstats->AddText("RMS   = 0.03427");
   ...
   fmb->SetParameter(0,6.155852);
   fmb->SetParError(0,4.992482);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-61.01448);
   fmb->SetParError(1,75.61468);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,241.3471);
   fmb->SetParError(2,274.5388);
