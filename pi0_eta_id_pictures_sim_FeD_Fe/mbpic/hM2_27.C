...
//=========  (Tue Sep 13 13:34:40 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.03113");
   ...
   fmb->SetParameter(0,2.244105);
   fmb->SetParError(0,5.800259);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,0.5524275);
   fmb->SetParError(1,85.68468);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,1.737883);
   fmb->SetParError(2,304.6671);
