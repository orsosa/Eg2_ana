...
//=========  (Tue Sep 13 13:34:40 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.03356");
   ...
   fmb->SetParameter(0,-1.530252);
   fmb->SetParError(0,7.327472);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,59.43384);
   fmb->SetParError(1,111.9308);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-210.8283);
   fmb->SetParError(2,402.1799);
