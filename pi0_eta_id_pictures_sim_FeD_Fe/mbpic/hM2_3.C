...
//=========  (Tue Sep 13 13:34:39 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 80     ");
   ...
   fmb->SetParameter(0,0.2472266);
   fmb->SetParError(0,5.342588);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,28.4477);
   fmb->SetParError(1,81.64229);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-95.922);
   fmb->SetParError(2,300.7887);
