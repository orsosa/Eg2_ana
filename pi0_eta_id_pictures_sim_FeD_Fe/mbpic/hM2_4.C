...
//=========  (Tue Sep 13 13:34:39 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.03205");
   ...
   fmb->SetParameter(0,4.569306);
   fmb->SetParError(0,8.34878);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-44.1627);
   fmb->SetParError(1,133.902);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,200.6632);
   fmb->SetParError(2,511.3745);
