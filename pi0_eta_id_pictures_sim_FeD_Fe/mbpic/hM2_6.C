...
//=========  (Tue Sep 13 13:34:39 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 482    ");
   ...
   fmb->SetParameter(0,8.251671);
   fmb->SetParError(0,4.853907);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-63.10568);
   fmb->SetParError(1,75.77866);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,259.5197);
   fmb->SetParError(2,283.7115);
