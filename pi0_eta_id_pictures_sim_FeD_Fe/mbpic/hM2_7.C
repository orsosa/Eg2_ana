...
//=========  (Tue Sep 13 13:34:39 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.03118");
   ...
   fmb->SetParameter(0,0.8923661);
   fmb->SetParError(0,4.300721);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,28.80888);
   fmb->SetParError(1,65.56372);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-109.0147);
   fmb->SetParError(2,239.2539);
