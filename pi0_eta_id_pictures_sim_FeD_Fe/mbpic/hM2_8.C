...
//=========  (Tue Sep 13 13:34:39 2016) by ROOT version5.34/19
   ...
   fmb->SetParameter(0,4.43448);
   fmb->SetParError(0,6.51542);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-36.53307);
   fmb->SetParError(1,98.44062);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,148.1508);
   fmb->SetParError(2,358.4165);
