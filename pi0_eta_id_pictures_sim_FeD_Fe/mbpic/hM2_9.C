...
//=========  (Tue Sep 13 13:34:39 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.02529");
   ...
   fmb->SetParameter(0,1.01245);
   fmb->SetParError(0,9.658202);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,12.89611);
   fmb->SetParError(1,136.0587);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-34.06212);
   fmb->SetParError(2,467.2527);
