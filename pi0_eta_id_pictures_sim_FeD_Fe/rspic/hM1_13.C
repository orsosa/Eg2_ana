...
//=========  (Wed Sep 14 17:43:46 2016) by ROOT version5.34/19
   ...
   TH1F *hM = new TH1F("hM","Mass, bin (q2,nu,z) = (2,0,3), tot: 1.554305,partial: 1.460250",75,0.08,0.19);
   ...
   text = ptstats->AddText("Entries = 1129   ");
   text = ptstats->AddText("Mean  = 0.1379");
   text = ptstats->AddText("RMS   = 0.01753");
   text = ptstats->AddText("#chi^{2} / ndf = 68.77 / 65");
   text = ptstats->AddText("p0       = -0.6384 #pm 0.9511 ");
   text = ptstats->AddText("p1       = 11.06 #pm 6.99 ");
   text = ptstats->AddText("p2       = -4.428e-08 #pm 7.019e+01 ");
   text = ptstats->AddText("p3       = 37.55 #pm 1.39 ");
   text = ptstats->AddText("p4       = 0.1372 #pm 0.0005 ");
   ...
   fsig->SetParameter(0,-0.6383533);
   fsig->SetParError(0,0.9511302);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,11.06223);
   fsig->SetParError(1,6.986621);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-4.427784e-08);
   fsig->SetParError(2,70.18695);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,37.54615);
   fsig->SetParError(3,1.391908);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1372385);
   fsig->SetParError(4,0.0005306262);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,7.213741e-05);
   ...
   fmb->SetParameter(0,-0.6383533);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,11.06223);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-4.427784e-08);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,37.54615);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1372385);
   ...
   pt->SetName("title");
   pt->SetBorderSize(2);
   text = pt->AddText("Mass, bin (q2,nu,z) = (2,0,3), tot: 1.554305,partial: 1.460250");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
