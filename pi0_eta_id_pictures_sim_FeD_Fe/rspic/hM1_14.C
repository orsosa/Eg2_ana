...
//=========  (Wed Sep 14 17:43:46 2016) by ROOT version5.34/19
   ...
   TH1F *hM = new TH1F("hM","Mass, bin (q2,nu,z) = (2,0,4), tot: 0.910694,partial: 0.849054",75,0.08,0.19);
   ...
   text = ptstats->AddText("Entries = 664    ");
   text = ptstats->AddText("Mean  =  0.138");
   text = ptstats->AddText("RMS   = 0.01701");
   text = ptstats->AddText("#chi^{2} / ndf = 44.33 / 61");
   text = ptstats->AddText("p0       = -0.7614 #pm 0.9109 ");
   text = ptstats->AddText("p1       = 9.793 #pm 6.293 ");
   text = ptstats->AddText("p2       = -0.01668 #pm 1.95325 ");
   text = ptstats->AddText("p3       = 21.83 #pm 1.07 ");
   ...
   fsig->SetParameter(0,-0.7614074);
   fsig->SetParError(0,0.9109409);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,9.793239);
   fsig->SetParError(1,6.293355);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-0.01668407);
   fsig->SetParError(2,1.953251);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,21.83075);
   fsig->SetParError(3,1.069955);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1369956);
   fsig->SetParError(4,0.0007568827);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,0.0002418634);
   ...
   fmb->SetParameter(0,-0.7614074);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,9.793239);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-0.01668407);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,21.83075);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1369956);
   ...
   pt->SetName("title");
   pt->SetBorderSize(2);
   text = pt->AddText("Mass, bin (q2,nu,z) = (2,0,4), tot: 0.910694,partial: 0.849054");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
