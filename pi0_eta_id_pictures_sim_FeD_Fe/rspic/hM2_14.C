...
//=========  (Wed Sep 14 17:43:48 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 214    ");
   text = ptstats->AddText("Mean  = 0.1355");
   text = ptstats->AddText("RMS   = 0.01705");
   text = ptstats->AddText("#chi^{2} / ndf = 39.55 / 47");
   text = ptstats->AddText("p0       = 0.06878 #pm 1.28510 ");
   text = ptstats->AddText("p1       =  4.11 #pm 8.17 ");
   text = ptstats->AddText("p2       = -5.472e-06 #pm 1.943e+02 ");
   text = ptstats->AddText("p3       = 5.424 #pm 0.743 ");
   text = ptstats->AddText("p4       = 0.1336 #pm 0.0019 ");
   ...
   fsig->SetParameter(0,0.06878172);
   fsig->SetParError(0,1.285103);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,4.109835);
   fsig->SetParError(1,8.171218);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-5.471789e-06);
   fsig->SetParError(2,194.273);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,5.424186);
   fsig->SetParError(3,0.7431011);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1335618);
   fsig->SetParError(4,0.001858186);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,0.0007023181);
   ...
   fmb->SetParameter(0,0.06878172);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,4.109835);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-5.471789e-06);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,5.424186);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1335618);
