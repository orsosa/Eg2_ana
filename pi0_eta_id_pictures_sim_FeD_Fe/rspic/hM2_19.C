...
//=========  (Wed Sep 14 17:43:48 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.0151");
   text = ptstats->AddText("#chi^{2} / ndf = 26.52 / 41");
   text = ptstats->AddText("p0       = -0.4774 #pm 1.2377 ");
   text = ptstats->AddText("p1       = 6.182 #pm 8.258 ");
   text = ptstats->AddText("p2       = -3.008e-06 #pm 1.405e+02 ");
   text = ptstats->AddText("p3       =  6.85 #pm 0.77 ");
   text = ptstats->AddText("p4       = 0.1348 #pm 0.0015 ");
   ...
   fsig->SetParameter(0,-0.4773647);
   fsig->SetParError(0,1.237711);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,6.182376);
   fsig->SetParError(1,8.257579);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-3.008283e-06);
   fsig->SetParError(2,140.5349);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,6.850401);
   fsig->SetParError(3,0.7707613);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1348443);
   fsig->SetParError(4,0.001548788);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,0.0004729539);
   ...
   fmb->SetParameter(0,-0.4773647);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,6.182376);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-3.008283e-06);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,6.850401);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1348443);
