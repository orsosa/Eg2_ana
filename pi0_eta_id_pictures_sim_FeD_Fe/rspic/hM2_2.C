...
//=========  (Wed Sep 14 17:43:47 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 393    ");
   text = ptstats->AddText("Mean  = 0.1376");
   text = ptstats->AddText("RMS   = 0.02322");
   text = ptstats->AddText("#chi^{2} / ndf = 48.06 / 65");
   text = ptstats->AddText("p0       = 0.8783 #pm 0.8530 ");
   text = ptstats->AddText("p1       = 5.777 #pm 6.192 ");
   text = ptstats->AddText("p2       = -0.0009599 #pm 0.5196888 ");
   text = ptstats->AddText("p3       = 8.434 #pm 0.788 ");
   text = ptstats->AddText("p4       = 0.1364 #pm 0.0016 ");
   text = ptstats->AddText("p5       = 0.01552 #pm 0.00484 ");
   ...
   fsig->SetParameter(0,0.8783128);
   fsig->SetParError(0,0.8530333);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,5.777406);
   fsig->SetParError(1,6.191804);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-0.0009599445);
   fsig->SetParError(2,0.5196889);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,8.433816);
   fsig->SetParError(3,0.7880558);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1363663);
   fsig->SetParError(4,0.001558661);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,0.004835587);
   ...
   fmb->SetParameter(0,0.8783128);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,5.777406);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-0.0009599445);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,8.433816);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1363663);
