...
//=========  (Wed Sep 14 17:43:48 2016) by ROOT version5.34/19
   ...
   hM->SetBinContent(36,39);
   hM->SetBinContent(37,43);
   ...
   text = ptstats->AddText("Entries = 993    ");
   text = ptstats->AddText("Mean  = 0.1354");
   text = ptstats->AddText("RMS   = 0.01799");
   text = ptstats->AddText("#chi^{2} / ndf = 64.02 / 67");
   text = ptstats->AddText("p0       = -0.8848 #pm 0.8396 ");
   text = ptstats->AddText("p1       = 14.11 #pm 6.27 ");
   text = ptstats->AddText("p2       = -6.821e-07 #pm 6.695e+01 ");
   text = ptstats->AddText("p3       = 32.06 #pm 1.29 ");
   ...
   fsig->SetParameter(0,-0.8848237);
   fsig->SetParError(0,0.8396177);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,14.11274);
   fsig->SetParError(1,6.274406);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-6.820792e-07);
   fsig->SetParError(2,66.95366);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,32.06241);
   fsig->SetParError(3,1.286478);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1339471);
   fsig->SetParError(4,0.0005747069);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,7.780053e-05);
   ...
   fmb->SetParameter(0,-0.8848237);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,14.11274);
   fmb->SetParError(1,0);
   ...
   fpeak->SetParameter(0,32.06241);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1339471);
