...
//=========  (Wed Sep 14 17:43:48 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.01534");
   text = ptstats->AddText("#chi^{2} / ndf = 37.31 / 44");
   text = ptstats->AddText("p0       = -1.027 #pm 1.664 ");
   text = ptstats->AddText("p1       = 7.634 #pm 10.643 ");
   text = ptstats->AddText("p2       = -3.98e-05 #pm 1.19e+02 ");
   text = ptstats->AddText("p3       = 7.915 #pm 0.885 ");
   text = ptstats->AddText("p4       = 0.1359 #pm 0.0014 ");
   ...
   fsig->SetParameter(0,-1.02677);
   fsig->SetParError(0,1.664455);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,7.634273);
   fsig->SetParError(1,10.64319);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-3.979501e-05);
   fsig->SetParError(2,119.1828);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,7.914574);
   fsig->SetParError(3,0.8851502);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1359297);
   fsig->SetParError(4,0.001367596);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,0.0002830524);
   ...
   fmb->SetParameter(0,-1.02677);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,7.634273);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-3.979501e-05);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,7.914574);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1359297);
