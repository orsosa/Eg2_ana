...
//=========  (Wed Sep 14 17:43:49 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("#chi^{2} / ndf = 73.35 / 61");
   text = ptstats->AddText("p0       = -1.49 #pm 0.93 ");
   text = ptstats->AddText("p1       = 13.47 #pm 6.23 ");
   text = ptstats->AddText("p2       = -0.0006368 #pm 0.4995892 ");
   text = ptstats->AddText("p3       = 19.95 #pm 1.06 ");
   text = ptstats->AddText("p4       = 0.1338 #pm 0.0007 ");
   ...
   fsig->SetParameter(0,-1.49045);
   fsig->SetParError(0,0.9303967);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,13.46734);
   fsig->SetParError(1,6.229137);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-0.000636821);
   fsig->SetParError(2,0.4995892);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,19.94854);
   fsig->SetParError(3,1.058214);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1338082);
   fsig->SetParError(4,0.0007120592);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,9.525331e-05);
   ...
   fmb->SetParameter(0,-1.49045);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,13.46734);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-0.000636821);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,19.94854);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1338082);
