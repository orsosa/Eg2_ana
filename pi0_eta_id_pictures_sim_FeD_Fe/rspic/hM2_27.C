...
//=========  (Wed Sep 14 17:43:49 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.01621");
   text = ptstats->AddText("#chi^{2} / ndf =  76.4 / 55");
   text = ptstats->AddText("p0       = -0.8452 #pm 0.9940 ");
   text = ptstats->AddText("p1       = 7.964 #pm 6.848 ");
   text = ptstats->AddText("p2       = -4.225e-08 #pm 6.130e+01 ");
   text = ptstats->AddText("p3       =  16.2 #pm 1.0 ");
   ...
   fsig->SetParameter(0,-0.8451608);
   fsig->SetParError(0,0.9940436);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,7.964421);
   fsig->SetParError(1,6.847687);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-4.225149e-08);
   fsig->SetParError(2,61.30021);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,16.20034);
   fsig->SetParError(3,0.9862096);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1350192);
   fsig->SetParError(4,0.0007943002);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,0.0001040798);
   ...
   fmb->SetParameter(0,-0.8451608);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,7.964421);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-4.225149e-08);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,16.20034);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1350192);
