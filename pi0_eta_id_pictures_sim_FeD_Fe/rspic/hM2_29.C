...
//=========  (Wed Sep 14 17:43:49 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 155    ");
   text = ptstats->AddText("Mean  = 0.1397");
   text = ptstats->AddText("RMS   = 0.01522");
   text = ptstats->AddText("#chi^{2} / ndf = 32.25 / 36");
   text = ptstats->AddText("p0       = -0.8108 #pm 1.8372 ");
   text = ptstats->AddText("p1       = 9.689 #pm 13.044 ");
   text = ptstats->AddText("p2       = -7.381e-05 #pm 2.804e+02 ");
   text = ptstats->AddText("p3       = 4.203 #pm 0.798 ");
   text = ptstats->AddText("p4       = 0.1386 #pm 0.0025 ");
   text = ptstats->AddText("p5       = 0.01552 #pm 0.00075 ");
   ...
   fsig->SetParameter(0,-0.8108249);
   fsig->SetParError(0,1.837209);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,9.689229);
   fsig->SetParError(1,13.04446);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-7.380945e-05);
   fsig->SetParError(2,280.3905);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,4.202658);
   fsig->SetParError(3,0.7979311);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1386365);
   fsig->SetParError(4,0.00252966);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,0.000753551);
   ...
   fmb->SetParameter(0,-0.8108249);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,9.689229);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-7.380945e-05);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,4.202658);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1386365);
