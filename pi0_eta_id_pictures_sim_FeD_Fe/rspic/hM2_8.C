...
//=========  (Wed Sep 14 17:43:48 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.01895");
   text = ptstats->AddText("#chi^{2} / ndf = 33.07 / 55");
   text = ptstats->AddText("p0       = 0.1811 #pm 1.0794 ");
   text = ptstats->AddText("p1       = 5.735 #pm 7.146 ");
   text = ptstats->AddText("p2       = -0.008249 #pm 1.271411 ");
   text = ptstats->AddText("p3       = 9.158 #pm 0.804 ");
   text = ptstats->AddText("p4       = 0.134 #pm 0.001 ");
   text = ptstats->AddText("p5       = 0.01552 #pm 0.00158 ");
   ...
   fsig->SetParameter(0,0.1810764);
   fsig->SetParError(0,1.079443);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,5.735472);
   fsig->SetParError(1,7.146413);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-0.008248607);
   fsig->SetParError(2,1.271411);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,9.15835);
   fsig->SetParError(3,0.8036471);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1340115);
   fsig->SetParError(4,0.001413894);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,0.00157824);
   ...
   fmb->SetParameter(0,0.1810764);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,5.735472);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-0.008248607);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,9.15835);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1340115);
