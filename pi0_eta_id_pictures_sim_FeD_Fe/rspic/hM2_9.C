...
//=========  (Wed Sep 14 17:43:48 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 230    ");
   text = ptstats->AddText("Mean  = 0.1342");
   text = ptstats->AddText("RMS   = 0.01713");
   text = ptstats->AddText("#chi^{2} / ndf =  43.2 / 47");
   text = ptstats->AddText("p0       = 0.4696 #pm 1.1766 ");
   text = ptstats->AddText("p1       = 1.915 #pm 7.790 ");
   text = ptstats->AddText("p2       = -8.238e-09 #pm 1.931e+02 ");
   text = ptstats->AddText("p3       = 5.816 #pm 0.744 ");
   text = ptstats->AddText("p4       = 0.1333 #pm 0.0018 ");
   ...
   fsig->SetParameter(0,0.4695692);
   fsig->SetParError(0,1.176593);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,1.915053);
   fsig->SetParError(1,7.789763);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-8.238203e-09);
   fsig->SetParError(2,193.1196);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,5.816158);
   fsig->SetParError(3,0.7440161);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1332964);
   fsig->SetParError(4,0.001762534);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,0.000599819);
   ...
   fmb->SetParameter(0,0.4695692);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,1.915053);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-8.238203e-09);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,5.816158);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1332964);
