...
//=========  (Mon Jun  6 21:14:01 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.03105");
   ...
   fmb->SetParameter(0,2.062112);
   fmb->SetParError(0,4.583504);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,17.1222);
   fmb->SetParError(1,70.16333);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-36.91323);
   fmb->SetParError(2,256.9089);
