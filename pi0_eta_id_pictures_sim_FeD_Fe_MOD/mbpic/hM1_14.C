...
//=========  (Mon Jun  6 21:14:01 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 90     ");
   text = ptstats->AddText("Mean  =  0.148");
   text = ptstats->AddText("RMS   = 0.02847");
   ...
   fmb->SetParameter(0,1.390518);
   fmb->SetParError(0,7.058344);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,7.904506);
   fmb->SetParError(1,103.6815);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,2.601589);
   fmb->SetParError(2,369.0036);
