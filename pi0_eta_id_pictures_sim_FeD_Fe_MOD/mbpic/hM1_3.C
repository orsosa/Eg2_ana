...
//=========  (Mon Jun  6 21:14:00 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 174    ");
   ...
   fmb->SetParameter(0,2.268633);
   fmb->SetParError(0,4.903371);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-0.7466843);
   fmb->SetParError(1,75.95366);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,32.86377);
   fmb->SetParError(2,282.8361);
