...
//=========  (Mon Jun  6 21:14:00 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 734    ");
   ...
   fmb->SetParameter(0,5.273744);
   fmb->SetParError(0,5.617105);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-17.04433);
   fmb->SetParError(1,88.71301);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,239.3089);
   fmb->SetParError(2,335.3095);
