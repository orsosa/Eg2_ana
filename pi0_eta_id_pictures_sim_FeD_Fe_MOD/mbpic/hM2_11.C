...
//=========  (Mon Jun  6 21:14:04 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 390    ");
   ...
   fmb->SetParameter(0,0.07345788);
   fmb->SetParError(0,4.828259);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,54.33441);
   fmb->SetParError(1,75.87223);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-166.2593);
   fmb->SetParError(2,284.4325);
