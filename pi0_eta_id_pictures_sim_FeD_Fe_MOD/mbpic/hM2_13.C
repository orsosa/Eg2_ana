...
//=========  (Mon Jun  6 21:14:05 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.02882");
   ...
   fmb->SetParameter(0,2.667306);
   fmb->SetParError(0,5.6466);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-14.46204);
   fmb->SetParError(1,84.91604);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,83.16604);
   fmb->SetParError(2,309.1767);
