...
//=========  (Mon Jun  6 21:14:05 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 72     ");
   ...
   fmb->SetParameter(0,2.371102);
   fmb->SetParError(0,6.00749);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-0.4444338);
   fmb->SetParError(1,88.94455);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-9.478781);
   fmb->SetParError(2,322.0187);
