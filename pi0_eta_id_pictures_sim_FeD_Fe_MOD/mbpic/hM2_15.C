...
//=========  (Mon Jun  6 21:14:05 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 340    ");
   text = ptstats->AddText("Mean  = 0.1337");
   ...
   fmb->SetParameter(0,1.823597);
   fmb->SetParError(0,4.353785);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,29.21432);
   fmb->SetParError(1,67.14034);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-114.8266);
   fmb->SetParError(2,248.6466);
