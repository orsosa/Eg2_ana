...
//=========  (Mon Jun  6 21:14:05 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.03186");
   ...
   fmb->SetParameter(0,1.261252);
   fmb->SetParError(0,4.037272);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,11.13158);
   fmb->SetParError(1,62.37687);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-9.121611);
   fmb->SetParError(2,230.2854);
