...
//=========  (Mon Jun  6 21:14:04 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 202    ");
   ...
   fmb->SetParameter(0,0.896306);
   fmb->SetParError(0,4.190216);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,20.94211);
   fmb->SetParError(1,64.8132);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-52.89424);
   fmb->SetParError(2,239.7566);
