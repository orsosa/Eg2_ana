...
//=========  (Mon Jun  6 21:14:05 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.0317");
   ...
   fmb->SetParameter(0,-0.5094366);
   fmb->SetParError(0,4.108146);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,49.19215);
   fmb->SetParError(1,63.69096);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-166.3958);
   fmb->SetParError(2,235.5263);
