...
//=========  (Mon Jun  6 21:14:05 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 168    ");
   ...
   fmb->SetParameter(0,-0.4361671);
   fmb->SetParError(0,4.885242);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,43.62845);
   fmb->SetParError(1,73.85337);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-138.9189);
   fmb->SetParError(2,267.0027);
