...
//=========  (Mon Jun  6 21:14:05 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.03075");
   ...
   fmb->SetParameter(0,2.173497);
   fmb->SetParError(0,6.834081);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-2.807648);
   fmb->SetParError(1,101.8581);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,15.90045);
   fmb->SetParError(2,365.3635);
