...
//=========  (Mon Jun  6 21:14:05 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 36     ");
   text = ptstats->AddText("Mean  = 0.1311");
   ...
   fmb->SetParameter(0,0.9543445);
   fmb->SetParError(0,6.149025);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,18.85273);
   fmb->SetParError(1,98.50459);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-74.29053);
   fmb->SetParError(2,376.4858);
