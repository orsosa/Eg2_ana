...
//=========  (Mon Jun  6 21:14:05 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.03273");
   ...
   fmb->SetParameter(0,3.375539);
   fmb->SetParError(0,4.456277);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-10.31684);
   fmb->SetParError(1,68.39574);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,30.19556);
   fmb->SetParError(2,251.7283);
