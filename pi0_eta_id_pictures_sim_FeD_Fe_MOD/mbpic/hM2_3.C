...
//=========  (Mon Jun  6 21:14:04 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.03085");
   ...
   fmb->SetParameter(0,-2.477311);
   fmb->SetParError(0,6.250938);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,76.74117);
   fmb->SetParError(1,99.08872);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-288.8591);
   fmb->SetParError(2,371.3733);
