...
//=========  (Thu Jul 21 19:32:07 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Mean  = 0.1331");
   text = ptstats->AddText("RMS   = 0.01705");
   text = ptstats->AddText("#chi^{2} / ndf = 64.63 / 57");
   text = ptstats->AddText("p0       = -0.6249 #pm 0.8500 ");
   text = ptstats->AddText("p1       = 8.014 #pm 5.804 ");
   text = ptstats->AddText("p2       = -0.0001691 #pm 0.2448608 ");
   text = ptstats->AddText("p3       = 15.03 #pm 0.95 ");
   ...
   fsig->SetParameter(0,-0.6249491);
   fsig->SetParError(0,0.8500145);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,8.013946);
   fsig->SetParError(1,5.804297);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-0.0001691407);
   fsig->SetParError(2,0.2448608);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,15.0333);
   fsig->SetParError(3,0.9451788);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1326901);
   fsig->SetParError(4,0.000747442);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,0.0001121696);
   ...
   fmb->SetParameter(0,-0.6249491);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,8.013946);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-0.0001691407);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,15.0333);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1326901);
