...
//=========  (Thu Jul 21 19:32:08 2016) by ROOT version5.34/19
   ...
   hM->SetBinContent(38,46);
   hM->SetBinContent(39,39);
   hM->SetBinContent(40,32);
   hM->SetBinContent(41,40);
   hM->SetBinContent(42,33);
   hM->SetBinContent(43,33);
   ...
   text = ptstats->AddText("Entries = 1078   ");
   text = ptstats->AddText("Mean  = 0.1354");
   text = ptstats->AddText("RMS   = 0.01848");
   text = ptstats->AddText("#chi^{2} / ndf = 99.83 / 66");
   text = ptstats->AddText("p0       = -1.443 #pm 1.010 ");
   text = ptstats->AddText("p1       = 20.66 #pm 7.51 ");
   text = ptstats->AddText("p2       = -7.446e-08 #pm 6.329e+01 ");
   text = ptstats->AddText("p3       = 32.98 #pm 1.36 ");
   ...
   fsig->SetParameter(0,-1.442734);
   fsig->SetParError(0,1.009561);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,20.66143);
   fsig->SetParError(1,7.512515);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-7.446397e-08);
   fsig->SetParError(2,63.28594);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,32.97961);
   fsig->SetParError(3,1.362072);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1335277);
   fsig->SetParError(4,0.0005757048);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,5.785121e-05);
   ...
   fmb->SetParameter(0,-1.442734);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,20.66143);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-7.446397e-08);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,32.97961);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1335277);
