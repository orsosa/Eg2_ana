...
//=========  (Thu Jul 21 19:32:08 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 195    ");
   text = ptstats->AddText("Mean  = 0.1353");
   text = ptstats->AddText("RMS   = 0.01795");
   text = ptstats->AddText("#chi^{2} / ndf =  37.4 / 45");
   text = ptstats->AddText("p0       = -0.2418 #pm 1.2760 ");
   text = ptstats->AddText("p1       = 8.648 #pm 8.793 ");
   text = ptstats->AddText("p2       = -3.128e-05 #pm 1.809e+02 ");
   text = ptstats->AddText("p3       =  4.33 #pm 0.71 ");
   text = ptstats->AddText("p4       = 0.1296 #pm 0.0022 ");
   ...
   fsig->SetParameter(0,-0.2417977);
   fsig->SetParError(0,1.275973);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,8.647743);
   fsig->SetParError(1,8.792887);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-3.128405e-05);
   fsig->SetParError(2,180.8798);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,4.329634);
   fsig->SetParError(3,0.707683);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1295958);
   fsig->SetParError(4,0.002181448);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,0.0007583435);
   ...
   fmb->SetParameter(0,-0.2417977);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,8.647743);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-3.128405e-05);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,4.329634);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1295958);
