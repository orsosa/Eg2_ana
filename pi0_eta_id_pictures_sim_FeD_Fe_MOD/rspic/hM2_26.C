...
//=========  (Thu Jul 21 19:32:08 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 523    ");
   text = ptstats->AddText("Mean  = 0.1357");
   text = ptstats->AddText("RMS   = 0.01758");
   text = ptstats->AddText("#chi^{2} / ndf = 52.83 / 61");
   text = ptstats->AddText("p0       = -0.1761 #pm 0.8560 ");
   text = ptstats->AddText("p1       = 6.543 #pm 5.745 ");
   text = ptstats->AddText("p2       = -0.007416 #pm 2.922907 ");
   text = ptstats->AddText("p3       = 15.96 #pm 0.95 ");
   text = ptstats->AddText("p4       = 0.1345 #pm 0.0009 ");
   ...
   fsig->SetParameter(0,-0.17607);
   fsig->SetParError(0,0.856029);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,6.542846);
   fsig->SetParError(1,5.744791);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-0.007415605);
   fsig->SetParError(2,2.922907);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,15.95756);
   fsig->SetParError(3,0.9499298);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1345331);
   fsig->SetParError(4,0.000860072);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,0.0002208372);
   ...
   fmb->SetParameter(0,-0.17607);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,6.542846);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-0.007415605);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,15.95756);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1345331);
