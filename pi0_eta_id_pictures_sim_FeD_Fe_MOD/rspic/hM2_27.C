...
//=========  (Thu Jul 21 19:32:08 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 518    ");
   text = ptstats->AddText("Mean  = 0.1355");
   text = ptstats->AddText("RMS   = 0.01632");
   text = ptstats->AddText("#chi^{2} / ndf = 65.55 / 54");
   text = ptstats->AddText("p0       = -1.784 #pm 1.036 ");
   text = ptstats->AddText("p1       = 14.66 #pm 7.30 ");
   text = ptstats->AddText("p2       = -2.635e-07 #pm 7.439e+01 ");
   text = ptstats->AddText("p3       =  16.7 #pm 1.0 ");
   text = ptstats->AddText("p4       = 0.1341 #pm 0.0008 ");
   ...
   fsig->SetParameter(0,-1.783526);
   fsig->SetParError(0,1.036147);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,14.66326);
   fsig->SetParError(1,7.303082);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-2.634952e-07);
   fsig->SetParError(2,74.39309);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,16.69984);
   fsig->SetParError(3,1.005568);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1341168);
   fsig->SetParError(4,0.0008035229);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,0.0001167575);
   ...
   fmb->SetParameter(0,-1.783526);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,14.66326);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-2.634952e-07);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,16.69984);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1341168);
