...
//=========  (Thu Jul 21 19:32:08 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.01586");
   text = ptstats->AddText("#chi^{2} / ndf = 56.18 / 42");
   text = ptstats->AddText("p0       = -0.804 #pm 1.389 ");
   text = ptstats->AddText("p1       = 9.798 #pm 8.980 ");
   text = ptstats->AddText("p2       = -0.0002261 #pm 320.5936890 ");
   text = ptstats->AddText("p3       = 4.599 #pm 0.726 ");
   text = ptstats->AddText("p4       = 0.1375 #pm 0.0020 ");
   text = ptstats->AddText("p5       = 0.01552 #pm 0.00079 ");
   ...
   fsig->SetParameter(0,-0.8040026);
   fsig->SetParError(0,1.389494);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,9.797537);
   fsig->SetParError(1,8.979756);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-0.0002260749);
   fsig->SetParError(2,320.5937);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,4.598699);
   fsig->SetParError(3,0.7262653);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1375047);
   fsig->SetParError(4,0.002046099);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,0.0007887971);
   ...
   fmb->SetParameter(0,-0.8040026);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,9.797537);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-0.0002260749);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,4.598699);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1375047);
