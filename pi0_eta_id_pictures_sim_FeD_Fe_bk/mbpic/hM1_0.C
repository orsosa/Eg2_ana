...
//=========  (Mon Jun  6 21:14:00 2016) by ROOT version5.34/19
   ...
   fmb->SetParameter(0,-13.76464);
   fmb->SetParError(0,8.42662);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,354.6731);
   fmb->SetParError(1,133.2129);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-908.7401);
   fmb->SetParError(2,501.1936);
   ...
   text = ptstats->AddText("Entries = 1486   ");
