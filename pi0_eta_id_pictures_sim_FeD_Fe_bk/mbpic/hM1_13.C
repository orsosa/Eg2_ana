...
//=========  (Mon Jun  6 21:14:01 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.03322");
   ...
   fmb->SetParameter(0,3.240331);
   fmb->SetParError(0,4.24599);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-7.277851);
   fmb->SetParError(1,65.22026);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,30.1881);
   fmb->SetParError(2,239.7735);
