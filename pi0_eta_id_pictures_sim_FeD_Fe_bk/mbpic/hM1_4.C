...
//=========  (Mon Jun  6 21:14:00 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 96     ");
   ...
   fmb->SetParameter(0,4.821746);
   fmb->SetParError(0,5.66846);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-46.74397);
   fmb->SetParError(1,86.5004);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,205.5921);
   fmb->SetParError(2,319.0141);
