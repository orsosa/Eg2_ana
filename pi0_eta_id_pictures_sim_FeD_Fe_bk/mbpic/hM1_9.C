...
//=========  (Mon Jun  6 21:14:00 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.02919");
   ...
   fmb->SetParameter(0,2.825041);
   fmb->SetParError(0,6.474788);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-11.2287);
   fmb->SetParError(1,94.86302);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,65.57786);
   fmb->SetParError(2,336.0244);
