...
//=========  (Mon Jun  6 21:14:04 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 716    ");
   ...
   fmb->SetParameter(0,-11.77418);
   fmb->SetParError(0,5.418042);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,284.1389);
   fmb->SetParError(1,84.24094);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-1004.048);
   fmb->SetParError(2,311.455);
