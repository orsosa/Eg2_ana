...
//=========  (Mon Jun  6 21:14:04 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 218    ");
   text = ptstats->AddText("Mean  =  0.136");
   text = ptstats->AddText("RMS   = 0.03149");
   ...
   fmb->SetParameter(0,-2.62551);
   fmb->SetParError(0,4.030714);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,85.5703);
   fmb->SetParError(1,62.92871);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-317.0332);
   fmb->SetParError(2,233.2749);
