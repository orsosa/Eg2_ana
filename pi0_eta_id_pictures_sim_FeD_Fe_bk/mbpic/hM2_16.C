...
//=========  (Mon Jun  6 21:14:05 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.03193");
   ...
   fmb->SetParameter(0,5.818587);
   fmb->SetParError(0,4.82319);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-46.1875);
   fmb->SetParError(1,74.09882);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,188.765);
   fmb->SetParError(2,274.1381);
