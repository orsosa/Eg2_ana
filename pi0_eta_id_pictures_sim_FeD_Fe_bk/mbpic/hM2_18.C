...
//=========  (Mon Jun  6 21:14:05 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 112    ");
   text = ptstats->AddText("Mean  = 0.1347");
   text = ptstats->AddText("RMS   = 0.03518");
   ...
   fmb->SetParameter(0,7.612899);
   fmb->SetParError(0,4.411042);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,-87.85819);
   fmb->SetParError(1,68.50261);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,341.6543);
   fmb->SetParError(2,256.6483);
