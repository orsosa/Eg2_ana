...
//=========  (Mon Jun  6 21:14:05 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.02979");
   ...
   fmb->SetParameter(0,0.6755108);
   fmb->SetParError(0,5.189446);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,23.58636);
   fmb->SetParError(1,77.45357);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-87.0569);
   fmb->SetParError(2,278.2749);
