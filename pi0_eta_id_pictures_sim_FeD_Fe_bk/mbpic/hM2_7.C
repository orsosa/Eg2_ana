...
//=========  (Mon Jun  6 21:14:04 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("RMS   = 0.03196");
   ...
   fmb->SetParameter(0,1.307892);
   fmb->SetParError(0,4.351404);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,22.34199);
   fmb->SetParError(1,68.03134);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-44.93497);
   fmb->SetParError(2,254.9169);
