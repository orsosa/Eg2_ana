...
//=========  (Thu Jul 21 19:32:05 2016) by ROOT version5.34/19
   ...
   TH1F *hM = new TH1F("hM","Mass, bin (q2,nu,z) = (1,0,4), tot: 0.985812,partial: 0.918783",75,0.08,0.19);
   ...
   text = ptstats->AddText("p0       = 0.03522 #pm 0.95304 ");
   text = ptstats->AddText("p1       = 4.253 #pm 6.729 ");
   text = ptstats->AddText("p2       = -1.422e-07 #pm 7.683e+01 ");
   text = ptstats->AddText("p3       = 23.63 #pm 1.13 ");
   ...
   fsig->SetParameter(0,0.03522423);
   fsig->SetParError(0,0.9530389);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,4.252819);
   fsig->SetParError(1,6.729065);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-1.421977e-07);
   fsig->SetParError(2,76.83055);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,23.62515);
   fsig->SetParError(3,1.134281);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1380983);
   fsig->SetParError(4,0.0006905247);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,0.0001131939);
   ...
   fmb->SetParameter(0,0.03522423);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,4.252819);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-1.421977e-07);
   fmb->SetParError(2,0);
   ...
   pt->SetName("title");
   pt->SetBorderSize(2);
   text = pt->AddText("Mass, bin (q2,nu,z) = (1,0,4), tot: 0.985812,partial: 0.918783");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
