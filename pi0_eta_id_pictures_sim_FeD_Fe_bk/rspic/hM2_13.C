...
//=========  (Thu Jul 21 19:32:07 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 446    ");
   text = ptstats->AddText("Mean  = 0.1354");
   text = ptstats->AddText("RMS   = 0.01819");
   text = ptstats->AddText("#chi^{2} / ndf = 66.06 / 56");
   text = ptstats->AddText("p0       = -0.467 #pm 1.096 ");
   text = ptstats->AddText("p1       =  9.71 #pm 7.34 ");
   text = ptstats->AddText("p2       = -1.146e-05 #pm 1.014e+02 ");
   text = ptstats->AddText("p3       =  12.5 #pm 0.9 ");
   text = ptstats->AddText("p4       = 0.1334 #pm 0.0010 ");
   ...
   fsig->SetParameter(0,-0.4669557);
   fsig->SetParError(0,1.095691);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,9.709713);
   fsig->SetParError(1,7.335771);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-1.146112e-05);
   fsig->SetParError(2,101.4229);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,12.50433);
   fsig->SetParError(3,0.9346713);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1333877);
   fsig->SetParError(4,0.001046576);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,0.0001895715);
   ...
   fmb->SetParameter(0,-0.4669557);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,9.709713);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-1.146112e-05);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,12.50433);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1333877);
