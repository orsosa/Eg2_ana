...
//=========  (Thu Jul 21 19:32:07 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 738    ");
   text = ptstats->AddText("Mean  = 0.1366");
   text = ptstats->AddText("RMS   = 0.01861");
   text = ptstats->AddText("#chi^{2} / ndf = 56.86 / 60");
   text = ptstats->AddText("p0       = -2.905 #pm 1.139 ");
   text = ptstats->AddText("p1       =  30.2 #pm 8.2 ");
   text = ptstats->AddText("p2       = -7.427e-07 #pm 1.583e+02 ");
   text = ptstats->AddText("p3       = 22.51 #pm 1.16 ");
   ...
   fsig->SetParameter(0,-2.904534);
   fsig->SetParError(0,1.138825);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,30.19706);
   fsig->SetParError(1,8.238236);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-7.426916e-07);
   fsig->SetParError(2,158.3274);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,22.50837);
   fsig->SetParError(3,1.162643);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1332693);
   fsig->SetParError(4,0.000798277);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,0.0002176279);
   ...
   fmb->SetParameter(0,-2.904534);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,30.19706);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-7.426916e-07);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,22.50837);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1332693);
