...
//=========  (Thu Jul 21 19:32:08 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 779    ");
   text = ptstats->AddText("Mean  = 0.1352");
   text = ptstats->AddText("RMS   = 0.01804");
   text = ptstats->AddText("#chi^{2} / ndf = 63.55 / 65");
   text = ptstats->AddText("p0       = -0.5012 #pm 0.8263 ");
   text = ptstats->AddText("p1       = 9.797 #pm 5.724 ");
   text = ptstats->AddText("p2       = -1.415e-05 #pm 1.034e+02 ");
   text = ptstats->AddText("p3       = 24.71 #pm 1.14 ");
   ...
   fsig->SetParameter(0,-0.5011586);
   fsig->SetParError(0,0.8262703);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,9.797221);
   fsig->SetParError(1,5.724097);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-1.414781e-05);
   fsig->SetParError(2,103.3954);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,24.71151);
   fsig->SetParError(3,1.135408);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1333973);
   fsig->SetParError(4,0.0006714485);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,0.000129469);
   ...
   fmb->SetParameter(0,-0.5011586);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,9.797221);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-1.414781e-05);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,24.71151);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1333973);
