...
//=========  (Thu Jul 21 19:32:08 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 379    ");
   text = ptstats->AddText("Mean  = 0.1379");
   text = ptstats->AddText("RMS   = 0.0152");
   text = ptstats->AddText("#chi^{2} / ndf = 54.98 / 48");
   text = ptstats->AddText("p0       = -1.385 #pm 1.463 ");
   text = ptstats->AddText("p1       = 10.26 #pm 9.13 ");
   text = ptstats->AddText("p2       = -2.741e-08 #pm 7.875e+01 ");
   text = ptstats->AddText("p3       = 12.46 #pm 0.97 ");
   ...
   fsig->SetParameter(0,-1.385325);
   fsig->SetParError(0,1.462541);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,10.26252);
   fsig->SetParError(1,9.134571);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-2.741399e-08);
   fsig->SetParError(2,78.7499);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,12.46142);
   fsig->SetParError(3,0.9726862);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.135805);
   fsig->SetParError(4,0.0009654409);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,0.000156706);
   ...
   fmb->SetParameter(0,-1.385325);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,10.26252);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-2.741399e-08);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,12.46142);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.135805);
