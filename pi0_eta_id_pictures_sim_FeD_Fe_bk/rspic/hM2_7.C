...
//=========  (Thu Jul 21 19:32:07 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 790    ");
   text = ptstats->AddText("Mean  = 0.1368");
   text = ptstats->AddText("RMS   = 0.0215");
   text = ptstats->AddText("#chi^{2} / ndf = 62.86 / 67");
   text = ptstats->AddText("p0       = -1.061 #pm 1.020 ");
   text = ptstats->AddText("p1       = 26.35 #pm 7.72 ");
   text = ptstats->AddText("p2       = -3.693e-06 #pm 2.113e+02 ");
   text = ptstats->AddText("p3       = 20.15 #pm 1.14 ");
   text = ptstats->AddText("p4       = 0.1332 #pm 0.0009 ");
   ...
   fsig->SetParameter(0,-1.061054);
   fsig->SetParError(0,1.019577);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,26.3536);
   fsig->SetParError(1,7.72018);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-3.693431e-06);
   fsig->SetParError(2,211.3363);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,20.14943);
   fsig->SetParError(3,1.140424);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1332244);
   fsig->SetParError(4,0.0008767509);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,0.0002781567);
   ...
   fmb->SetParameter(0,-1.061054);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,26.3536);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-3.693431e-06);
   fmb->SetParError(2,0);
