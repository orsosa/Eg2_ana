...
//=========  (Thu Jul 21 19:32:07 2016) by ROOT version5.34/19
   ...
   text = ptstats->AddText("Entries = 272    ");
   text = ptstats->AddText("Mean  = 0.1344");
   text = ptstats->AddText("RMS   = 0.01812");
   text = ptstats->AddText("#chi^{2} / ndf = 42.05 / 52");
   text = ptstats->AddText("p0       = 0.324 #pm 0.887 ");
   text = ptstats->AddText("p1       = 2.066 #pm 6.409 ");
   text = ptstats->AddText("p2       = -2.358e-05 #pm 8.345e+01 ");
   text = ptstats->AddText("p3       = 7.667 #pm 0.758 ");
   ...
   fsig->SetParameter(0,0.3240403);
   fsig->SetParError(0,0.8865212);
   fsig->SetParLimits(0,0,0);
   fsig->SetParameter(1,2.066482);
   fsig->SetParError(1,6.409134);
   fsig->SetParLimits(1,0,0);
   fsig->SetParameter(2,-2.357732e-05);
   fsig->SetParError(2,83.44954);
   fsig->SetParLimits(2,-10000,0);
   fsig->SetParameter(3,7.667041);
   fsig->SetParError(3,0.7576737);
   fsig->SetParLimits(3,0,0);
   fsig->SetParameter(4,0.1329716);
   fsig->SetParError(4,0.001344776);
   fsig->SetParLimits(4,0,0);
   fsig->SetParameter(5,0.01552272);
   fsig->SetParError(5,0.000276125);
   ...
   fmb->SetParameter(0,0.3240403);
   fmb->SetParError(0,0);
   fmb->SetParLimits(0,0,0);
   fmb->SetParameter(1,2.066482);
   fmb->SetParError(1,0);
   fmb->SetParLimits(1,0,0);
   fmb->SetParameter(2,-2.357732e-05);
   fmb->SetParError(2,0);
   ...
   fpeak->SetParameter(0,7.667041);
   fpeak->SetParError(0,0);
   fpeak->SetParLimits(0,0,0);
   fpeak->SetParameter(1,0.1329716);
