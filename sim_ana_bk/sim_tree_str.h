...
// Wed Nov 11 15:39:33 2015 by ROOT version 5.34/19
// from TTree h10/All_out
// found on file: /user/o/orsosa/sim_ahmed_raw/Fe56/run0001/recsis_Fe56_run0001.root
//////////////////////////////////////////////////////////

#ifndef sim_tree_str_h
#define sim_tree_str_h
...
////////////////////
   ...
   sim_tree_str(TTree *tree=0);
   virtual ~sim_tree_str();
...
#ifdef sim_tree_str_cxx
sim_tree_str::sim_tree_str(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/user/o/orsosa/sim_ahmed_raw/Fe56/run0001/recsis_Fe56_run0001.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/user/o/orsosa/sim_ahmed_raw/Fe56/run0001/recsis_Fe56_run0001.root");
      }
...
sim_tree_str::~sim_tree_str()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t sim_tree_str::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t sim_tree_str::LoadTree(Long64_t entry)
{
...
void sim_tree_str::Init(TTree *tree)
{
...
void sim_tree_str::Show(Long64_t entry)
{
...
Int_t sim_tree_str::Cut(Long64_t entry)
{
...
Bool_t sim_tree_str::GoodTrig(void);
Int_t sim_tree_str::CheckCut(void);
void sim_tree_str:: FillVlassovCoordinates(int track);
void sim_tree_str::get_cc_special_coord(float *point, float *dir, float *cc_coor);
Bool_t sim_tree_str::NpheSect(void);
Bool_t sim_tree_str::TrigCCmatch(void);
Bool_t sim_tree_str::SamplingCutFe(void);
TVector3 sim_tree_str::ec_xyz_uvw(TVector3 xyz);
void sim_tree_str::TFidCut(Char_t* FileName);
TF1* fcfun[7][2][4];
TF1* fcfidc_fun[2];
int sim_tree_str::get_vcrpl(float *r0, float *dir, float *plane_par, float *dist, float *cross_point);
Bool_t sim_tree_str::IsElecMin();
void sim_tree_str::LoopSimple(char *rfname = "all_part_ahmed.root");
