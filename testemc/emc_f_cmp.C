...
//=========  (Mon Oct 30 18:18:37 2017) by ROOT version5.34/34
   ...
   c->Range(0.07624999,-0.1449342,0.61375,1.304408);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   emc_a_stack_1->SetMaximum(1.159473);
   ...
   hEMCCN_a__1->SetBinContent(0,0.9923004);
   hEMCCN_a__1->SetBinContent(1,0.9958355);
   hEMCCN_a__1->SetBinContent(2,0.9924932);
   hEMCCN_a__1->SetBinContent(3,0.982191);
   hEMCCN_a__1->SetBinContent(4,0.9634352);
   hEMCCN_a__1->SetBinContent(5,0.965274);
   hEMCCN_a__1->SetBinContent(6,0.9657194);
   hEMCCN_a__1->SetBinContent(7,0.9567573);
   hEMCCN_a__1->SetBinContent(8,0.9458634);
   hEMCCN_a__1->SetBinContent(9,0.9391801);
   hEMCCN_a__1->SetBinContent(10,0.985464);
   hEMCCN_a__1->SetBinContent(11,0.9174072);
   hEMCCN_a__1->SetBinContent(12,0.8965322);
   hEMCCN_a__1->SetBinContent(13,0.9210537);
   hEMCCN_a__1->SetBinContent(14,0.8702275);
   hEMCCN_a__1->SetBinContent(15,0.7731267);
   hEMCCN_a__1->SetBinError(0,0.01189931);
   hEMCCN_a__1->SetBinError(1,0.001641964);
   hEMCCN_a__1->SetBinError(2,0.001235141);
   hEMCCN_a__1->SetBinError(3,0.001289299);
   hEMCCN_a__1->SetBinError(4,0.001514366);
   hEMCCN_a__1->SetBinError(5,0.001482518);
   hEMCCN_a__1->SetBinError(6,0.001401538);
   hEMCCN_a__1->SetBinError(7,0.001499897);
   hEMCCN_a__1->SetBinError(8,0.001701192);
   hEMCCN_a__1->SetBinError(9,0.00208477);
   hEMCCN_a__1->SetBinError(10,0.06115939);
   hEMCCN_a__1->SetBinError(11,0.004537031);
   hEMCCN_a__1->SetBinError(12,0.009529737);
   hEMCCN_a__1->SetBinError(13,0.03376473);
   hEMCCN_a__1->SetBinError(14,0.01248368);
   hEMCCN_a__1->SetBinError(15,0.2917069);
   hEMCCN_a__1->SetEntries(34204.14);
   ...
   hEMCFeN_a__2->SetBinContent(0,1.097108);
   hEMCFeN_a__2->SetBinContent(1,1.10426);
   hEMCFeN_a__2->SetBinContent(2,1.079462);
   hEMCFeN_a__2->SetBinContent(3,1.049216);
   hEMCFeN_a__2->SetBinContent(4,1.016541);
   hEMCFeN_a__2->SetBinContent(5,1.012305);
   hEMCFeN_a__2->SetBinContent(6,1.012602);
   hEMCFeN_a__2->SetBinContent(7,0.9932593);
   hEMCFeN_a__2->SetBinContent(8,0.9812557);
   hEMCFeN_a__2->SetBinContent(9,0.9664097);
   hEMCFeN_a__2->SetBinContent(10,0.9570194);
   hEMCFeN_a__2->SetBinContent(11,0.9374591);
   hEMCFeN_a__2->SetBinContent(12,0.9112983);
   hEMCFeN_a__2->SetBinContent(13,0.8771297);
   hEMCFeN_a__2->SetBinContent(14,0.8835989);
   hEMCFeN_a__2->SetBinContent(15,0.4943845);
   hEMCFeN_a__2->SetBinError(0,0.01186504);
   hEMCFeN_a__2->SetBinError(1,0.001568678);
   hEMCFeN_a__2->SetBinError(2,0.001139913);
   hEMCFeN_a__2->SetBinError(3,0.001165735);
   hEMCFeN_a__2->SetBinError(4,0.001353877);
   hEMCFeN_a__2->SetBinError(5,0.001315397);
   hEMCFeN_a__2->SetBinError(6,0.001227089);
   hEMCFeN_a__2->SetBinError(7,0.001279677);
   hEMCFeN_a__2->SetBinError(8,0.001438468);
   hEMCFeN_a__2->SetBinError(9,0.001738191);
   hEMCFeN_a__2->SetBinError(10,0.002352859);
   hEMCFeN_a__2->SetBinError(11,0.003735055);
   hEMCFeN_a__2->SetBinError(12,0.007788991);
   hEMCFeN_a__2->SetBinError(13,0.02678095);
   hEMCFeN_a__2->SetBinError(14,0.01052653);
   hEMCFeN_a__2->SetBinError(15,0.1673868);
   hEMCFeN_a__2->SetEntries(205317.1);
   ...
   hEMCPbN_a__3->SetBinContent(0,1.028328);
   hEMCPbN_a__3->SetBinContent(1,1.023325);
   hEMCPbN_a__3->SetBinContent(2,1.01133);
   hEMCPbN_a__3->SetBinContent(3,0.980433);
   hEMCPbN_a__3->SetBinContent(4,0.9502792);
   hEMCPbN_a__3->SetBinContent(5,0.941814);
   hEMCPbN_a__3->SetBinContent(6,0.932143);
   hEMCPbN_a__3->SetBinContent(7,0.9097798);
   hEMCPbN_a__3->SetBinContent(8,0.8925716);
   hEMCPbN_a__3->SetBinContent(9,0.867809);
   hEMCPbN_a__3->SetBinContent(10,0.8529186);
   hEMCPbN_a__3->SetBinContent(11,0.8222335);
   hEMCPbN_a__3->SetBinContent(12,0.7972702);
   hEMCPbN_a__3->SetBinContent(13,0.7496924);
   hEMCPbN_a__3->SetBinContent(14,0.767229);
   hEMCPbN_a__3->SetBinContent(15,0.5340331);
   hEMCPbN_a__3->SetBinError(0,0.01229736);
   hEMCPbN_a__3->SetBinError(1,0.001686856);
   hEMCPbN_a__3->SetBinError(2,0.001263643);
   hEMCPbN_a__3->SetBinError(3,0.001299685);
   hEMCPbN_a__3->SetBinError(4,0.00151022);
   hEMCPbN_a__3->SetBinError(5,0.001474496);
   hEMCPbN_a__3->SetBinError(6,0.001389353);
   hEMCPbN_a__3->SetBinError(7,0.001472374);
   hEMCPbN_a__3->SetBinError(8,0.001666538);
   hEMCPbN_a__3->SetBinError(9,0.002014186);
   hEMCPbN_a__3->SetBinError(10,0.002710733);
   hEMCPbN_a__3->SetBinError(11,0.004184834);
   hEMCPbN_a__3->SetBinError(12,0.008676953);
   hEMCPbN_a__3->SetBinError(13,0.02807986);
   hEMCPbN_a__3->SetBinError(14,0.01158255);
   hEMCPbN_a__3->SetBinError(15,0.1954081);
   hEMCPbN_a__3->SetEntries(149593.2);
   ...
   entry=leg->AddEntry("emc_Fe","Fe ext","lp");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("emc_Pb","Pb ext","lp");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("hEMCCN_a","C data","lp");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("hEMCFeN_a","Fe data","lp");
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   entry->SetMarkerColor(1);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("hEMCPbN_a","Pb data","lp");
   ...
   TPaveText *pt = new TPaveText(0.1539447,0.9341608,0.8460553,0.995,"blNDC");
   pt->SetName("title");
   pt->SetBorderSize(0);
   pt->SetFillColor(0);
   pt->SetFillStyle(0);
